...
```text
C:\Users\emre_\OneDrive\Desktop\J\ANSYS\Benchmark\load_reconstruction_v0.wbpj
```
...
```text
C:\Users\emre_\OneDrive\Desktop\J\ANSYS\Benchmark\load_reconstruction_v0_files\dp0\SYS-6\MECH
```
