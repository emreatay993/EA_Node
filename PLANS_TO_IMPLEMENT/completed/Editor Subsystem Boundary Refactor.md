...
- Preconditions: `none`
- Conservative write scope: `ea_node_editor/graph/model.py`, `ea_node_editor/graph/normalization.py`, `ea_node_editor/graph/mutation_service.py`, `ea_node_editor/graph/rules.py`, `ea_node_editor/graph/port_locking.py`, `ea_node_editor/graph/transform_*.py`, `tests/test_port_locking.py`, `tests/test_group_backdrop_membership.py`, `tests/graph_track_b/scene_model_graph_model_suite.py`
...
- Verification: `.\venv\Scripts\python.exe -m pytest tests/test_port_locking.py tests/test_group_backdrop_membership.py tests/graph_track_b/scene_model_graph_model_suite.py --ignore=venv -q`
...
## Test Plan
- Graph-core boundary regression: `tests/test_port_locking.py`, `tests/test_group_backdrop_membership.py`, `tests/graph_track_b/scene_model_graph_model_suite.py`
