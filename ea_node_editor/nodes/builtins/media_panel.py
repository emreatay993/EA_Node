...
@builtin_node_type(
    ...
    properties=(
        ...
        PropertySpec(
            ...
            inspector_visible=False, affects_execution=False,
        ),
        PropertySpec(
        ...
        PropertySpec("show_title", "bool", True, "Show Title", inspector_visible=False, affects_execution=False),
        PropertySpec("show_frame", "bool", True, "Show Frame", inspector_visible=False, affects_execution=False),
        PropertySpec("crop_x", "float", 0.0, "Crop X", inspector_visible=False, affects_execution=False),
        PropertySpec("crop_y", "float", 0.0, "Crop Y", inspector_visible=False, affects_execution=False),
        PropertySpec("crop_w", "float", 1.0, "Crop Width", inspector_visible=False, affects_execution=False),
        PropertySpec("crop_h", "float", 1.0, "Crop Height", inspector_visible=False, affects_execution=False),
        PropertySpec("rotation_degrees", "int", 0, "Rotation", inspector_visible=False, affects_execution=False),
        PropertySpec(
            "mirror_horizontal",
            "bool",
            False,
        ...
        PropertySpec(
            "mirror_vertical", "bool", False, "Mirror Vertical", inspector_visible=False, affects_execution=False
        ),
        PropertySpec("page_number", "int", 1, "Page Number", inspector_visible=False, affects_execution=False),
        PropertySpec("auto_play", "bool", False, "Auto Play", inspector_visible=False, affects_execution=False),
        PropertySpec("loop", "bool", False, "Loop", inspector_visible=False, affects_execution=False),
        PropertySpec("muted", "bool", False, "Muted", inspector_visible=False, affects_execution=False),
        PropertySpec("volume", "float", 1.0, "Volume", inspector_visible=False, affects_execution=False),
        PropertySpec(
            "playback_rate",
            "float",
            1.0,
        ...
        PropertySpec("position_ms", "int", 0, "Position", inspector_visible=False, affects_execution=False),
        PropertySpec(
            "timeline_bookmarks",
            "json",
            [],
        ...
        PropertySpec(
            "clip_start_ms", "int", 0, "Clip Start", inspector_visible=False, affects_execution=False
        ),
        PropertySpec(
            "clip_end_ms", "int", 0, "Clip End", inspector_visible=False, affects_execution=False
        ),
    ),
    collapsible=False,
