# Purpose: Provide core scripting and dynamic data-control nodes.
# Map: subsystems/nodes_registry_builtins.md
# Tests: tests/test_python_script_declaration.py, tests/test_corex_contract_catalog.py
...
PYTHON_SCRIPT_DEFAULT_SOURCE = """# Use Add to create ports, controls, and sections.
@corex.node
