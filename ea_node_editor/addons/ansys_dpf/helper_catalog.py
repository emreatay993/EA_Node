...
_HELPER_CATEGORY_PATHS = {
    # Atomic building blocks fully covered by curated workflow nodes live
    # under Advanced; scoping/support helpers the curated nodes do not cover
    # keep their Helpers roles.
