...
INPUT_REFERENCE_SECTIONS: tuple[InputReferenceSection, ...] = (
    ...
    InputReferenceSection(
        ...
        (
            ...
            InputReferenceEntry("Selection", "Ctrl+V", "Paste graph items from the clipboard."),
    ...
    InputReferenceSection(
        ...
        (
            ...
            InputReferenceEntry("Connected port", "Ctrl+drag", "Reconnect one incident wire endpoint."),
            InputReferenceEntry("Connected port", "Ctrl+drag to empty canvas", "Disconnect one incident wire."),
    ...
    InputReferenceSection(
        ...
        (
            ...
            InputReferenceEntry("DPF viewer fullscreen", "Space", "Play or pause the result-step animation."),
            InputReferenceEntry("DPF viewer fullscreen", "Left or Right", "Move to the previous or next result step."),
            InputReferenceEntry("DPF viewer fullscreen", "Home", "Fit the camera to the model."),
            InputReferenceEntry("DPF viewer fullscreen", "R", "Reset the camera to the isometric view."),
            InputReferenceEntry(
            ...
            InputReferenceEntry("Folder explorer row", "Left-drag", "Create a Path Pointer drop from the row."),
