...
class WorkspaceLibraryController:
    ...
    def _global_custom_workflow_definitions(self) -> list[dict[str, Any]]:
        return self.workflow_library_controller.global_custom_workflow_definitions()
    ...
    def add_node_from_library_with_properties(self, type_id: str, properties: dict[str, Any]) -> bool:
        return self.workspace_graph_edit_controller.add_node_from_library_with_properties(type_id, properties)
    ...
    def insert_library_node_with_properties(
        ...
        return self.workspace_graph_edit_controller.insert_library_node_with_properties(type_id, properties, x, y)
    ...
    def set_selection_same_type_width(self, node_ids: tuple[str, ...] | list[object]) -> bool:
        return self.workspace_graph_edit_controller.set_selection_same_type_width(node_ids)

    def set_selection_same_type_height(self, node_ids: tuple[str, ...] | list[object]) -> bool:
        return self.workspace_graph_edit_controller.set_selection_same_type_height(node_ids)

    def straighten_selection_connections(self) -> bool:
        return self.workspace_graph_edit_controller.straighten_selection_connections()
    ...
    def request_move_edge_endpoint(
        ...
        return self.workspace_graph_edit_controller.request_move_edge_endpoint(
            edge_id,
            endpoint,
            node_id,
            port_key,
    ...
    def focus_failed_node(self, workspace_id: str, node_id: str) -> None:
        self.workspace_navigation_controller.focus_failed_node(workspace_id, node_id)
