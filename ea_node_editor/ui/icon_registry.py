...
_ICON_SPECS: dict[str, IconSpec] = {
    ...
    "edge-reverse": IconSpec(name="edge-reverse", label="Reverse Direction", relative_path="edge-reverse.svg"),
    "edge-label-layout": IconSpec(name="edge-label-layout", label="Label Placement", relative_path="edge-label-layout.svg"),
