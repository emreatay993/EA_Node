    ...
    params=object_schema(
        {
            ...
            "author": string_schema(default="automation"),
            "parent_id": string_schema("Parent comment id for replies"),
            "resolved": boolean_schema(default=False),
            "pinned": boolean_schema(default=False),
        },
