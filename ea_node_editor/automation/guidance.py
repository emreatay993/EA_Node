...
def server_instructions() -> str:
    return "\n".join(
        (
            ...
            "   and columns and keeps Group backdrops intact. Use layout_arrange / layout_straighten for fine control.",
...
def node_types_text() -> str:
    ...
    lines = [
        ...
        "  `move_contents=false` to move or reshape only its frame. `layout_tidy` lays a whole",
