...
_FLOWCHART_VARIANT_LAYOUTS: dict[str, _FlowchartVariantLayout] = {
    ...
    "decision": _FlowchartVariantLayout(
        ...
        min_height=120.0,
        title_top=24.0,
        title_left_margin=52.0,
        title_right_margin=52.0,
        body_left_margin=42.0,
        body_right_margin=42.0,
        body_bottom_margin=20.0,
    ),
    ...
    "input_output": _FlowchartVariantLayout(
        ...
        min_height=88.0,
        title_top=20.0,
        title_left_margin=28.0,
        title_right_margin=28.0,
    ...
    "database": _FlowchartVariantLayout(
        ...
        min_height=120.0,
        title_top=26.0,
        title_left_margin=26.0,
        title_right_margin=26.0,
        body_left_margin=22.0,
        body_right_margin=22.0,
        body_bottom_margin=20.0,
    ),
}
...
def _flowchart_horizontal_bounds(
    ...
    if variant == "input_output":
        slant = min(width * 0.16, height * 0.35)
