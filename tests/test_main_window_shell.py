...
class MainWindowPyQtGraphActionRouteTests(SharedMainWindowShellTestBase):
    def test_pyqt_duplicate_clipboard_group_backdrop_subnode_group_align_scope_actions_dispatch_to_controller(self) -> None:
        actions = (
            ...
            (self.window.action_tidy_selection, GraphActionId.TIDY_SELECTION),
            (self.window.action_tidy_selection_left_to_right, GraphActionId.TIDY_SELECTION_LEFT_TO_RIGHT),
            (self.window.action_tidy_selection_top_to_bottom, GraphActionId.TIDY_SELECTION_TOP_TO_BOTTOM),
            (self.window.action_tidy_selection_in_place, GraphActionId.TIDY_SELECTION_IN_PLACE),
            (self.window.action_tidy_graph, GraphActionId.TIDY_GRAPH),
            (self.window.action_tidy_graph_in_place, GraphActionId.TIDY_GRAPH_IN_PLACE),
    ...
    def test_duplicate_clipboard_group_backdrop_subnode_group_align_scope_request_slots_delegate_to_controller(self) -> None:
        requests = (
            ...
            (self.window.request_tidy_selection, GraphActionId.TIDY_SELECTION, None, True),
            (
                self.window.request_tidy_selection_left_to_right,
                GraphActionId.TIDY_SELECTION_LEFT_TO_RIGHT,
                None,
                True,
            ),
            (
                self.window.request_tidy_selection_top_to_bottom,
                GraphActionId.TIDY_SELECTION_TOP_TO_BOTTOM,
                None,
                True,
            ),
            (self.window.request_tidy_selection_in_place, GraphActionId.TIDY_SELECTION_IN_PLACE, None, True),
            (self.window.request_tidy_graph, GraphActionId.TIDY_GRAPH, None, True),
            (self.window.request_tidy_graph_in_place, GraphActionId.TIDY_GRAPH_IN_PLACE, None, True),
