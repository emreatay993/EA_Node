...
def _build_targets():
    ...
    return (
        ...
        ShellIsolationTarget.pytest_nodeid_list(
            ...
            (
                "tests/test_main_window_shell.py::FrameRateSamplerTests",
                ...
                "tests/test_main_window_shell.py::GraphCanvasQmlBoundaryTests",
                "tests/test_main_window_shell.py::MainWindowShellTelemetryTests",
                "tests/test_main_window_shell.py::MainWindowShellBootstrapCompositionTests",
                "tests/test_main_window_shell.py::MainWindowShellContextBootstrapTests",
                "tests/test_main_window_shell.py::MainWindowShellHostProtocolStateTests",
            ),
        ),
        ShellIsolationTarget.pytest_nodeid(
