...
def _build_targets():
    ...
    return (
        ...
        ShellIsolationTarget.unittest_target_list(
            ...
            (
                "tests.test_main_window_shell.FrameRateSamplerTests",
                "tests.test_main_window_shell.ShellLibraryBridgeTests",
                "tests.test_main_window_shell.ShellInspectorBridgeTests",
                "tests.test_main_window_shell.GraphCanvasBridgeTests",
                "tests.test_main_window_shell.ShellWorkspaceBridgeTests",
                "tests.test_main_window_shell.ShellLibraryBridgeQmlBoundaryTests",
                "tests.test_main_window_shell.ShellInspectorBridgeQmlBoundaryTests",
                "tests.test_main_window_shell.ShellWorkspaceBridgeQmlBoundaryTests",
                "tests.test_main_window_shell.GraphCanvasQmlBoundaryTests",
                "tests.test_main_window_shell.MainWindowShellTelemetryTests",
                "tests.test_main_window_shell.MainWindowShellBootstrapCompositionTests",
                "tests.test_main_window_shell.MainWindowShellContextBootstrapTests",
                "tests.test_main_window_shell.MainWindowShellHostProtocolStateTests",
            ),
        ),
        ShellIsolationTarget.pytest_nodeid(
