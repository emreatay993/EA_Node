...
def _build_targets():
    ...
    return (
        ...
        ShellIsolationTarget.unittest_target(
            "tests.test_shell_run_controller.ShellRunControllerTests.test_unused_viewer_inputs_preserve_real_cad_workflow",
            target_id="run_controller__test_unused_viewer_inputs_preserve_real_cad_workflow",
        ),
        ShellIsolationTarget.unittest_target(
