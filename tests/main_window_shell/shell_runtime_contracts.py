...
class MainWindowShellContentFullscreenStaticContractsTests(unittest.TestCase):
    def test_content_fullscreen_overlay_is_shell_owned_and_bridge_gated(self) -> None:
        ...
        self.assertIn("item.graphThemeBridgeRef = root.graphThemeBridgeRef", main_shell)
        ...
        self.assertIn("graphThemeBridgeRef: root.graphThemeBridgeRef", overlay)
        ...
        self.assertNotIn("visible: root.guideButtonVisible", script_pane)
        self.assertIn("if (root.guideButtonVisible) root.guideRequested(); else helpPopup.open();", script_pane)
        self.assertIn("contentItem: PythonScriptGuidePane", script_pane)
