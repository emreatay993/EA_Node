...
- Video Panel toolbar and fullscreen controls use semantic registered Tabler-sourced `video-*` shell icons, including `video-trim-save`; keep inline QML action names on those registry keys instead of reusing generic browser/title/frame glyphs.
