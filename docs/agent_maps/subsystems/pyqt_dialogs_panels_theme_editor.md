...
- Default dialog buttons retain the normal font metrics and total border/padding insets because Qt can assign the default role after layout. `tests/test_shell_theme.py` covers visible OK/Cancel labels and Enter acceptance in input/message dialogs under both themes.
