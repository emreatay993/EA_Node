...
- Mechanical's dependency-gated semantic values remain in `addons/mechanical/contracts.py`; its run/workspace session service and dedicated bounded owner process live beside them and keep native imports out of the shell and shared execution worker.
