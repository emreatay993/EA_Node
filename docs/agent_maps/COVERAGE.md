...
- Mechanical's dependency-gated semantic types, immutable snapshot builders, stable selectors, and fixed catalogue/Definitions table schemas are owned by `addons/mechanical/contracts.py`; they remain data-only and import no Ansys runtime.
