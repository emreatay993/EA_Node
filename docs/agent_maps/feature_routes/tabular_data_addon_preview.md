...
- The inline Configure button uses shared surface controls and hit geometry, including the empty/selection-required/error states. Header selection and widths are presentation state; they do not mutate output recipes.
