# COREX_CLEAN_ARCHITECTURE_RESTRUCTURE P06 QML Shell Roots Prompt

Read the manifest, status ledger, and `COREX_CLEAN_ARCHITECTURE_RESTRUCTURE_P06_qml_shell_roots.md` before editing. Implement exactly `P06_qml_shell_roots`.
...
Create `docs/specs/work_packets/corex_clean_architecture_restructure/P06_qml_shell_roots_WRAPUP.md`.
...
Commit packet-local changes on `codex/corex-clean-architecture-restructure/p06-qml-shell-roots`, update the shared status ledger only if you are running this prompt standalone, and stop after this packet.
