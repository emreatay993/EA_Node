# COREX_CLEAN_ARCHITECTURE_RESTRUCTURE P02 Graph Domain Mutation Prompt

Read the manifest, status ledger, and `COREX_CLEAN_ARCHITECTURE_RESTRUCTURE_P02_graph_domain_mutation.md` before editing. Implement exactly `P02_graph_domain_mutation`.
...
Create `docs/specs/work_packets/corex_clean_architecture_restructure/P02_graph_domain_mutation_WRAPUP.md`.
...
Commit packet-local changes on `codex/corex-clean-architecture-restructure/p02-graph-domain-mutation`, update the shared status ledger only if you are running this prompt standalone, and stop after this packet.
