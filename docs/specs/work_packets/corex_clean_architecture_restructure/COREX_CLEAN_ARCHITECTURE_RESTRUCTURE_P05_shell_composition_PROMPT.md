# COREX_CLEAN_ARCHITECTURE_RESTRUCTURE P05 Shell Composition Prompt

Read the manifest, status ledger, and `COREX_CLEAN_ARCHITECTURE_RESTRUCTURE_P05_shell_composition.md` before editing. Implement exactly `P05_shell_composition`.
...
Create `docs/specs/work_packets/corex_clean_architecture_restructure/P05_shell_composition_WRAPUP.md`.
...
Commit packet-local changes on `codex/corex-clean-architecture-restructure/p05-shell-composition`, update the shared status ledger only if you are running this prompt standalone, and stop after this packet.
