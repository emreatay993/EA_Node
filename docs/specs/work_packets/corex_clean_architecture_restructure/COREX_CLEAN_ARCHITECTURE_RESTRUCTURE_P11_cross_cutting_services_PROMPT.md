# COREX_CLEAN_ARCHITECTURE_RESTRUCTURE P11 Cross-Cutting Services Prompt

Read the manifest, status ledger, and `COREX_CLEAN_ARCHITECTURE_RESTRUCTURE_P11_cross_cutting_services.md` before editing. Implement exactly `P11_cross_cutting_services`.
...
Create `docs/specs/work_packets/corex_clean_architecture_restructure/P11_cross_cutting_services_WRAPUP.md`.
...
Commit packet-local changes on `codex/corex-clean-architecture-restructure/p11-cross-cutting-services`, update the shared status ledger only if you are running this prompt standalone, and stop after this packet.
