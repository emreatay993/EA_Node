# COREX_CLEAN_ARCHITECTURE_RESTRUCTURE P03 Workspace Custom Workflows Prompt

Read the manifest, status ledger, and `COREX_CLEAN_ARCHITECTURE_RESTRUCTURE_P03_workspace_custom_workflows.md` before editing. Implement exactly `P03_workspace_custom_workflows`.
...
Create `docs/specs/work_packets/corex_clean_architecture_restructure/P03_workspace_custom_workflows_WRAPUP.md`.
...
Commit packet-local changes on `codex/corex-clean-architecture-restructure/p03-workspace-custom-workflows`, update the shared status ledger only if you are running this prompt standalone, and stop after this packet.
