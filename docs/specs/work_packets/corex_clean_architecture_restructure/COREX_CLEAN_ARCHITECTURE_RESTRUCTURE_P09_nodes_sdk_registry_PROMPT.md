# COREX_CLEAN_ARCHITECTURE_RESTRUCTURE P09 Nodes SDK Registry Prompt

Read the manifest, status ledger, and `COREX_CLEAN_ARCHITECTURE_RESTRUCTURE_P09_nodes_sdk_registry.md` before editing. Implement exactly `P09_nodes_sdk_registry`.
...
Create `docs/specs/work_packets/corex_clean_architecture_restructure/P09_nodes_sdk_registry_WRAPUP.md`.
...
Commit packet-local changes on `codex/corex-clean-architecture-restructure/p09-nodes-sdk-registry`, update the shared status ledger only if you are running this prompt standalone, and stop after this packet.
