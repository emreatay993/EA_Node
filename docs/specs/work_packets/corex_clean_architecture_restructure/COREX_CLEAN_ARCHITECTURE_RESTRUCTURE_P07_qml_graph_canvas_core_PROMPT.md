# COREX_CLEAN_ARCHITECTURE_RESTRUCTURE P07 QML Graph Canvas Core Prompt

Read the manifest, status ledger, and `COREX_CLEAN_ARCHITECTURE_RESTRUCTURE_P07_qml_graph_canvas_core.md` before editing. Implement exactly `P07_qml_graph_canvas_core`.
...
Create `docs/specs/work_packets/corex_clean_architecture_restructure/P07_qml_graph_canvas_core_WRAPUP.md`.
...
Commit packet-local changes on `codex/corex-clean-architecture-restructure/p07-qml-graph-canvas-core`, update the shared status ledger only if you are running this prompt standalone, and stop after this packet.
