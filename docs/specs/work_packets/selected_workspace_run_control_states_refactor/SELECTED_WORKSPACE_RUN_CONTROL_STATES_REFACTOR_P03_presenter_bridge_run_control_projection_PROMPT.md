...
Notes:
- Target branch: `codex/selected-workspace-run-control-states-refactor/p03-presenter-bridge-run-control-projection`.
- Review Gate: `$env:QT_QPA_PLATFORM='offscreen'; .\venv\Scripts\python.exe -m pytest tests/main_window_shell/bridge_contracts_workspace_and_console.py::ShellWorkspaceBridgeTests --ignore=venv -q`
- Expected artifacts:
...
- This packet owns presenter, bridge, and contract-surface projection only. Do not bind QML or add styling here.
