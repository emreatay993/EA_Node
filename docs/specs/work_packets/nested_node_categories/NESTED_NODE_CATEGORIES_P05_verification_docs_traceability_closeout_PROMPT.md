...
Notes:
- Target branch: `codex/nested-node-categories/p05-verification-docs-traceability-closeout`.
...
- Keep this packet docs-only. If a runtime mismatch appears, report it clearly instead of widening `P05` into a repair packet.
