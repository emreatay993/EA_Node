...
| P01 SDK Category Path Contract | `codex/nested-node-categories/p01-sdk-category-path-contract` | PENDING | `-` | executor contract repair: made builtins scope validator-usable after failed first review | `-` | `-` | Resuming Wave 1 after packet-contract repair; existing P01 branch requires revalidation before acceptance |
