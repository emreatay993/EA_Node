...
- [COREX Type Forwarding](../PLANS/COREX_TYPE_FORWARDING_PLAN.md) — `IMPLEMENTATION COMPLETE; BASELINE VERIFICATION EXCEPTIONS`; the plan records focused/serial acceptance, baseline static failures, and a parallel visual cleanup timeout whose isolated rerun passed.
