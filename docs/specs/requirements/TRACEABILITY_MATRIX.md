...
|---|---|---|
| REQ-ARCH-001 | 10_ARCHITECTURE | `ea_node_editor/app.py`, `ea_node_editor/ui/main_window.py`, `tests/test_main_window_shell.py` |
| REQ-ARCH-006 | 10_ARCHITECTURE | `ea_node_editor/workspace/manager.py`, `ea_node_editor/ui/main_window.py`, `tests/test_workspace_manager.py`, `tests/test_main_window_shell.py` |
| REQ-ARCH-005 | 10_ARCHITECTURE | `ea_node_editor/ui/main_window.py` status API methods, `ea_node_editor/ui/status_bar.py`, `tests/test_main_window_shell.py` |
| REQ-UI-001 | 20_UI_UX | `ea_node_editor/ui/main_window.py` shell layout zones, `tests/test_main_window_shell.py` |
| REQ-UI-002 | 20_UI_UX | `ea_node_editor/ui/main_window.py` workspace tab logic |
| REQ-UI-003 | 20_UI_UX | `ea_node_editor/ui/main_window.py` canvas/tab/console stacking, `tests/test_main_window_shell.py` |
| REQ-UI-004 | 20_UI_UX | `ea_node_editor/graph/model.py` view model, `ea_node_editor/ui/main_window.py` view switch/create logic, `tests/test_main_window_shell.py` |
| REQ-UI-005 | 20_UI_UX | `ea_node_editor/ui/main_window.py` per-view camera save/restore, `tests/test_main_window_shell.py`, `tests/test_serializer.py` |
| REQ-UI-006 | 20_UI_UX | `ea_node_editor/nodes/registry.py`, `ea_node_editor/ui/panels/node_library_panel.py`, `tests/test_registry_filters.py`, `tests/test_main_window_shell.py` (`test_node_library_add_uses_selected_item_when_current_row_is_unset`) |
| REQ-UI-008 | 20_UI_UX | `ea_node_editor/ui/panels/inspector_panel.py`, `ea_node_editor/ui/main_window.py`, `tests/test_inspector_reflection.py`, `tests/test_graph_track_b.py` |
| REQ-GRAPH-001 | 30_GRAPH_MODEL | `ea_node_editor/graph/model.py` dataclasses |
| REQ-GRAPH-002 | 30_GRAPH_MODEL | `ea_node_editor/graph/model.py`, `ea_node_editor/graph/scene.py`, `ea_node_editor/graph/items/node_item.py`, `tests/test_graph_track_b.py` |
| REQ-GRAPH-003 | 30_GRAPH_MODEL | `ea_node_editor/graph/model.py` workspace/view state, `ea_node_editor/ui/main_window.py`, `tests/test_main_window_shell.py` |
| REQ-GRAPH-004 | 30_GRAPH_MODEL | `ea_node_editor/graph/model.py`, `ea_node_editor/graph/scene.py`, `tests/test_graph_track_b.py` |
| REQ-GRAPH-005 | 30_GRAPH_MODEL | `ea_node_editor/graph/model.py`, `ea_node_editor/graph/scene.py`, `ea_node_editor/ui/main_window.py`, `tests/test_graph_track_b.py` |
| REQ-GRAPH-006 | 30_GRAPH_MODEL | `ea_node_editor/graph/model.py`, `ea_node_editor/workspace/manager.py`, `ea_node_editor/ui/main_window.py`, `tests/test_workspace_manager.py`, `tests/test_main_window_shell.py` |
| REQ-GRAPH-007 | 30_GRAPH_MODEL | `ea_node_editor/graph/items/node_item.py`, `edge_item.py` |
| REQ-GRAPH-008 | 30_GRAPH_MODEL | `ea_node_editor/graph/items/node_item.py`, `ea_node_editor/graph/scene.py`, `tests/test_graph_track_b.py` |
...
| REQ-NODE-004 | 40_NODE_SDK | `ea_node_editor/ui/panels/inspector_panel.py`, `ea_node_editor/graph/scene.py`, `ea_node_editor/execution/worker.py`, `tests/test_inspector_reflection.py` |
| REQ-NODE-005 | 40_NODE_SDK | `ea_node_editor/ui/panels/inspector_panel.py`, `ea_node_editor/graph/items/node_item.py`, `ea_node_editor/graph/scene.py`, `tests/test_graph_track_b.py` |
...
| REQ-EXEC-003 | 50_EXECUTION_ENGINE | `ea_node_editor/ui/main_window.py` Qt queued `execution_event` path, `ea_node_editor/execution/client.py` listener thread, `tests/test_main_window_shell.py` |
...
| REQ-EXEC-006 | 50_EXECUTION_ENGINE | `ea_node_editor/execution/worker.py` structured `run_failed` traceback payload, `ea_node_editor/ui/main_window.py` failure routing/focus, `tests/test_execution_worker.py`, `tests/test_main_window_shell.py` |
| REQ-EXEC-007 | 50_EXECUTION_ENGINE | `ea_node_editor/execution/worker.py` event emissions |
| REQ-UI-010 | 20_UI_UX | `ea_node_editor/ui/main_window.py` failed-node focus + parent-chain reveal via `parent_node_id`, `tests/test_main_window_shell.py` |
...
| REQ-PERSIST-005 | 60_PERSISTENCE | `ea_node_editor/persistence/serializer.py` migrate-before-model construction (`load`/`from_document`), `ea_node_editor/ui/main_window.py` guarded restore/open flow |
| REQ-PERSIST-006 | 60_PERSISTENCE | `ea_node_editor/ui/main_window.py` session restore/persist + autosave/recovery prompt flow, `tests/test_main_window_shell.py` session/autosave recovery tests including `test_recovery_prompt_is_deferred_until_main_window_is_visible` |
...
| REQ-PERF-004 | 80_PERFORMANCE | `ea_node_editor/graph/view.py` view optimization flags |
| REQ-PERF-005 | 80_PERFORMANCE | `ea_node_editor/graph/scene.py` explicit scene rect and local item updates, `tests/test_graph_track_b.py` |
...
| REQ-QA-007 | 90_QA_ACCEPTANCE | `ea_node_editor/ui/main_window.py`, `tests/test_main_window_shell.py` |
...
| REQ-ARCH-009 | 10_ARCHITECTURE | `ea_node_editor/ui/main_window.py` (`open_workflow_settings`, `toggle_script_editor`), `tests/test_theme_shell_rc2.py`, `tests/test_settings_dialog_rc2.py`, `tests/test_script_editor_dock_rc2.py` |
...
| REQ-UI-012 | 20_UI_UX | Workflow settings modal + API: `ea_node_editor/ui/dialogs/workflow_settings_dialog.py`, `ea_node_editor/ui/main_window.py::open_workflow_settings`, `tests/test_settings_dialog_rc2.py` |
| REQ-UI-013 | 20_UI_UX | Script editor dock + API: `ea_node_editor/ui/panels/script_editor_dock.py`, `ea_node_editor/ui/editor/code_editor.py`, `ea_node_editor/ui/main_window.py::toggle_script_editor`, `tests/test_script_editor_dock_rc2.py` |
| REQ-GRAPH-009 | 30_GRAPH_MODEL | Stitch visual refresh + LOD: `ea_node_editor/graph/scene.py`, `ea_node_editor/graph/items/node_item.py`, `ea_node_editor/graph/items/edge_item.py`, `ea_node_editor/graph/view.py`, `tests/test_graph_track_b.py` |
