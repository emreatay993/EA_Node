...
| REQ-GRAPH-010 | 30_GRAPH_MODEL | Hierarchy scope path + scope-aware scene ops: `ea_node_editor/graph/hierarchy.py`, `ea_node_editor/graph/transforms.py`, `ea_node_editor/ui_qml/graph_scene_bridge.py`, `tests/test_graph_track_b.py`, `tests/test_main_window_shell.py` |
...
| REQ-PERSIST-009 | 60_PERSISTENCE | Schema v3 scope/custom-workflow normalization and persistence: `ea_node_editor/settings.py`, `ea_node_editor/persistence/migration.py`, `ea_node_editor/persistence/project_codec.py`, `ea_node_editor/persistence/serializer.py`, `tests/test_serializer.py`, `tests/test_serializer_v2_migration_rc2.py` |
...
| AC-REQ-PERSIST-009-01 | 60_PERSISTENCE | Scope path + custom workflow save/load normalization: `tests/test_serializer.py`, `tests/test_serializer_v2_migration_rc2.py` |
