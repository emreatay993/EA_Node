...
- No `.cxproj` serializer migration or node-instance migration is required because node category metadata is not persisted on node instances.
...
| Library path filters, descendant-inclusive parent matching, nested Ansys DPF taxonomy, and root-segment graph-theme accents | `P02` | `REQ-NODE-003`, `REQ-NODE-025`, `REQ-INT-008` | `.\venv\Scripts\python.exe -m pytest tests/test_library_projection.py tests/test_dpf_node_catalog.py tests/test_graph_theme_shell.py -k nested_category_library --ignore=venv -q` | PASS in `docs/specs/work_packets/nested_node_categories/P02_registry_path_filters_and_dpf_taxonomy_WRAPUP.md` (`95d9b47ce4397253c87dba4d24b6a6d3fc95d25e`) |
| Library and DPF review gate for path filters and shipped taxonomy | `P02` | `AC-REQ-NODE-003-01`, `AC-REQ-NODE-025-01`, `AC-REQ-INT-008-01` | `.\venv\Scripts\python.exe -m pytest tests/test_library_projection.py tests/test_dpf_node_catalog.py -k nested_category_library --ignore=venv -q` | PASS in `docs/specs/work_packets/nested_node_categories/P02_registry_path_filters_and_dpf_taxonomy_WRAPUP.md` (`95d9b47ce4397253c87dba4d24b6a6d3fc95d25e`) |
