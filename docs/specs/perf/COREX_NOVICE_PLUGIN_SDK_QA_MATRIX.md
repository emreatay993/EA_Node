...
| Immutable execution | `tests/test_plugin_generation.py`, `tests/test_execution_protocol.py`, `tests/test_execution_client.py`, and `tests/test_execution_worker.py` cover approved roots, full registry agreement, digest recheck, lazy import, source mutation, and worker retirement. |
