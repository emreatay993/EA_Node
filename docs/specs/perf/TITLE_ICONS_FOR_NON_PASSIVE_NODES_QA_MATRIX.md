...
| Collapsed Group glyph exception and unchanged `uiIcons` / `comment.svg` behavior alongside the new header contract | `P03` | `REQ-UI-038`, `REQ-PERF-013`, `AC-REQ-PERF-013-01` | `$env:QT_QPA_PLATFORM='offscreen'; .\venv\Scripts\python.exe -m pytest tests/main_window_shell/group_backdrop_workflows.py tests/main_window_shell/shell_runtime_contracts.py tests/test_icon_registry.py tests/test_group_backdrop_contracts.py -k title_icon --ignore=venv -q` | Accepted `P03` packet commit `a0cbb845271b2b8d8be0150d5fcb81609e305b2f` |
