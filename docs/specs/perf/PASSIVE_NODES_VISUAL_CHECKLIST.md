...
- Verify per-node overrides render after open: the decision, document, input/output, and annotation note keep their distinct passive colors while Media Panel uses active-node chrome.
