...
| `code.python_script` | Python Script | `active` | `TrustedFactoryEntry` | `ea_node_editor/nodes/builtins/core.py` | Code | `never` | `untrusted_user_code` | `not_required_never` | `not_used_never` | `not_reusable` | `none` | `user_code_untrusted` | `tests/test_python_script_declaration.py` |
