...
- Source roots: `ea_node_editor`, `web/excalidraw_host`
- Test roots: `tests`
...
| `ea_node_editor/addons/ansys_dpf/doc_generation.py` |
| `ea_node_editor/addons/ansys_dpf/helper_catalog.py` |
| `ea_node_editor/addons/ansys_dpf/metadata.py` |
| `ea_node_editor/addons/ansys_dpf/operator_catalog.py` |
| `ea_node_editor/addons/ansys_dpf/operator_docs.py` |
...
| `ea_node_editor/execution/dpf_runtime/optional_imports.py` |
...
| `ea_node_editor/graph/input_semantics.py` |
...
| `ea_node_editor/graph/pdf_panel_page_policy.py` |
...
| `ea_node_editor/help/_qt_markdown.py` |
...
| `ea_node_editor/nodes/builtins/ansys_dpf_node_helpers.py` |
...
| `ea_node_editor/nodes/builtins/core_unit_nodes.py` |
| `ea_node_editor/nodes/builtins/core_value_nodes.py` |
...
| `ea_node_editor/nodes/builtins/math_interval.py` |
...
| `ea_node_editor/nodes/builtins/plot/signal.py` |
...
| `tests/test_ansys_dpf_example_projects.py` |
...
| `tests/test_dene3_dpf_showcase.py` |
...
| `tests/test_dpf_metadata_options_service.py` |
| `tests/test_dpf_node_catalog.py` |
| `tests/test_dpf_operator_catalog_asset.py` |
| `tests/test_dpf_operator_help_lookup.py` |
| `tests/test_dpf_operator_help_markdown.py` |
| `tests/test_dpf_property_edit_adapter.py` |
| `tests/test_dpf_property_groups.py` |
| `tests/test_dpf_runtime_analysis.py` |
| `tests/test_dpf_runtime_materialization_camera.py` |
...
| `tests/test_dpf_workflow_help.py` |
| `tests/test_dpf_workflow_helpers.py` |
| `tests/test_dpf_workflow_post_nodes.py` |
| `tests/test_dpf_workflow_recipes.py` |
| `tests/test_dpf_workflow_surface.py` |
