...
# lsdyna::binout::BND_P_M

**Version: 0.0.0**

## Description

Read binout bndout pressure moment from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| moment |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout pressure moment. |
 ...
 **Internal name**: lsdyna::binout::BND_P_M
...
ansys::dpf::Operator op("lsdyna::binout::BND_P_M"); // operator instantiation
