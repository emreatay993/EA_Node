...
# lsdyna::binout::NODOUT_A_RX

**Version: 0.0.0**

## Description

Read nodout acceleration rx from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| nodout_acceleration_rx |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | nodout_acceleration_rx |
 ...
 **Internal name**: lsdyna::binout::NODOUT_A_RX
...
ansys::dpf::Operator op("lsdyna::binout::NODOUT_A_RX"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_nodout_acceleration_rx = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_nodout_acceleration_rx = op.outputs.nodout_acceleration_rx()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_nodout_acceleration_rx = op.outputs.nodout_acceleration_rx.GetData()
```
</details>
<br>
