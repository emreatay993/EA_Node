...
Create frequency response chart from a complex fields container over time
...
| <strong>Pin 5</strong>|  averaging_type |[`int32`](../../core-concepts/dpf-types.md#standard-types) | 0 is min, 1 is max, 2 is average |
 ...
 **Internal name**: mechanical::chart
...
ansys::dpf::Operator op("mechanical::chart"); // operator instantiation
