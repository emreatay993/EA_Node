...
Read moddynout displacement from result streams
...
|-------|------|------------------|-------------|
|  **Pin 0**| moddynout_disp |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | moddynout_disp |
 ...
 **Internal name**: lsdyna::moddynout::U
...
ansys::dpf::Operator op("lsdyna::moddynout::U"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_moddynout_disp = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_moddynout_disp = op.outputs.moddynout_disp()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_moddynout_disp = op.outputs.moddynout_disp.GetData()
```
</details>
<br>
