...
Read ms em electric potential results from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| em_potential |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | results by specifying name. |
...
ansys::dpf::Operator op("lsdyna::ms::EM_P"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
ansys::dpf::FieldsContainer my_em_potential = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_em_potential = op.outputs.em_potential()
```
</details>
...
op.inputs.streams_container.Connect(my_streams_container)
op.inputs.data_sources.Connect(my_data_sources)
my_em_potential = op.outputs.em_potential.GetData()
```
</details>
<br>
