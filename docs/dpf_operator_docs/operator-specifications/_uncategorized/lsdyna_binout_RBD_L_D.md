...
# lsdyna::binout::RBD_L_D

**Version: 0.0.0**

## Description

Read binout rbdout local d from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout rbdout local d. |
 ...
 **Internal name**: lsdyna::binout::RBD_L_D
...
ansys::dpf::Operator op("lsdyna::binout::RBD_L_D"); // operator instantiation
