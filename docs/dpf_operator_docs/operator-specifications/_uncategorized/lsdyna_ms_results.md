...
Read ms results from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| results |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | results by specifying name. label: domain_id, variable_id |
 ...
 **Internal name**: lsdyna::ms::results
...
ansys::dpf::Operator op("lsdyna::ms::results"); // operator instantiation
