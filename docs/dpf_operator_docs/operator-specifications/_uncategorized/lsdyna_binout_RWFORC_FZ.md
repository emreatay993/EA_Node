...
# lsdyna::binout::RWFORC_FZ

**Version: 0.0.0**

## Description

Read rwforce force z from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| rwforc_force_z |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | rwforc_force_z |
 ...
 **Internal name**: lsdyna::binout::RWFORC_FZ
...
ansys::dpf::Operator op("lsdyna::binout::RWFORC_FZ"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_rwforc_force_z = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_rwforc_force_z = op.outputs.rwforc_force_z()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_rwforc_force_z = op.outputs.rwforc_force_z.GetData()
```
</details>
<br>
