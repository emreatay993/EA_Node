...
# composite::common_generic_data_container
 ...
 **Internal name**: composite::common_generic_data_container
...
ansys::dpf::Operator op("composite::common_generic_data_container"); // operator instantiation
