...
# lsdyna::binout::GLOB_KDE

**Version: 0.0.0**

## Description

Read global spring and damper energy from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| global_spring_damper_energy |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | global_spring_damper_energy |
 ...
 **Internal name**: lsdyna::binout::GLOB_KDE
...
ansys::dpf::Operator op("lsdyna::binout::GLOB_KDE"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_global_spring_damper_energy = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_global_spring_damper_energy = op.outputs.global_spring_damper_energy()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_global_spring_damper_energy = op.outputs.global_spring_damper_energy.GetData()
```
</details>
<br>
