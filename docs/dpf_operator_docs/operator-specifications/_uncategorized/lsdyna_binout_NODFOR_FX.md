...
# lsdyna::binout::NODFOR_FX

**Version: 0.0.0**

## Description

Read nodforc force x from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| nodfor_force_x |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | nodfor_force_x |
 ...
 **Internal name**: lsdyna::binout::NODFOR_FX
...
ansys::dpf::Operator op("lsdyna::binout::NODFOR_FX"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_nodfor_force_x = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_nodfor_force_x = op.outputs.nodfor_force_x()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_nodfor_force_x = op.outputs.nodfor_force_x.GetData()
```
</details>
<br>
