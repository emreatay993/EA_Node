...
# lsdyna::d3acs::TimeFreqSupportProvider
 ...
 **Internal name**: lsdyna::d3acs::TimeFreqSupportProvider
...
ansys::dpf::Operator op("lsdyna::d3acs::TimeFreqSupportProvider"); // operator instantiation
