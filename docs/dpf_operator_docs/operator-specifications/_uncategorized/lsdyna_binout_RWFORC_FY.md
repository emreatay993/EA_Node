...
# lsdyna::binout::RWFORC_FY

**Version: 0.0.0**

## Description

Read rwforce force y from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| rwforc_force_y |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | rwforc_force_y |
 ...
 **Internal name**: lsdyna::binout::RWFORC_FY
...
ansys::dpf::Operator op("lsdyna::binout::RWFORC_FY"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_rwforc_force_y = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_rwforc_force_y = op.outputs.rwforc_force_y()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_rwforc_force_y = op.outputs.rwforc_force_y.GetData()
```
</details>
<br>
