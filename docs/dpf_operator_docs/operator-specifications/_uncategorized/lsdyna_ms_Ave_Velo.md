...
Read ms average velocity results from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| average_velocity |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | results by specifying name. |
 ...
 **Internal name**: lsdyna::ms::Ave_Velo
...
ansys::dpf::Operator op("lsdyna::ms::Ave_Velo"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
ansys::dpf::FieldsContainer my_average_velocity = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_average_velocity = op.outputs.average_velocity()
```
</details>
...
op.inputs.streams_container.Connect(my_streams_container)
op.inputs.data_sources.Connect(my_data_sources)
my_average_velocity = op.outputs.average_velocity.GetData()
```
</details>
<br>
