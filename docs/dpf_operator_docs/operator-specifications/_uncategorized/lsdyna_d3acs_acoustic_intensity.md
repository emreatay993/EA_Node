...
# lsdyna::d3acs::acoustic_intensity
 ...
 **Internal name**: lsdyna::d3acs::acoustic_intensity
...
ansys::dpf::Operator op("lsdyna::d3acs::acoustic_intensity"); // operator instantiation
