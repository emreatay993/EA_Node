...
# lsdyna::binout::JNTFORC_MX

**Version: 0.0.0**

## Description

Read jntforc moment x from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| jntforc_mx |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | jntforc_mx |
 ...
 **Internal name**: lsdyna::binout::JNTFORC_MX
...
ansys::dpf::Operator op("lsdyna::binout::JNTFORC_MX"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_jntforc_mx = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_jntforc_mx = op.outputs.jntforc_mx()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_jntforc_mx = op.outputs.jntforc_mx.GetData()
```
</details>
<br>
