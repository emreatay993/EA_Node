...
# lsdyna::binout::RBD_L_V

**Version: 0.0.0**

## Description

Read binout rbdout local v from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout rbdout local v. |
 ...
 **Internal name**: lsdyna::binout::RBD_L_V
...
ansys::dpf::Operator op("lsdyna::binout::RBD_L_V"); // operator instantiation
