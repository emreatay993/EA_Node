...
# lsdyna::ms::vol_OHM_POWER

**Version: 0.0.0**

## Description

Read ms volumic ohm power results from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| volumic_ohm_power |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | results by specifying name. |
 ...
 **Internal name**: lsdyna::ms::vol_OHM_POWER
...
ansys::dpf::Operator op("lsdyna::ms::vol_OHM_POWER"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
ansys::dpf::FieldsContainer my_volumic_ohm_power = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_volumic_ohm_power = op.outputs.volumic_ohm_power()
```
</details>
...
op.inputs.streams_container.Connect(my_streams_container)
op.inputs.data_sources.Connect(my_data_sources)
my_volumic_ohm_power = op.outputs.volumic_ohm_power.GetData()
```
</details>
<br>
