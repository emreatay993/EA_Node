...
# lsdyna::binout::SLE_T_M

**Version: 0.0.0**

## Description

Read binout sleout total master from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout sleout total master. |
 ...
 **Internal name**: lsdyna::binout::SLE_T_M
...
ansys::dpf::Operator op("lsdyna::binout::SLE_T_M"); // operator instantiation
