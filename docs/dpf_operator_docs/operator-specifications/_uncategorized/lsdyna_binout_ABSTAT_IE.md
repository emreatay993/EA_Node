...
# lsdyna::binout::ABSTAT_IE

**Version: 0.0.0**

## Description

Read abstat internal energy from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| abstat_internal_energy |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | abstat_internal_energy |
 ...
 **Internal name**: lsdyna::binout::ABSTAT_IE
...
ansys::dpf::Operator op("lsdyna::binout::ABSTAT_IE"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_abstat_internal_energy = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_abstat_internal_energy = op.outputs.abstat_internal_energy()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_abstat_internal_energy = op.outputs.abstat_internal_energy.GetData()
```
</details>
<br>
