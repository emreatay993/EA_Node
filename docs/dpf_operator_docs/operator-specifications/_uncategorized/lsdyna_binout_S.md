...
Read stress from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| stress |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | stress |
...
ansys::dpf::Operator op("lsdyna::binout::S"); // operator instantiation
op.connect(1, my_mesh_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_stress = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_stress = op.outputs.stress.GetData()
```
</details>
<br>
