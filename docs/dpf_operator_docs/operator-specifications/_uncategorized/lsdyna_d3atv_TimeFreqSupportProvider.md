...
# lsdyna::d3atv::TimeFreqSupportProvider
 ...
 **Internal name**: lsdyna::d3atv::TimeFreqSupportProvider
...
ansys::dpf::Operator op("lsdyna::d3atv::TimeFreqSupportProvider"); // operator instantiation
