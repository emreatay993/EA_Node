...
# lsdyna::binout::RBD_G_RV

**Version: 0.0.0**

## Description

Read binout rbdout global rv from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout rbdout global rv. |
 ...
 **Internal name**: lsdyna::binout::RBD_G_RV
...
ansys::dpf::Operator op("lsdyna::binout::RBD_G_RV"); // operator instantiation
