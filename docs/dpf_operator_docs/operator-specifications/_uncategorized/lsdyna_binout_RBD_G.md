...
Read binout rbdout global from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout rbdout global. |
 ...
 **Internal name**: lsdyna::binout::RBD_G
...
ansys::dpf::Operator op("lsdyna::binout::RBD_G"); // operator instantiation
