...
# lsdyna::d3plot::EPPL_EQV

**Version: 0.0.0**

## Description

Read Plastic Strain eqv from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| effective_plastic_strain |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | effective plastic strain |
 ...
 **Internal name**: lsdyna::d3plot::EPPL_EQV
...
ansys::dpf::Operator op("lsdyna::d3plot::EPPL_EQV"); // operator instantiation
...
ansys::dpf::FieldsContainer my_effective_plastic_strain = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_effective_plastic_strain = op.outputs.effective_plastic_strain()
```
</details>
...
op.inputs.part_id.Connect(my_part_id)
op.inputs.unit_system.Connect(my_unit_system)
my_effective_plastic_strain = op.outputs.effective_plastic_strain.GetData()
```
</details>
<br>
