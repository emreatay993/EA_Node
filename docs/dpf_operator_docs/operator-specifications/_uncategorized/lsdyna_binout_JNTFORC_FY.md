...
# lsdyna::binout::JNTFORC_FY

**Version: 0.0.0**

## Description

Read jntforc force y from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| jntforc_fy |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | jntforc_fy |
 ...
 **Internal name**: lsdyna::binout::JNTFORC_FY
...
ansys::dpf::Operator op("lsdyna::binout::JNTFORC_FY"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_jntforc_fy = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_jntforc_fy = op.outputs.jntforc_fy()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_jntforc_fy = op.outputs.jntforc_fy.GetData()
```
</details>
<br>
