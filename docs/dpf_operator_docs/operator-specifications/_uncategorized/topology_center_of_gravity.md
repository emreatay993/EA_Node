...
|  **Pin 1**| mesh |[`abstract_meshed_region`](../../core-concepts/dpf-types.md#meshed-region) | Center of gravity as a mesh |
...
ansys::dpf::Operator op("topology::center_of_gravity"); // operator instantiation
