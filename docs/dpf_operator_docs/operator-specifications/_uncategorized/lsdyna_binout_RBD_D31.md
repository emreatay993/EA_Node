...
# lsdyna::binout::RBD_D31

**Version: 0.0.0**

## Description

Read binout rbdout dircos31 from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout rbdout dircos31. |
 ...
 **Internal name**: lsdyna::binout::RBD_D31
...
ansys::dpf::Operator op("lsdyna::binout::RBD_D31"); // operator instantiation
