...
|-------|------|------------------|-------------|
|  **Pin 0**| nodfor_total_force_y |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | nodfor_total_force_y |
 ...
 **Internal name**: lsdyna::binout::NODFOR_TOTAL_FY
...
ansys::dpf::Operator op("lsdyna::binout::NODFOR_TOTAL_FY"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_nodfor_total_force_y = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_nodfor_total_force_y = op.outputs.nodfor_total_force_y()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_nodfor_total_force_y = op.outputs.nodfor_total_force_y.GetData()
```
</details>
<br>
