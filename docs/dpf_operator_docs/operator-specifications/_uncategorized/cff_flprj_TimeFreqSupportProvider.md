...
# cff::flprj::TimeFreqSupportProvider
 ...
 **Internal name**: cff::flprj::TimeFreqSupportProvider
...
ansys::dpf::Operator op("cff::flprj::TimeFreqSupportProvider"); // operator instantiation
