...
# lsdyna::d3atv::ResultInfoProvider
 ...
 **Internal name**: lsdyna::d3atv::ResultInfoProvider
...
ansys::dpf::Operator op("lsdyna::d3atv::ResultInfoProvider"); // operator instantiation
