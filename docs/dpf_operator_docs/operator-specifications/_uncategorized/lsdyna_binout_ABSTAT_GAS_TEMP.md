...
# lsdyna::binout::ABSTAT_GAS_TEMP

**Version: 0.0.0**

## Description

Read abstat gas temperature from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| abstat_gas_temp |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | abstat_gas_temp |
 ...
 **Internal name**: lsdyna::binout::ABSTAT_GAS_TEMP
...
ansys::dpf::Operator op("lsdyna::binout::ABSTAT_GAS_TEMP"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_abstat_gas_temp = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_abstat_gas_temp = op.outputs.abstat_gas_temp()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_abstat_gas_temp = op.outputs.abstat_gas_temp.GetData()
```
</details>
<br>
