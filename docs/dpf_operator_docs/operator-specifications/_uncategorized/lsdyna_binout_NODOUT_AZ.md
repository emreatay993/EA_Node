...
# lsdyna::binout::NODOUT_AZ

**Version: 0.0.0**

## Description

Read nodout acceleration z from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| nodout_acceleration_z |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | nodout_acceleration_z |
 ...
 **Internal name**: lsdyna::binout::NODOUT_AZ
...
ansys::dpf::Operator op("lsdyna::binout::NODOUT_AZ"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_nodout_acceleration_z = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_nodout_acceleration_z = op.outputs.nodout_acceleration_z()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_nodout_acceleration_z = op.outputs.nodout_acceleration_z.GetData()
```
</details>
<br>
