...
# lsdyna::d3plot::time_freq_support_provider
...
|-------|------|------------------|-------------|
|  **Pin 0**| time_freq_support |[`time_freq_support`](../../core-concepts/dpf-types.md#time-freq-support) | (time_freq_support) |
 ...
 **Internal name**: lsdyna::d3plot::time_freq_support_provider
...
ansys::dpf::Operator op("lsdyna::d3plot::time_freq_support_provider"); // operator instantiation
