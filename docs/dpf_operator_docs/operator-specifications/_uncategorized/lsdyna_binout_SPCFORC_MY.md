...
# lsdyna::binout::SPCFORC_MY

**Version: 0.0.0**

## Description

Read spcforc moment y from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| spcforc_my |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | spcforc_my |
 ...
 **Internal name**: lsdyna::binout::SPCFORC_MY
...
ansys::dpf::Operator op("lsdyna::binout::SPCFORC_MY"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_spcforc_my = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_spcforc_my = op.outputs.spcforc_my()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_spcforc_my = op.outputs.spcforc_my.GetData()
```
</details>
<br>
