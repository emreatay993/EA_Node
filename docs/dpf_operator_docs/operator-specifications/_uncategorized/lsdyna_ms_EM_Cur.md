...
Read ms em current results from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| em_current |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | results by specifying name. |
 ...
 **Internal name**: lsdyna::ms::EM_Cur
...
ansys::dpf::Operator op("lsdyna::ms::EM_Cur"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
ansys::dpf::FieldsContainer my_em_current = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_em_current = op.outputs.em_current()
```
</details>
...
op.inputs.streams_container.Connect(my_streams_container)
op.inputs.data_sources.Connect(my_data_sources)
my_em_current = op.outputs.em_current.GetData()
```
</details>
<br>
