...
# lsdyna::binout::NODFOR_TOTAL_ENG

**Version: 0.0.0**

## Description

Read nodforc total energy from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| nodfor_total_energy |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | nodfor_total_energy |
 ...
 **Internal name**: lsdyna::binout::NODFOR_TOTAL_ENG
...
ansys::dpf::Operator op("lsdyna::binout::NODFOR_TOTAL_ENG"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_nodfor_total_energy = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_nodfor_total_energy = op.outputs.nodfor_total_energy()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_nodfor_total_energy = op.outputs.nodfor_total_energy.GetData()
```
</details>
<br>
