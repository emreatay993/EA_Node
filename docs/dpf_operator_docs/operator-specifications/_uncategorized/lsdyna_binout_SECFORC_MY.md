...
# lsdyna::binout::SECFORC_MY

**Version: 0.0.0**

## Description

Read secforc moment y from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| secforc_moment_y |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | secforc_moment_y |
 ...
 **Internal name**: lsdyna::binout::SECFORC_MY
...
ansys::dpf::Operator op("lsdyna::binout::SECFORC_MY"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_secforc_moment_y = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_secforc_moment_y = op.outputs.secforc_moment_y()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_secforc_moment_y = op.outputs.secforc_moment_y.GetData()
```
</details>
<br>
