...
# composite::rigid_transformation_provider
 ...
 **Internal name**: composite::rigid_transformation_provider
...
ansys::dpf::Operator op("composite::rigid_transformation_provider"); // operator instantiation
