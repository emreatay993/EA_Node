...
Read Displacement from result streams
...
|-------|------|------------------|-------------|
|  **Pin 0**| displacement |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | displacement |
...
ansys::dpf::Operator op("lsdyna::d3psd::U"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(1, my_mesh_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_displacement = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_displacement = op.outputs.displacement()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_displacement = op.outputs.displacement.GetData()
```
</details>
<br>
