...
# lsdyna::binout::RBD_D23

**Version: 0.0.0**

## Description

Read binout rbdout dircos23 from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout rbdout dircos23. |
 ...
 **Internal name**: lsdyna::binout::RBD_D23
...
ansys::dpf::Operator op("lsdyna::binout::RBD_D23"); // operator instantiation
