...
# lsdyna::d3plot::custom

**Version: 0.0.0**

## Description

Extract a result from an RST file using the operator passed through result_name input pin.
...
| <strong>Pin 60</strong>|  result_name |[`string`](../../core-concepts/dpf-types.md#standard-types) | Name of the result that must be extracted from the file |

## Outputs

| Output |  Name | Expected type(s) | Description |
|-------|------|------------------|-------------|
|  **Pin 0**| custom |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | custom |
 ...
 **Internal name**: lsdyna::d3plot::custom
...
ansys::dpf::Operator op("lsdyna::d3plot::custom"); // operator instantiation
...
ansys::dpf::FieldsContainer my_custom = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
op.inputs.unit_system.Connect(my_unit_system)
op.inputs.result_name.Connect(my_result_name)
my_custom = op.outputs.custom.GetData()
```
</details>
<br>
