...
# composite::MaterialPropertyOfElement
 ...
 **Internal name**: composite::MaterialPropertyOfElement
...
ansys::dpf::Operator op("composite::MaterialPropertyOfElement"); // operator instantiation
