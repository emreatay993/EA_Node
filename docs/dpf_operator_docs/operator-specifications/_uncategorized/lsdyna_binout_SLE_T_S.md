...
# lsdyna::binout::SLE_T_S

**Version: 0.0.0**

## Description

Read binout sleout total slave from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout sleout total slave. |
 ...
 **Internal name**: lsdyna::binout::SLE_T_S
...
ansys::dpf::Operator op("lsdyna::binout::SLE_T_S"); // operator instantiation
