...
# lsdyna::binout::RWFORC_NF

**Version: 0.0.0**

## Description

Read rwforce normal force from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| rwforc_normal_force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | rwforc_normal_force |
 ...
 **Internal name**: lsdyna::binout::RWFORC_NF
...
ansys::dpf::Operator op("lsdyna::binout::RWFORC_NF"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_rwforc_normal_force = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_rwforc_normal_force = op.outputs.rwforc_normal_force()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_rwforc_normal_force = op.outputs.rwforc_normal_force.GetData()
```
</details>
<br>
