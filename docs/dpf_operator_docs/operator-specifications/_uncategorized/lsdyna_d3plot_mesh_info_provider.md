...
# lsdyna::d3plot::mesh_info_provider

**Version: 0.0.0**

## Description

Read mesh metadata from result files and cure degenerated elements
...
|-------|------|------------------|-------------|
|  **Pin 0**| mesh_info |[`mesh_info`](../../core-concepts/dpf-types.md#mesh-info) | mesh info |
 ...
 **Internal name**: lsdyna::d3plot::mesh_info_provider
...
ansys::dpf::Operator op("lsdyna::d3plot::mesh_info_provider"); // operator instantiation
