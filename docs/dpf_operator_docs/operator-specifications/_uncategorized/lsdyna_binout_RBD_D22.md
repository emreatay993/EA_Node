...
# lsdyna::binout::RBD_D22

**Version: 0.0.0**

## Description

Read binout rbdout dircos22 from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout rbdout dircos22. |
 ...
 **Internal name**: lsdyna::binout::RBD_D22
...
ansys::dpf::Operator op("lsdyna::binout::RBD_D22"); // operator instantiation
