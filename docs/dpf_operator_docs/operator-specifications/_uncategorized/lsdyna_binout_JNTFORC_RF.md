...
# lsdyna::binout::JNTFORC_RF

**Version: 0.0.0**

## Description

Read jntforc resultant force from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| jntforc_resultant_force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | jntforc_resultant_force |
 ...
 **Internal name**: lsdyna::binout::JNTFORC_RF
...
ansys::dpf::Operator op("lsdyna::binout::JNTFORC_RF"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_jntforc_resultant_force = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_jntforc_resultant_force = op.outputs.jntforc_resultant_force()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_jntforc_resultant_force = op.outputs.jntforc_resultant_force.GetData()
```
</details>
<br>
