...
# lsdyna::binout::SLE_SM

**Version: 0.0.0**

## Description

Read binout sleout slave master from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout sleout slave master. |
 ...
 **Internal name**: lsdyna::binout::SLE_SM
...
ansys::dpf::Operator op("lsdyna::binout::SLE_SM"); // operator instantiation
