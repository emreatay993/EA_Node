...
# lsdyna::d3psd::TimeFreqSupportProvider
 ...
 **Internal name**: lsdyna::d3psd::TimeFreqSupportProvider
...
ansys::dpf::Operator op("lsdyna::d3psd::TimeFreqSupportProvider"); // operator instantiation
