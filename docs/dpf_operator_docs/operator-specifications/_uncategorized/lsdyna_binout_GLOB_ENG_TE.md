...
|-------|------|------------------|-------------|
|  **Pin 0**| global_total_energy |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | global_total_energy |
 ...
 **Internal name**: lsdyna::binout::GLOB_ENG_TE
...
ansys::dpf::Operator op("lsdyna::binout::GLOB_ENG_TE"); // operator instantiation
