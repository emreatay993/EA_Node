...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout rbdout dircos13. |
 ...
 **Internal name**: lsdyna::binout::RBD_D13
...
ansys::dpf::Operator op("lsdyna::binout::RBD_D13"); // operator instantiation
