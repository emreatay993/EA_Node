...
# lsdyna::binout::SECFORC_CENTROIDX

**Version: 0.0.0**

## Description

Read secforc centroid x from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| secforc_centroid_x |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | secforc_centroid_x |
 ...
 **Internal name**: lsdyna::binout::SECFORC_CENTROIDX
...
ansys::dpf::Operator op("lsdyna::binout::SECFORC_CENTROIDX"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_secforc_centroid_x = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_secforc_centroid_x = op.outputs.secforc_centroid_x()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_secforc_centroid_x = op.outputs.secforc_centroid_x.GetData()
```
</details>
<br>
