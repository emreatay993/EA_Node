...
# lsdyna::d3psd::ResultInfoProvider
 ...
 **Internal name**: lsdyna::d3psd::ResultInfoProvider
...
ansys::dpf::Operator op("lsdyna::d3psd::ResultInfoProvider"); // operator instantiation
