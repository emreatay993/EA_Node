...
# lsdyna::ms::QCriterion

**Version: 0.0.0**

## Description

Read ms Q Criterion results from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| q_criterion |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | results by specifying name. |
 ...
 **Internal name**: lsdyna::ms::QCriterion
...
ansys::dpf::Operator op("lsdyna::ms::QCriterion"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
ansys::dpf::FieldsContainer my_q_criterion = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_q_criterion = op.outputs.q_criterion()
```
</details>
...
op.inputs.streams_container.Connect(my_streams_container)
op.inputs.data_sources.Connect(my_data_sources)
my_q_criterion = op.outputs.q_criterion.GetData()
```
</details>
<br>
