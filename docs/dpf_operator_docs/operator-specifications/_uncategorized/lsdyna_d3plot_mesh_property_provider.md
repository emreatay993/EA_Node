...
# lsdyna::d3plot::mesh_property_provider
...
| <strong>Pin 13</strong>|  property_name |[`string`](../../core-concepts/dpf-types.md#standard-types) | Supported property names are: 'part_id'. |
...
|-------|------|------------------|-------------|
|  **Pin 0**| property_field |[`property_field`](../../core-concepts/dpf-types.md#property-field) | Returns a property field for properties: 'part_id'. |
 ...
 **Internal name**: lsdyna::d3plot::mesh_property_provider
...
ansys::dpf::Operator op("lsdyna::d3plot::mesh_property_provider"); // operator instantiation
