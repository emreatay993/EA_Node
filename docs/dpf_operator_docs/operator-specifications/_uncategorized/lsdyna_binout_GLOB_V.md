...
|-------|------|------------------|-------------|
|  **Pin 0**| global_velocity |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | global_velocity |
 ...
 **Internal name**: lsdyna::binout::GLOB_V
...
ansys::dpf::Operator op("lsdyna::binout::GLOB_V"); // operator instantiation
