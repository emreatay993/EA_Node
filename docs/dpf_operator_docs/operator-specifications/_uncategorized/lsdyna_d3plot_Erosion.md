...
# lsdyna::d3plot::Erosion

**Version: 0.0.0**

## Description

Read/compute element erosion flag.
...
|-------|------|------------------|-------------|
|  **Pin 0**| erosion |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | Erosion flag |
 ...
 **Internal name**: lsdyna::d3plot::Erosion
...
ansys::dpf::Operator op("lsdyna::d3plot::Erosion"); // operator instantiation
...
ansys::dpf::FieldsContainer my_erosion = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
op.inputs.part_id.Connect(my_part_id)
op.inputs.unit_system.Connect(my_unit_system)
my_erosion = op.outputs.erosion.GetData()
```
</details>
<br>
