...
# lsdyna::binout::RBD_G_RD

**Version: 0.0.0**

## Description

Read binout rbdout global rd from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout rbdout global rd. |
 ...
 **Internal name**: lsdyna::binout::RBD_G_RD
...
ansys::dpf::Operator op("lsdyna::binout::RBD_G_RD"); // operator instantiation
