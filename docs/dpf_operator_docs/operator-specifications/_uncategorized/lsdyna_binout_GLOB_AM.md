...
# lsdyna::binout::GLOB_AM

**Version: 0.0.0**

## Description

Read global added mass from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| global_added_mass |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | global_added_mass |
 ...
 **Internal name**: lsdyna::binout::GLOB_AM
...
ansys::dpf::Operator op("lsdyna::binout::GLOB_AM"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_global_added_mass = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_global_added_mass = op.outputs.global_added_mass()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_global_added_mass = op.outputs.global_added_mass.GetData()
```
</details>
<br>
