...
# lsdyna::binout::RBD_D11

**Version: 0.0.0**

## Description

Read binout rbdout dircos11 from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout rbdout dircos11. |
 ...
 **Internal name**: lsdyna::binout::RBD_D11
...
ansys::dpf::Operator op("lsdyna::binout::RBD_D11"); // operator instantiation
