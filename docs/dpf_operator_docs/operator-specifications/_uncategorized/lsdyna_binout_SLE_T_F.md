...
# lsdyna::binout::SLE_T_F

**Version: 0.0.0**

## Description

Read binout sleout total friction from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout sleout total friction. |
 ...
 **Internal name**: lsdyna::binout::SLE_T_F
...
ansys::dpf::Operator op("lsdyna::binout::SLE_T_F"); // operator instantiation
