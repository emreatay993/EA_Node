...
# lsdyna::binout::SWFORC_RM

**Version: 0.0.0**

## Description

Read swforc resultant moment from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| swforc_resultant_moment |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | swforc_resultant_moment |
 ...
 **Internal name**: lsdyna::binout::SWFORC_RM
...
ansys::dpf::Operator op("lsdyna::binout::SWFORC_RM"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_swforc_resultant_moment = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_swforc_resultant_moment = op.outputs.swforc_resultant_moment()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_swforc_resultant_moment = op.outputs.swforc_resultant_moment.GetData()
```
</details>
<br>
