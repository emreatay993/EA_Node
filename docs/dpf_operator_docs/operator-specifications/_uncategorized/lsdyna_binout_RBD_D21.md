...
# lsdyna::binout::RBD_D21

**Version: 0.0.0**

## Description

Read binout rbdout dircos21 from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout rbdout dircos21. |
 ...
 **Internal name**: lsdyna::binout::RBD_D21
...
ansys::dpf::Operator op("lsdyna::binout::RBD_D21"); // operator instantiation
