...
# lsdyna::binout::BND_VN_F

**Version: 0.0.0**

## Description

Read binout bndout velocity nodes force from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout velocity nodes force. |
 ...
 **Internal name**: lsdyna::binout::BND_VN_F
...
ansys::dpf::Operator op("lsdyna::binout::BND_VN_F"); // operator instantiation
