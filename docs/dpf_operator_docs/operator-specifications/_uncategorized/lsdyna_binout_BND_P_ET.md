...
# lsdyna::binout::BND_P_ET

**Version: 0.0.0**

## Description

Read binout bndout pressure etotal from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| etotal |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout pressure etotal. |
 ...
 **Internal name**: lsdyna::binout::BND_P_ET
...
ansys::dpf::Operator op("lsdyna::binout::BND_P_ET"); // operator instantiation
