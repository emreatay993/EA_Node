...
Read Von Mises Strain from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| von_mises_strain |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | von mises strain |
 ...
 **Internal name**: lsdyna::d3plot::strain_von_mises
...
ansys::dpf::Operator op("lsdyna::d3plot::strain_von_mises"); // operator instantiation
...
ansys::dpf::FieldsContainer my_von_mises_strain = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_von_mises_strain = op.outputs.von_mises_strain()
```
</details>
...
op.inputs.part_id.Connect(my_part_id)
op.inputs.unit_system.Connect(my_unit_system)
my_von_mises_strain = op.outputs.von_mises_strain.GetData()
```
</details>
<br>
