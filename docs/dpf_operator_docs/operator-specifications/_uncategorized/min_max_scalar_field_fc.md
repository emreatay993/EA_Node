...
# min_max_scalar_field_fc

**Version: 0.0.0**

## Description

Compute the minimum (out 0) and maximum (out 1) over a container of scalar fields.
 ...
 **Internal name**: min_max_scalar_field_fc
...
ansys::dpf::Operator op("min_max_scalar_field_fc"); // operator instantiation
