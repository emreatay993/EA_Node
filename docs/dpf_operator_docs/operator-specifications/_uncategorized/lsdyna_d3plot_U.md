...
|-------|------|------------------|-------------|
|  **Pin 0**| displacement |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | Displacement results |
...
ansys::dpf::Operator op("lsdyna::d3plot::U"); // operator instantiation
