...
Read binout matsum kinetic energy from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| kinetic_energy_t |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | kinetic_energy_t |
 ...
 **Internal name**: lsdyna::binout::M_KE
...
ansys::dpf::Operator op("lsdyna::binout::M_KE"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(6, my_part_scoping);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_kinetic_energy_t = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_kinetic_energy_t = op.outputs.kinetic_energy_t()
```
</details>
...
op.inputs.part_scoping.Connect(my_part_scoping)
op.inputs.unit_system.Connect(my_unit_system)
my_kinetic_energy_t = op.outputs.kinetic_energy_t.GetData()
```
</details>
<br>
