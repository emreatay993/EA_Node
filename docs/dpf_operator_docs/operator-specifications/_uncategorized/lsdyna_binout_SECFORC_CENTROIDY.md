...
# lsdyna::binout::SECFORC_CENTROIDY

**Version: 0.0.0**

## Description

Read secforc centroid y from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| secforc_centroid_y |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | secforc_centroid_y |
 ...
 **Internal name**: lsdyna::binout::SECFORC_CENTROIDY
...
ansys::dpf::Operator op("lsdyna::binout::SECFORC_CENTROIDY"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_secforc_centroid_y = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_secforc_centroid_y = op.outputs.secforc_centroid_y()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_secforc_centroid_y = op.outputs.secforc_centroid_y.GetData()
```
</details>
<br>
