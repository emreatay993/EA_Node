...
# lsdyna::binout::BND_P_T

**Version: 0.0.0**

## Description

Read binout bndout pressure total from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| total |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout pressure total. |
 ...
 **Internal name**: lsdyna::binout::BND_P_T
...
ansys::dpf::Operator op("lsdyna::binout::BND_P_T"); // operator instantiation
