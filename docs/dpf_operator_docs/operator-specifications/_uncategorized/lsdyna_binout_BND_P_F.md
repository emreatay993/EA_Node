...
# lsdyna::binout::BND_P_F

**Version: 0.0.0**

## Description

Read binout bndout pressure force from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout pressure force. |
 ...
 **Internal name**: lsdyna::binout::BND_P_F
...
ansys::dpf::Operator op("lsdyna::binout::BND_P_F"); // operator instantiation
