...
# lsdyna::d3acp::result_info_provider
 ...
 **Internal name**: lsdyna::d3acp::result_info_provider
...
ansys::dpf::Operator op("lsdyna::d3acp::result_info_provider"); // operator instantiation
