...
# lsdyna::binout::SBTOUT_RETRACTOR_FORCE

**Version: 0.0.0**

## Description

Read sbtout retractor force from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| sbtout_retractor_force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | sbtout_retractor_force |
 ...
 **Internal name**: lsdyna::binout::SBTOUT_RETRACTOR_FORCE
...
ansys::dpf::Operator op("lsdyna::binout::SBTOUT_RETRACTOR_FORCE"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_sbtout_retractor_force = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_sbtout_retractor_force = op.outputs.sbtout_retractor_force()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_sbtout_retractor_force = op.outputs.sbtout_retractor_force.GetData()
```
</details>
<br>
