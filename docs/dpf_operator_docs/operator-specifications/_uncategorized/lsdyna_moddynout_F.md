...
Read moddynout force from result streams
...
|-------|------|------------------|-------------|
|  **Pin 0**| moddynout_force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | moddynout_force |
 ...
 **Internal name**: lsdyna::moddynout::F
...
ansys::dpf::Operator op("lsdyna::moddynout::F"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_moddynout_force = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_moddynout_force = op.outputs.moddynout_force()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_moddynout_force = op.outputs.moddynout_force.GetData()
```
</details>
<br>
