...
# lsdyna::binout::SECFORC_FTotal

**Version: 0.0.0**

## Description

Read secforc force total from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| secforc_force_total |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | secforc_force_total |
 ...
 **Internal name**: lsdyna::binout::SECFORC_FTotal
...
ansys::dpf::Operator op("lsdyna::binout::SECFORC_FTotal"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_secforc_force_total = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_secforc_force_total = op.outputs.secforc_force_total()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_secforc_force_total = op.outputs.secforc_force_total.GetData()
```
</details>
<br>
