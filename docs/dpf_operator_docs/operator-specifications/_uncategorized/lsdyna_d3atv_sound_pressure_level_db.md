...
# lsdyna::d3atv::sound_pressure_level_db

**Version: 0.0.0**

## Description

Read Sound Pressure Level from result streams
...
|-------|------|------------------|-------------|
|  **Pin 0**| sound_pressure_level |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | sound pressure level |
 ...
 **Internal name**: lsdyna::d3atv::sound_pressure_level_db
...
ansys::dpf::Operator op("lsdyna::d3atv::sound_pressure_level_db"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(1, my_mesh_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_sound_pressure_level = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_sound_pressure_level = op.outputs.sound_pressure_level()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_sound_pressure_level = op.outputs.sound_pressure_level.GetData()
```
</details>
<br>
