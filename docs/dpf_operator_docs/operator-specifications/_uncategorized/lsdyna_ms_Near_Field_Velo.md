...
# lsdyna::ms::Near_Field_Velo

**Version: 0.0.0**

## Description

Read ms nodal near field velocity results from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| near_field_velocity |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | results by specifying name. |
 ...
 **Internal name**: lsdyna::ms::Near_Field_Velo
...
ansys::dpf::Operator op("lsdyna::ms::Near_Field_Velo"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
ansys::dpf::FieldsContainer my_near_field_velocity = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_near_field_velocity = op.outputs.near_field_velocity()
```
</details>
...
op.inputs.streams_container.Connect(my_streams_container)
op.inputs.data_sources.Connect(my_data_sources)
my_near_field_velocity = op.outputs.near_field_velocity.GetData()
```
</details>
<br>
