...
# lsdyna::ms::randle_RO_I_2

**Version: 0.0.0**

## Description

Read ms randle r0*i^2 results from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| randle_r0*i^2 |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | results by specifying name. |
 ...
 **Internal name**: lsdyna::ms::randle_RO_I_2
...
ansys::dpf::Operator op("lsdyna::ms::randle_RO_I_2"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
ansys::dpf::FieldsContainer my_randle_r0*i^2 = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_randle_r0*i^2 = op.outputs.randle_r0*i^2()
```
</details>
...
op.inputs.streams_container.Connect(my_streams_container)
op.inputs.data_sources.Connect(my_data_sources)
my_randle_r0*i^2 = op.outputs.randle_r0*i^2.GetData()
```
</details>
<br>
