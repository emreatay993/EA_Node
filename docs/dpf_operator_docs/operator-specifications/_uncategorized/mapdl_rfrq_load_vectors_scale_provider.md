...
# mapdl::rfrq::load_vectors_scale_provider

**Version: 0.0.0**

## Description

Retrieve load vectors scale coefficients from rfrq/rdsp file.
 ...
 **Internal name**: mapdl::rfrq::load_vectors_scale_provider
...
ansys::dpf::Operator op("mapdl::rfrq::load_vectors_scale_provider"); // operator instantiation
