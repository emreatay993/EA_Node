...
# lsdyna::binout::GLOB_EW

**Version: 0.0.0**

## Description

Read global external work from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| global_external_work |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | global_external_work |
 ...
 **Internal name**: lsdyna::binout::GLOB_EW
...
ansys::dpf::Operator op("lsdyna::binout::GLOB_EW"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_global_external_work = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_global_external_work = op.outputs.global_external_work()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_global_external_work = op.outputs.global_external_work.GetData()
```
</details>
<br>
