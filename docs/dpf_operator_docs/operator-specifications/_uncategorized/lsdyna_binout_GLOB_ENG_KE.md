...
|-------|------|------------------|-------------|
|  **Pin 0**| global_kinetic_energy |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | global_kinetic_energy |
 ...
 **Internal name**: lsdyna::binout::GLOB_ENG_KE
...
ansys::dpf::Operator op("lsdyna::binout::GLOB_ENG_KE"); // operator instantiation
