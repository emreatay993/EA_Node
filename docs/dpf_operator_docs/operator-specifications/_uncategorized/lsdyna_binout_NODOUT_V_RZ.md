...
# lsdyna::binout::NODOUT_V_RZ

**Version: 0.0.0**

## Description

Read nodout velocity rz from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| nodout_velocity_rz |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | nodout_velocity_rz |
 ...
 **Internal name**: lsdyna::binout::NODOUT_V_RZ
...
ansys::dpf::Operator op("lsdyna::binout::NODOUT_V_RZ"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_nodout_velocity_rz = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_nodout_velocity_rz = op.outputs.nodout_velocity_rz()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_nodout_velocity_rz = op.outputs.nodout_velocity_rz.GetData()
```
</details>
<br>
