...
Provides a Mapping object that interpolates results at the mid nodes.
 ...
 **Internal name**: mid_node_mapping_provider
...
ansys::dpf::Operator op("mid_node_mapping_provider"); // operator instantiation
