...
Read ms ohm heating power results from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| ohm_heating_power |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | results by specifying name. |
 ...
 **Internal name**: lsdyna::ms::OHM_HP
...
ansys::dpf::Operator op("lsdyna::ms::OHM_HP"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
ansys::dpf::FieldsContainer my_ohm_heating_power = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_ohm_heating_power = op.outputs.ohm_heating_power()
```
</details>
...
op.inputs.streams_container.Connect(my_streams_container)
op.inputs.data_sources.Connect(my_data_sources)
my_ohm_heating_power = op.outputs.ohm_heating_power.GetData()
```
</details>
<br>
