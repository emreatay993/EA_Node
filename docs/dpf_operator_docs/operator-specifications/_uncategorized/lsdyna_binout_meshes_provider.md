...
Generate fake mesh for binout files
 ...
 **Internal name**: lsdyna::binout::meshes_provider
...
ansys::dpf::Operator op("lsdyna::binout::meshes_provider"); // operator instantiation
