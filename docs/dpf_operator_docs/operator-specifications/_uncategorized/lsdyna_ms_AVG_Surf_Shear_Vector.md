...
# lsdyna::ms::AVG_Surf_Shear_Vector

**Version: 0.0.0**

## Description

Read ms avg surface shear vector results from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| avg_surface_shear_vector |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | results by specifying name. |
 ...
 **Internal name**: lsdyna::ms::AVG_Surf_Shear_Vector
...
ansys::dpf::Operator op("lsdyna::ms::AVG_Surf_Shear_Vector"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
ansys::dpf::FieldsContainer my_avg_surface_shear_vector = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_avg_surface_shear_vector = op.outputs.avg_surface_shear_vector()
```
</details>
...
op.inputs.streams_container.Connect(my_streams_container)
op.inputs.data_sources.Connect(my_data_sources)
my_avg_surface_shear_vector = op.outputs.avg_surface_shear_vector.GetData()
```
</details>
<br>
