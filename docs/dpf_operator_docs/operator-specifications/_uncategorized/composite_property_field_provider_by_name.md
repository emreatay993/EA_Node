...
# composite::property_field_provider_by_name
 ...
 **Internal name**: composite::property_field_provider_by_name
...
ansys::dpf::Operator op("composite::property_field_provider_by_name"); // operator instantiation
