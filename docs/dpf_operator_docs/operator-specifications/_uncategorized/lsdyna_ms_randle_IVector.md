...
# lsdyna::ms::randle_IVector

**Version: 0.0.0**

## Description

Read ms randle i vector results from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| randle_i_vector |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | results by specifying name. |
 ...
 **Internal name**: lsdyna::ms::randle_IVector
...
ansys::dpf::Operator op("lsdyna::ms::randle_IVector"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
ansys::dpf::FieldsContainer my_randle_i_vector = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_randle_i_vector = op.outputs.randle_i_vector()
```
</details>
...
op.inputs.streams_container.Connect(my_streams_container)
op.inputs.data_sources.Connect(my_data_sources)
my_randle_i_vector = op.outputs.randle_i_vector.GetData()
```
</details>
<br>
