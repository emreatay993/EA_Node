...
# cff::cas::TimeFreqSupportProvider
 ...
 **Internal name**: cff::cas::TimeFreqSupportProvider
...
ansys::dpf::Operator op("cff::cas::TimeFreqSupportProvider"); // operator instantiation
