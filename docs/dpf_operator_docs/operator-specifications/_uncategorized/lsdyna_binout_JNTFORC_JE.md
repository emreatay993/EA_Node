...
# lsdyna::binout::JNTFORC_JE

**Version: 0.0.0**

## Description

Read jntforc joint energy from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| jntforc_joint_energy |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | jntforc_joint_energy |
 ...
 **Internal name**: lsdyna::binout::JNTFORC_JE
...
ansys::dpf::Operator op("lsdyna::binout::JNTFORC_JE"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_jntforc_joint_energy = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_jntforc_joint_energy = op.outputs.jntforc_joint_energy()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_jntforc_joint_energy = op.outputs.jntforc_joint_energy.GetData()
```
</details>
<br>
