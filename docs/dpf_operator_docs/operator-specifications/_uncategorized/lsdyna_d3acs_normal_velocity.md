...
# lsdyna::d3acs::normal_velocity

**Version: 0.0.0**

## Description

Read Normal Velocity from result streams
...
|-------|------|------------------|-------------|
|  **Pin 0**| normal_velocity |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | normal velocity |
 ...
 **Internal name**: lsdyna::d3acs::normal_velocity
...
ansys::dpf::Operator op("lsdyna::d3acs::normal_velocity"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(1, my_mesh_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_normal_velocity = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_normal_velocity = op.outputs.normal_velocity()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_normal_velocity = op.outputs.normal_velocity.GetData()
```
</details>
<br>
