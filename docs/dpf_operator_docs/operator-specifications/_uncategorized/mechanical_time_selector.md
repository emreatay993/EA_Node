...
# mechanical::time_selector

**Version: 0.0.0**

## Description

For the single field container added in input, select a subset of the field container corresponding to the time scoping in input (pin 0)
...
|  **Pin 1**| vector<int32> |[`vector<int32>`](../../core-concepts/dpf-types.md#standard-types) |  |
|  **Pin 2**| scoping |[`scoping`](../../core-concepts/dpf-types.md#scoping) |  |
 ...
 **Internal name**: mechanical::time_selector
...
ansys::dpf::Operator op("mechanical::time_selector"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(1, my_fields_container);
ansys::dpf::FieldsContainer my_fields_container = op.getOutput<ansys::dpf::FieldsContainer>(0);
std::vector<int> my_vector<int32> = op.getOutput<std::vector<int>>(1);
ansys::dpf::Scoping my_scoping = op.getOutput<ansys::dpf::Scoping>(2);
```
</details>
