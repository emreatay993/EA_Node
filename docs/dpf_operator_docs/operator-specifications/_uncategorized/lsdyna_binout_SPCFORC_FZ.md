...
# lsdyna::binout::SPCFORC_FZ

**Version: 0.0.0**

## Description

Read spcforc force z from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| spcforc_fz |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | spcforc_fz |
 ...
 **Internal name**: lsdyna::binout::SPCFORC_FZ
...
ansys::dpf::Operator op("lsdyna::binout::SPCFORC_FZ"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_spcforc_fz = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_spcforc_fz = op.outputs.spcforc_fz()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_spcforc_fz = op.outputs.spcforc_fz.GetData()
```
</details>
<br>
