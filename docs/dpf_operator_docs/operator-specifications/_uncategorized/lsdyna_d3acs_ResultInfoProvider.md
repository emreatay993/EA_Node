...
# lsdyna::d3acs::ResultInfoProvider
 ...
 **Internal name**: lsdyna::d3acs::ResultInfoProvider
...
ansys::dpf::Operator op("lsdyna::d3acs::ResultInfoProvider"); // operator instantiation
