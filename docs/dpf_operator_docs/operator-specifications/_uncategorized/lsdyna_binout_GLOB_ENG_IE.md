...
|-------|------|------------------|-------------|
|  **Pin 0**| global_internal_energy |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | global_internal_energy |
 ...
 **Internal name**: lsdyna::binout::GLOB_ENG_IE
...
ansys::dpf::Operator op("lsdyna::binout::GLOB_ENG_IE"); // operator instantiation
