...
# composite::MeshProvider

**Version: 0.0.0**

## Description

Creates a composite material based on a given streams
 ...
 **Internal name**: composite::MeshProvider
...
ansys::dpf::Operator op("composite::MeshProvider"); // operator instantiation
