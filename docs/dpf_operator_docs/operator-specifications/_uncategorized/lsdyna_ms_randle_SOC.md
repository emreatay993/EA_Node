...
# lsdyna::ms::randle_SOC

**Version: 0.0.0**

## Description

Read ms randle soc results from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| randle_soc |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | results by specifying name. |
 ...
 **Internal name**: lsdyna::ms::randle_SOC
...
ansys::dpf::Operator op("lsdyna::ms::randle_SOC"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
ansys::dpf::FieldsContainer my_randle_soc = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_randle_soc = op.outputs.randle_soc()
```
</details>
...
op.inputs.streams_container.Connect(my_streams_container)
op.inputs.data_sources.Connect(my_data_sources)
my_randle_soc = op.outputs.randle_soc.GetData()
```
</details>
<br>
