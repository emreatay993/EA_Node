...
# lsdyna::ms::EM_OHM_Power

**Version: 0.0.0**

## Description

Read ms em ohm power results from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| em_ohm_power |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | results by specifying name. |
 ...
 **Internal name**: lsdyna::ms::EM_OHM_Power
...
ansys::dpf::Operator op("lsdyna::ms::EM_OHM_Power"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
ansys::dpf::FieldsContainer my_em_ohm_power = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_em_ohm_power = op.outputs.em_ohm_power()
```
</details>
...
op.inputs.streams_container.Connect(my_streams_container)
op.inputs.data_sources.Connect(my_data_sources)
my_em_ohm_power = op.outputs.em_ohm_power.GetData()
```
</details>
<br>
