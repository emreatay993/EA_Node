...
# lsdyna::binout::RBD_L_RV

**Version: 0.0.0**

## Description

Read binout rbdout local rv from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout rbdout local rv. |
 ...
 **Internal name**: lsdyna::binout::RBD_L_RV
...
ansys::dpf::Operator op("lsdyna::binout::RBD_L_RV"); // operator instantiation
