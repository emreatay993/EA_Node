...
# lsdyna::binout::SECFORC_AREA

**Version: 0.0.0**

## Description

Read secforc area from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| secforc_area |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | secforc_area |
 ...
 **Internal name**: lsdyna::binout::SECFORC_AREA
...
ansys::dpf::Operator op("lsdyna::binout::SECFORC_AREA"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_secforc_area = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_secforc_area = op.outputs.secforc_area()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_secforc_area = op.outputs.secforc_area.GetData()
```
</details>
<br>
