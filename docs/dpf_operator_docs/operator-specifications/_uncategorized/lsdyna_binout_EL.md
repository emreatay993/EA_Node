...
Read strain from result streams
...
|-------|------|------------------|-------------|
|  **Pin 0**| total_strain |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | total_strain |
 ...
 **Internal name**: lsdyna::binout::EL
...
ansys::dpf::Operator op("lsdyna::binout::EL"); // operator instantiation
op.connect(1, my_mesh_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_total_strain = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_total_strain = op.outputs.total_strain()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_total_strain = op.outputs.total_strain.GetData()
```
</details>
<br>
