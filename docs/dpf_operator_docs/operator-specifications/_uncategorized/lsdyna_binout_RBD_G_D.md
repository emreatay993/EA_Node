...
# lsdyna::binout::RBD_G_D

**Version: 0.0.0**

## Description

Read binout rbdout global d from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout rbdout global d. |
 ...
 **Internal name**: lsdyna::binout::RBD_G_D
...
ansys::dpf::Operator op("lsdyna::binout::RBD_G_D"); // operator instantiation
