...
# lsdyna::binout::M_ENG_AM

**Version: 0.0.0**

## Description

Read binout matsum added mass from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| added_mass |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | added_mass |
 ...
 **Internal name**: lsdyna::binout::M_ENG_AM
...
ansys::dpf::Operator op("lsdyna::binout::M_ENG_AM"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(6, my_part_scoping);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_added_mass = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_added_mass = op.outputs.added_mass()
```
</details>
...
op.inputs.part_scoping.Connect(my_part_scoping)
op.inputs.unit_system.Connect(my_unit_system)
my_added_mass = op.outputs.added_mass.GetData()
```
</details>
<br>
