...
# composite::MeshSelectionManagerProvider
 ...
 **Internal name**: composite::MeshSelectionManagerProvider
...
ansys::dpf::Operator op("composite::MeshSelectionManagerProvider"); // operator instantiation
