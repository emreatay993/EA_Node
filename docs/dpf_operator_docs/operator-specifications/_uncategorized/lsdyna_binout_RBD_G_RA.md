...
# lsdyna::binout::RBD_G_RA

**Version: 0.0.0**

## Description

Read binout rbdout global ra from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout rbdout global ra. |
 ...
 **Internal name**: lsdyna::binout::RBD_G_RA
...
ansys::dpf::Operator op("lsdyna::binout::RBD_G_RA"); // operator instantiation
