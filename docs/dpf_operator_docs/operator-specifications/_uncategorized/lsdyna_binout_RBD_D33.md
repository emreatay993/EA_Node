...
# lsdyna::binout::RBD_D33

**Version: 0.0.0**

## Description

Read binout rbdout dircos33 from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout rbdout dircos33. |
 ...
 **Internal name**: lsdyna::binout::RBD_D33
...
ansys::dpf::Operator op("lsdyna::binout::RBD_D33"); // operator instantiation
