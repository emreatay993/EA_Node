...
# lsdyna::binout::ResultInfoProvider
 ...
 **Internal name**: lsdyna::binout::ResultInfoProvider
...
ansys::dpf::Operator op("lsdyna::binout::ResultInfoProvider"); // operator instantiation
