...
Read binout sleout master from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout sleout master. |
 ...
 **Internal name**: lsdyna::binout::SLE_M
...
ansys::dpf::Operator op("lsdyna::binout::SLE_M"); // operator instantiation
