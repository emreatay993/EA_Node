...
# lsdyna::d3acp::ResultInfoProvider
 ...
 **Internal name**: lsdyna::d3acp::ResultInfoProvider
...
ansys::dpf::Operator op("lsdyna::d3acp::ResultInfoProvider"); // operator instantiation
