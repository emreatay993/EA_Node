...
# lsdyna::binout::RBD_L_RD

**Version: 0.0.0**

## Description

Read binout rbdout local rd from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout rbdout local rd. |
 ...
 **Internal name**: lsdyna::binout::RBD_L_RD
...
ansys::dpf::Operator op("lsdyna::binout::RBD_L_RD"); // operator instantiation
