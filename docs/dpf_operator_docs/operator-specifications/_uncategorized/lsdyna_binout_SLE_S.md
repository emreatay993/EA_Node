...
Read binout sleout slave from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout sleout slave. |
 ...
 **Internal name**: lsdyna::binout::SLE_S
...
ansys::dpf::Operator op("lsdyna::binout::SLE_S"); // operator instantiation
