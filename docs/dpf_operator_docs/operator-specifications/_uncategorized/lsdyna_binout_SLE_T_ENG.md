...
# lsdyna::binout::SLE_T_ENG

**Version: 0.0.0**

## Description

Read binout sleout total energy from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| energy |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout sleout total energy. |
 ...
 **Internal name**: lsdyna::binout::SLE_T_ENG
...
ansys::dpf::Operator op("lsdyna::binout::SLE_T_ENG"); // operator instantiation
