...
# lsdyna::binout::BND_VN_T

**Version: 0.0.0**

## Description

Read binout bndout velocity nodes total from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| total |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout velocity nodes total. |
 ...
 **Internal name**: lsdyna::binout::BND_VN_T
...
ansys::dpf::Operator op("lsdyna::binout::BND_VN_T"); // operator instantiation
