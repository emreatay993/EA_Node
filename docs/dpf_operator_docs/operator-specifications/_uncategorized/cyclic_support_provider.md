...
ansys::dpf::Operator op("mapdl::rst::support_provider_cyclic"); // operator instantiation
...
op = dpf.operators.None.cyclic_support_provider() # operator instantiation
