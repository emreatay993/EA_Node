...
# cff::flprj::mesh_info_provider

**Version: 0.0.0**

## Description

Read the mesh info from mesh streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| mesh_info |[`mesh_info`](../../core-concepts/dpf-types.md#mesh-info) | mesh_info |
 ...
 **Internal name**: cff::flprj::mesh_info_provider
...
ansys::dpf::Operator op("cff::flprj::mesh_info_provider"); // operator instantiation
