...
# lsdyna::ms::EM_Magnetic_P

**Version: 0.0.0**

## Description

Read ms em magnetic pressure results from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| em_magnetic_pressure |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | results by specifying name. |
 ...
 **Internal name**: lsdyna::ms::EM_Magnetic_P
...
ansys::dpf::Operator op("lsdyna::ms::EM_Magnetic_P"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
ansys::dpf::FieldsContainer my_em_magnetic_pressure = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_em_magnetic_pressure = op.outputs.em_magnetic_pressure()
```
</details>
...
op.inputs.streams_container.Connect(my_streams_container)
op.inputs.data_sources.Connect(my_data_sources)
my_em_magnetic_pressure = op.outputs.em_magnetic_pressure.GetData()
```
</details>
<br>
