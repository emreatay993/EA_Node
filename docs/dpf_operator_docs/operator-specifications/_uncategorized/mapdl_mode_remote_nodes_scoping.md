...
# mapdl::mode::remote_nodes_scoping

**Version: 0.0.0**

## Description

convert a remote point into the corresponding nodes scoping
 ...
 **Internal name**: mapdl::mode::remote_nodes_scoping
...
ansys::dpf::Operator op("mapdl::mode::remote_nodes_scoping"); // operator instantiation
