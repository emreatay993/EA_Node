...
# lsdyna::binout::RBD_D32

**Version: 0.0.0**

## Description

Read binout rbdout dircos32 from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout rbdout dircos32. |
 ...
 **Internal name**: lsdyna::binout::RBD_D32
...
ansys::dpf::Operator op("lsdyna::binout::RBD_D32"); // operator instantiation
