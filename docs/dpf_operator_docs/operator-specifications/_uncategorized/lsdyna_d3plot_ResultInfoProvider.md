...
# lsdyna::d3plot::ResultInfoProvider
 ...
 **Internal name**: lsdyna::d3plot::ResultInfoProvider
...
ansys::dpf::Operator op("lsdyna::d3plot::ResultInfoProvider"); // operator instantiation
