...
# lsdyna::binout::RBD_G_V

**Version: 0.0.0**

## Description

Read binout rbdout global v from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout rbdout global v. |
 ...
 **Internal name**: lsdyna::binout::RBD_G_V
...
ansys::dpf::Operator op("lsdyna::binout::RBD_G_V"); // operator instantiation
