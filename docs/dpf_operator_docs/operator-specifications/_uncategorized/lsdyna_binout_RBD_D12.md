...
# lsdyna::binout::RBD_D12

**Version: 0.0.0**

## Description

Read binout rbdout dircos12 from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout rbdout dircos12. |
 ...
 **Internal name**: lsdyna::binout::RBD_D12
...
ansys::dpf::Operator op("lsdyna::binout::RBD_D12"); // operator instantiation
