...
# lsdyna::binout::RBD_G_A

**Version: 0.0.0**

## Description

Read binout rbdout global a from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout rbdout global a. |
 ...
 **Internal name**: lsdyna::binout::RBD_G_A
...
ansys::dpf::Operator op("lsdyna::binout::RBD_G_A"); // operator instantiation
