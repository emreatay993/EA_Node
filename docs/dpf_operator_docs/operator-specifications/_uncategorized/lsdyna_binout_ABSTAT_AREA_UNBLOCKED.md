...
# lsdyna::binout::ABSTAT_AREA_UNBLOCKED

**Version: 0.0.0**

## Description

Read abstat area unblocked from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| abstat_area_unblocked |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | abstat_area_unblocked |
 ...
 **Internal name**: lsdyna::binout::ABSTAT_AREA_UNBLOCKED
...
ansys::dpf::Operator op("lsdyna::binout::ABSTAT_AREA_UNBLOCKED"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_abstat_area_unblocked = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_abstat_area_unblocked = op.outputs.abstat_area_unblocked()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_abstat_area_unblocked = op.outputs.abstat_area_unblocked.GetData()
```
</details>
<br>
