...
# lsdyna::binout::RBD_L_A

**Version: 0.0.0**

## Description

Read binout rbdout local a from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout rbdout local a. |
 ...
 **Internal name**: lsdyna::binout::RBD_L_A
...
ansys::dpf::Operator op("lsdyna::binout::RBD_L_A"); // operator instantiation
