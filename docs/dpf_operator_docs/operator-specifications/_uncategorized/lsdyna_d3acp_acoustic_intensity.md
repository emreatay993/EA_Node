...
# lsdyna::d3acp::acoustic_intensity

**Version: 0.0.0**

## Description

Read Acoustic Intensity from result streams
...
|-------|------|------------------|-------------|
|  **Pin 0**| acoustic_intensity |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | acoustic intensity |
 ...
 **Internal name**: lsdyna::d3acp::acoustic_intensity
...
ansys::dpf::Operator op("lsdyna::d3acp::acoustic_intensity"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(1, my_mesh_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_acoustic_intensity = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_acoustic_intensity = op.outputs.acoustic_intensity()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_acoustic_intensity = op.outputs.acoustic_intensity.GetData()
```
</details>
<br>
