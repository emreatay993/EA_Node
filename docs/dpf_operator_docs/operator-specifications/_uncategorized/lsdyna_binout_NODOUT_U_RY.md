...
# lsdyna::binout::NODOUT_U_RY

**Version: 0.0.0**

## Description

Read nodout displacement ry from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| nodout_displacement_ry |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | nodout_displacement_ry |
 ...
 **Internal name**: lsdyna::binout::NODOUT_U_RY
...
ansys::dpf::Operator op("lsdyna::binout::NODOUT_U_RY"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_nodout_displacement_ry = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_nodout_displacement_ry = op.outputs.nodout_displacement_ry()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_nodout_displacement_ry = op.outputs.nodout_displacement_ry.GetData()
```
</details>
<br>
