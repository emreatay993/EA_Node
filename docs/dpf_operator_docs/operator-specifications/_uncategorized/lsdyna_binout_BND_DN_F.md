...
# lsdyna::binout::BND_DN_F

**Version: 0.0.0**

## Description

Read binout bndout discrete nodes force from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout discrete nodes force. |
 ...
 **Internal name**: lsdyna::binout::BND_DN_F
...
ansys::dpf::Operator op("lsdyna::binout::BND_DN_F"); // operator instantiation
