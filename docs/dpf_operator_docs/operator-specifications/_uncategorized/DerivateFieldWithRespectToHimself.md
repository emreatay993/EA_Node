...
Computes the self derivative of a field.
 ...
 **Internal name**: DerivateFieldWithRespectToHimself
...
ansys::dpf::Operator op("DerivateFieldWithRespectToHimself"); // operator instantiation
