...
# lsdyna::binout::BND_DN_T

**Version: 0.0.0**

## Description

Read binout bndout discrete nodes total from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| total |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout discrete nodes total. |
 ...
 **Internal name**: lsdyna::binout::BND_DN_T
...
ansys::dpf::Operator op("lsdyna::binout::BND_DN_T"); // operator instantiation
