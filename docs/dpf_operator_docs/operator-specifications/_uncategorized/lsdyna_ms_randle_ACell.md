...
# lsdyna::ms::randle_ACell

**Version: 0.0.0**

## Description

Read ms randle area cell results from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| randle_areacell |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | results by specifying name. |
 ...
 **Internal name**: lsdyna::ms::randle_ACell
...
ansys::dpf::Operator op("lsdyna::ms::randle_ACell"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
ansys::dpf::FieldsContainer my_randle_areacell = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_randle_areacell = op.outputs.randle_areacell()
```
</details>
...
op.inputs.streams_container.Connect(my_streams_container)
op.inputs.data_sources.Connect(my_data_sources)
my_randle_areacell = op.outputs.randle_areacell.GetData()
```
</details>
<br>
