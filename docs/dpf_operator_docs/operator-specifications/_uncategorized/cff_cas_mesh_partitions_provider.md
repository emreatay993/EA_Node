...
# cff::cas::mesh_partitions_provider
 ...
 **Internal name**: cff::cas::mesh_partitions_provider
...
ansys::dpf::Operator op("cff::cas::mesh_partitions_provider"); // operator instantiation
