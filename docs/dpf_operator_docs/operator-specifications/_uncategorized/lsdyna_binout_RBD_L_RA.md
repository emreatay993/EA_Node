...
# lsdyna::binout::RBD_L_RA

**Version: 0.0.0**

## Description

Read binout rbdout local ra from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout rbdout local ra. |
 ...
 **Internal name**: lsdyna::binout::RBD_L_RA
...
ansys::dpf::Operator op("lsdyna::binout::RBD_L_RA"); // operator instantiation
