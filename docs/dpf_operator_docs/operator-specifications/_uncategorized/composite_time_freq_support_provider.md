...
# composite::time_freq_support_provider
 ...
 **Internal name**: composite::time_freq_support_provider
...
ansys::dpf::Operator op("composite::time_freq_support_provider"); // operator instantiation
