...
# lsdyna::d3ssd::ResultInfoProvider
 ...
 **Internal name**: lsdyna::d3ssd::ResultInfoProvider
...
ansys::dpf::Operator op("lsdyna::d3ssd::ResultInfoProvider"); // operator instantiation
