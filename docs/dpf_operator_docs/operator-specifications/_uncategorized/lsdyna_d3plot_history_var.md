...
Read d3plot history variable from result streams
...
|-------|------|------------------|-------------|
|  **Pin 0**| history_var |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | history_var |
 ...
 **Internal name**: lsdyna::d3plot::history_var
...
ansys::dpf::Operator op("lsdyna::d3plot::history_var"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
ansys::dpf::FieldsContainer my_history_var = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_history_var = op.outputs.history_var()
```
</details>
...
op.inputs.streams_container.Connect(my_streams_container)
op.inputs.data_sources.Connect(my_data_sources)
my_history_var = op.outputs.history_var.GetData()
```
</details>
<br>
