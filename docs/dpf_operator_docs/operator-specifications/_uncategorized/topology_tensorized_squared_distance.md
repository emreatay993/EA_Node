...
| <strong>Pin 1</strong>|  origin |[`field`](../../core-concepts/dpf-types.md#field) | Overall field that defines the origin's position. |
 ...
 **Internal name**: topology::tensorized_squared_distance
...
ansys::dpf::Operator op("topology::tensorized_squared_distance"); // operator instantiation
