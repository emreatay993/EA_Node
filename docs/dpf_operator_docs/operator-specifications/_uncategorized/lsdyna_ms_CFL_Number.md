...
# lsdyna::ms::CFL_Number

**Version: 0.0.0**

## Description

Read ms cfl number results from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| cfl_number |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | results by specifying name. |
 ...
 **Internal name**: lsdyna::ms::CFL_Number
...
ansys::dpf::Operator op("lsdyna::ms::CFL_Number"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
ansys::dpf::FieldsContainer my_cfl_number = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_cfl_number = op.outputs.cfl_number()
```
</details>
...
op.inputs.streams_container.Connect(my_streams_container)
op.inputs.data_sources.Connect(my_data_sources)
my_cfl_number = op.outputs.cfl_number.GetData()
```
</details>
<br>
