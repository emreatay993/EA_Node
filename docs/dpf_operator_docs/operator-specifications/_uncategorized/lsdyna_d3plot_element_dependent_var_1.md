...
Read element dependent variable 1 from result streams
...
|-------|------|------------------|-------------|
|  **Pin 0**| element_dependent_var_1 |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | element_dependent_var_1 |
 ...
 **Internal name**: lsdyna::d3plot::element_dependent_var_1
...
ansys::dpf::Operator op("lsdyna::d3plot::element_dependent_var_1"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(25, my_part_id);
ansys::dpf::FieldsContainer my_element_dependent_var_1 = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_element_dependent_var_1 = op.outputs.element_dependent_var_1()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.part_id.Connect(my_part_id)
my_element_dependent_var_1 = op.outputs.element_dependent_var_1.GetData()
```
</details>
<br>
