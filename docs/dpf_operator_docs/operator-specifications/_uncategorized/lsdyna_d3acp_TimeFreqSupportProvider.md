...
# lsdyna::d3acp::TimeFreqSupportProvider
 ...
 **Internal name**: lsdyna::d3acp::TimeFreqSupportProvider
...
ansys::dpf::Operator op("lsdyna::d3acp::TimeFreqSupportProvider"); // operator instantiation
