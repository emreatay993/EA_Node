...
|-------|------|------------------|-------------|
|  **Pin 0**| strain |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | strain |
 ...
 **Internal name**: lsdyna::d3plot::EL
...
ansys::dpf::Operator op("lsdyna::d3plot::EL"); // operator instantiation
...
ansys::dpf::FieldsContainer my_strain = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
op.inputs.part_id.Connect(my_part_id)
op.inputs.unit_system.Connect(my_unit_system)
my_strain = op.outputs.strain.GetData()
```
</details>
<br>
