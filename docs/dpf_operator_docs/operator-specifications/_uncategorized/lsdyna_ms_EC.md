...
Read ms electric conductivity results from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| electric_conductivity |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | results by specifying name. |
...
ansys::dpf::Operator op("lsdyna::ms::EC"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
ansys::dpf::FieldsContainer my_electric_conductivity = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_electric_conductivity = op.outputs.electric_conductivity()
```
</details>
...
op.inputs.streams_container.Connect(my_streams_container)
op.inputs.data_sources.Connect(my_data_sources)
my_electric_conductivity = op.outputs.electric_conductivity.GetData()
```
</details>
<br>
