...
Read binout matsum momentum from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| momentum |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | momentum |
 ...
 **Internal name**: lsdyna::binout::M_MV
...
ansys::dpf::Operator op("lsdyna::binout::M_MV"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(6, my_part_scoping);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_momentum = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_momentum = op.outputs.momentum()
```
</details>
...
op.inputs.part_scoping.Connect(my_part_scoping)
op.inputs.unit_system.Connect(my_unit_system)
my_momentum = op.outputs.momentum.GetData()
```
</details>
<br>
