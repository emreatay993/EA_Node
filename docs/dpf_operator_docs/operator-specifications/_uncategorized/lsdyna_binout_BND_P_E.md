...
# lsdyna::binout::BND_P_E

**Version: 0.0.0**

## Description

Read binout bndout pressure energy from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| energy |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | bndout pressure energy. |
 ...
 **Internal name**: lsdyna::binout::BND_P_E
...
ansys::dpf::Operator op("lsdyna::binout::BND_P_E"); // operator instantiation
