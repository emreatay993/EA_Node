...
# composite::transpose_scoping_to_physical
 ...
 **Internal name**: composite::transpose_scoping_to_physical
...
ansys::dpf::Operator op("composite::transpose_scoping_to_physical"); // operator instantiation
