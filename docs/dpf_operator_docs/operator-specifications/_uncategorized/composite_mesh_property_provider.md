...
# composite::mesh_property_provider
 ...
 **Internal name**: composite::mesh_property_provider
...
ansys::dpf::Operator op("composite::mesh_property_provider"); // operator instantiation
