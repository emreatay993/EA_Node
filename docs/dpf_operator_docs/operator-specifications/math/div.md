...
Computes element-wise division between two fields. If one field's scoping has "overall" location, then these field's values are applied on the entire other field.
...
|-------|------|------------------|-------------|
|  **Pin 0**| field |[`field`](../../core-concepts/dpf-types.md#field) | Field containing the element-wise division (fieldA / fieldB) |
...
ansys::dpf::Operator op("div"); // operator instantiation
