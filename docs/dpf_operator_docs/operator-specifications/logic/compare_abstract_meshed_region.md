...
# logic:compare::abstract_meshed_region
 ...
 **Internal name**: compare::abstract_meshed_region
...
ansys::dpf::Operator op("compare::abstract_meshed_region"); // operator instantiation
