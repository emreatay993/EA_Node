...
Put in output the input in the higher input pin
 ...
 **Scripting name**: multiplixer

 **Full name**: utility.multiplixer

 **Internal name**: multiplixer
...
ansys::dpf::Operator op("multiplixer"); // operator instantiation
op.connect(0, my_any);
...
op = dpf.operators.utility.multiplixer() # operator instantiation
