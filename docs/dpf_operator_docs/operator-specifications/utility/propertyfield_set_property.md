...
|-------|------|------------------|-------------|
|  **Pin 0**| field |[`property_field`](../../core-concepts/dpf-types.md#property-field), [`property_fields_container`](../../core-concepts/dpf-types.md#property-fields-container) | Accepted Outputs are: Field, PropertyField, CustomTypeField or their containers. |
 ...
 **Scripting name**: propertyfield_set_property

 **Full name**: utility.propertyfield_set_property

 **Internal name**: propertyfield::set_property
...
ansys::dpf::Operator op("propertyfield::set_property"); // operator instantiation
...
op = dpf.operators.utility.propertyfield_set_property() # operator instantiation
