 ...
 **Scripting name**: html_doc_old

 **Full name**: utility.html_doc_old

 **Internal name**: html_doc_old
...
ansys::dpf::Operator op("html_doc_old"); // operator instantiation
...
op = dpf.operators.utility.html_doc_old() # operator instantiation
