 ...
 **Scripting name**: customtypefield_set_property

 **Full name**: utility.customtypefield_set_property

 **Internal name**: customtypefield::set_property
...
ansys::dpf::Operator op("customtypefield::set_property"); // operator instantiation
...
op = dpf.operators.utility.customtypefield_set_property() # operator instantiation
