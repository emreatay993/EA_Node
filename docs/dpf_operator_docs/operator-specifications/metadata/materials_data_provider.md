...
# metadata:materials data provider
...
|-------|-------|------------------|-------------|
| <strong>Pin 0</strong>|  properties_names |[`string`](../../core-concepts/dpf-types.md#standard-types), [`vector<string>`](../../core-concepts/dpf-types.md#standard-types) | Property names to recover if available. If not set, all available properties to be recovered. |
| <strong>Pin 1</strong>|  solver_material_ids |[`int32`](../../core-concepts/dpf-types.md#standard-types), [`vector<int32>`](../../core-concepts/dpf-types.md#standard-types) | Material ids to recover used by the solver. If not set, all available materials to be recovered. |
 ...
 **Full name**: metadata.materials_data_provider

 **Internal name**: materials_data_provider
...
ansys::dpf::Operator op("materials_data_provider"); // operator instantiation
...
op = dpf.operators.metadata.materials_data_provider() # operator instantiation
