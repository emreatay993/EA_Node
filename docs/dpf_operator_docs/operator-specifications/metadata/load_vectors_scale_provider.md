...
# metadata:load vectors scale provider

**Version: 0.0.0**

## Description

Reads the load vectors scale.
 ...
 **Scripting name**: load_vectors_scale_provider

 **Full name**: metadata.load_vectors_scale_provider

 **Internal name**: load_vectors_scale_provider
...
ansys::dpf::Operator op("load_vectors_scale_provider"); // operator instantiation
...
op = dpf.operators.metadata.load_vectors_scale_provider() # operator instantiation
