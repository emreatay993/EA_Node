...
# metadata:load vectors provider

**Version: 0.0.0**

## Description

Reads the load vectors.
 ...
 **Scripting name**: load_vectors_provider

 **Full name**: metadata.load_vectors_provider

 **Internal name**: load_vectors_provider
...
ansys::dpf::Operator op("load_vectors_provider"); // operator instantiation
...
op = dpf.operators.metadata.load_vectors_provider() # operator instantiation
