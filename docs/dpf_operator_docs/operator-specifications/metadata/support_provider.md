...
# metadata:support provider

**Version: 0.0.0**

## Description

Reads the support of the property in input.
...
| <strong>Pin 13</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  property |[`string`](../../core-concepts/dpf-types.md#standard-types) | mat, time, mesh, ... |
 ...
 **Scripting name**: support_provider

 **Full name**: metadata.support_provider

 **Internal name**: support_provider
...
ansys::dpf::Operator op("support_provider"); // operator instantiation
...
op = dpf.operators.metadata.support_provider() # operator instantiation
