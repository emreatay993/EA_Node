...
# metadata:ModalBasis_nested

**Version: 0.0.0**

## Description

Read/compute modal basis expanded result.
 ...
 **Internal name**: ModalBasis_nested
...
ansys::dpf::Operator op("ModalBasis_nested"); // operator instantiation
