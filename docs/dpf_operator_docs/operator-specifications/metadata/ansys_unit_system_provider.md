...
# metadata:ansys unit system provider

**Version: 0.0.0**

## Description

Reads the ansys unit system from the results files contained in the streams or data sources.
...
|-------|------|------------------|-------------|
|  **Pin 0**| int32 |[`int32`](../../core-concepts/dpf-types.md#standard-types) |  |
 ...
 **Full name**: metadata.ansys_unit_system_provider

 **Internal name**: ansys_unit_system_provider
...
ansys::dpf::Operator op("ansys_unit_system_provider"); // operator instantiation
...
op = dpf.operators.metadata.ansys_unit_system_provider() # operator instantiation
