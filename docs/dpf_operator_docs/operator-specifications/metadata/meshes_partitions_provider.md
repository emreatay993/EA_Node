...
# metadata:meshes_partitions_provider

**Version: 0.0.0**

## Description

Provide the element scoping for each partition of several meshes.
 ...
 **Internal name**: meshes_partitions_provider
...
ansys::dpf::Operator op("meshes_partitions_provider"); // operator instantiation
