...
# metadata:mapdl::rst::U_cyclic

**Version: 0.0.0**

## Description

This operator is deprecated: use the operator nodal displacements with the read_cyclic pin instead. Read nodal displacements from a result file and expand it with cyclic symmetry.
...
ansys::dpf::Operator op("mapdl::rst::U_cyclic"); // operator instantiation
