...
# metadata:remote data status

**Version: 0.0.0**

## Description

Returns the status of a remote operator for a given protocol registered in the streams.
 ...
 **Scripting name**: remote_operator_get_status

 **Full name**: metadata.remote_operator_get_status

 **Internal name**: remote_operator_get_status
...
ansys::dpf::Operator op("remote_operator_get_status"); // operator instantiation
...
op = dpf.operators.metadata.remote_operator_get_status() # operator instantiation
