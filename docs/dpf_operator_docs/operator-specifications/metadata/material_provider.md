 ...
 **Full name**: metadata.material_provider

 **Internal name**: materials_provider
...
ansys::dpf::Operator op("materials_provider"); // operator instantiation
...
op = dpf.operators.metadata.material_provider() # operator instantiation
