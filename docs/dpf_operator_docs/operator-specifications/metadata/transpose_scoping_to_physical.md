...
# metadata:transpose_scoping_to_physical

**Version: 0.0.0**

## Description

Converts a node's scoping into the corresponding elements scoping without contact elements.
 ...
 **Internal name**: transpose_scoping_to_physical
...
ansys::dpf::Operator op("transpose_scoping_to_physical"); // operator instantiation
