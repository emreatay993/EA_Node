 ...
 **Full name**: result.section_data_provider

 **Internal name**: mapdl::rstp::sections_data_provider
...
ansys::dpf::Operator op("mapdl::rstp::sections_data_provider"); // operator instantiation
...
op = dpf.operators.result.section_data_provider() # operator instantiation
