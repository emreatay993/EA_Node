 ...
 **Full name**: result.nodal_averaged_stresses
...
ansys::dpf::Operator op("mapdl::rst::NS"); // operator instantiation
...
op = dpf.operators.result.nodal_averaged_stresses() # operator instantiation
