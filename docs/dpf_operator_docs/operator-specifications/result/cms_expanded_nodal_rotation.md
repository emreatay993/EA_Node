...
# result:cms expanded nodal rotation

**Version: 0.0.0**

## Description

Read/compute nodal rotation expanded result.
 ...
 **Scripting name**: cms_expanded_nodal_rotation

 **Full name**: result.cms_expanded_nodal_rotation

 **Internal name**: ROT_cms
...
ansys::dpf::Operator op("ROT_cms"); // operator instantiation
...
op = dpf.operators.result.cms_expanded_nodal_rotation() # operator instantiation
