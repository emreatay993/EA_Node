...
# result:lsdyna::d3plot::node_residual_force

**Version: 0.0.0**

## Description

Read Residual Force from result streams
...
|-------|------|------------------|-------------|
|  **Pin 0**| node_residual_force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | node residual force |
 ...
 **Scripting name**: node residual force

 **Full name**: result.node residual force

 **Internal name**: lsdyna::d3plot::node_residual_force
...
ansys::dpf::Operator op("lsdyna::d3plot::node_residual_force"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(1, my_mesh_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_node_residual_force = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
op = dpf.operators.result.node residual force() # operator instantiation
op.inputs.time_scoping.connect(my_time_scoping)
op.inputs.mesh_scoping.connect(my_mesh_scoping)
op.inputs.streams_container.connect(my_streams_container)
op.inputs.data_sources.connect(my_data_sources)
op.inputs.unit_system.connect(my_unit_system)
my_node_residual_force = op.outputs.node_residual_force()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_node_residual_force = op.outputs.node_residual_force.GetData()
```
</details>
<br>
