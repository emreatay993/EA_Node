...
# result:mapdl::rstp::DMG

**Version: 0.0.0**

## Description

Read rotational acceleration from rst file.
...
ansys::dpf::Operator op("mapdl::rstp::DMG"); // operator instantiation
