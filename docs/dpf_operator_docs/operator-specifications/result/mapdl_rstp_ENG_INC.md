...
# result:mapdl::rstp::ENG_INC

**Version: 0.0.0**

## Description

Read incremental energy (magnetics) from rst file.
 ...
 **Internal name**: mapdl::rstp::ENG_INC
...
ansys::dpf::Operator op("mapdl::rstp::ENG_INC"); // operator instantiation
