...
# result:mapdl::rdsp::DMG

**Version: 0.0.0**

## Description

Read/compute nodal rotational accelerationfrom a use pass file and expand the result if an upstream is available
...
| <strong>Pin 5</strong>|  bool_rotate_to_global |[`int32`](../../core-concepts/dpf-types.md#standard-types) | default is true |
| <strong>Pin 17</strong>|  domain_pin_id |[`int32`](../../core-concepts/dpf-types.md#standard-types) |  |
...
ansys::dpf::Operator op("mapdl::rdsp::DMG"); // operator instantiation
