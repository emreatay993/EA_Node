...
# result:mapdl::rfrq::boundary_conditions
 ...
 **Internal name**: mapdl::rfrq::boundary_conditions
...
ansys::dpf::Operator op("mapdl::rfrq::boundary_conditions"); // operator instantiation
