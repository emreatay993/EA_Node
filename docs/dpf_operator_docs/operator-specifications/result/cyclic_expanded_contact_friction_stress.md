...
This operator is deprecated: use the operator element contact friction stress with the read_cyclic pin instead. Read element contact friction stress from a result file and expand it with cyclic symmetry.
 ...
 **Scripting name**: cyclic_expanded_contact_friction_stress

 **Full name**: result.cyclic_expanded_contact_friction_stress

 **Internal name**: ECT_SFRIC_cyclic
...
ansys::dpf::Operator op("ECT_SFRIC_cyclic"); // operator instantiation
...
op = dpf.operators.result.cyclic_expanded_contact_friction_stress() # operator instantiation
