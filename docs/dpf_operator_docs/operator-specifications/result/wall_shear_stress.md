...
# result:cff::flprj::TAU

**Version: 0.0.0**

## Description

Reads/computes Wall Shear Stress from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| wall_shear_stress |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | wall_shear_stress |
...
ansys::dpf::Operator op("cff::flprj::TAU"); // operator instantiation
...
ansys::dpf::FieldsContainer my_wall_shear_stress = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_wall_shear_stress = op.outputs.wall_shear_stress()
```
</details>
...
my_wall_shear_stress = op.outputs.wall_shear_stress.GetData()
```
</details>
<br>
