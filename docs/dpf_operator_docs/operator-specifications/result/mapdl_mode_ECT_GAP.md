...
# result:mapdl::mode::ECT_GAP

**Version: 0.0.0**

## Description

Load the appropriate operator based on the data sources and read/computeelement contact gap distance
 ...
 **Internal name**: mapdl::mode::ECT_GAP
...
ansys::dpf::Operator op("mapdl::mode::ECT_GAP"); // operator instantiation
