...
# result:mapdl::rfrq::ResultInfoProvider
 ...
 **Internal name**: mapdl::rfrq::ResultInfoProvider
...
ansys::dpf::Operator op("mapdl::rfrq::ResultInfoProvider"); // operator instantiation
