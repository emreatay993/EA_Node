...
This operator is deprecated: use the operator element total heat flux at contact surface with the read_cyclic pin instead. Read element total heat flux at contact surface from a result file and expand it with cyclic symmetry.
 ...
 **Scripting name**: cyclic_expanded_contact_surface_heat_flux

 **Full name**: result.cyclic_expanded_contact_surface_heat_flux

 **Internal name**: ECT_FLUX_cyclic
...
ansys::dpf::Operator op("ECT_FLUX_cyclic"); // operator instantiation
...
op = dpf.operators.result.cyclic_expanded_contact_surface_heat_flux() # operator instantiation
