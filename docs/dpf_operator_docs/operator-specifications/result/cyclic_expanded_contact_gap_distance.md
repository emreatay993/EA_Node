...
This operator is deprecated: use the operator element contact gap distance with the read_cyclic pin instead. Read element contact gap distance from a result file and expand it with cyclic symmetry.
 ...
 **Scripting name**: cyclic_expanded_contact_gap_distance

 **Full name**: result.cyclic_expanded_contact_gap_distance

 **Internal name**: ECT_GAP_cyclic
...
ansys::dpf::Operator op("ECT_GAP_cyclic"); // operator instantiation
...
op = dpf.operators.result.cyclic_expanded_contact_gap_distance() # operator instantiation
