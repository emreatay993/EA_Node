...
# result:mapdl::rstp::RFTOT

**Version: 0.0.0**

## Description

Read raw reaction Forces from rst file.
 ...
 **Internal name**: mapdl::rstp::RFTOT
...
ansys::dpf::Operator op("mapdl::rstp::RFTOT"); // operator instantiation
