...
# result:lsdyna::d3plot::B_ST2

**Version: 0.0.0**

## Description

Read Beam TR Shear Stress from result streams
...
|-------|------|------------------|-------------|
|  **Pin 0**| beamt_tr_shear_stress |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | beamt tr shear stress |
 ...
 **Scripting name**: beamt tr shear stress

 **Full name**: result.beamt tr shear stress

 **Internal name**: lsdyna::d3plot::B_ST2
...
ansys::dpf::Operator op("lsdyna::d3plot::B_ST2"); // operator instantiation
...
ansys::dpf::FieldsContainer my_beamt_tr_shear_stress = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
op = dpf.operators.result.beamt tr shear stress() # operator instantiation
...
my_beamt_tr_shear_stress = op.outputs.beamt_tr_shear_stress()
```
</details>
...
op.inputs.ipt_scoping.Connect(my_ipt_scoping)
op.inputs.unit_system.Connect(my_unit_system)
my_beamt_tr_shear_stress = op.outputs.beamt_tr_shear_stress.GetData()
```
</details>
<br>
