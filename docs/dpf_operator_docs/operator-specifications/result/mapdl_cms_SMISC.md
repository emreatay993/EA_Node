...
# result:mapdl::cms::SMISC

**Version: 0.0.0**

## Description

Read/computeelemental summable miscellaneous data. If a downstream info (from a usepass) is provided, an expansion usepass*genpass is computed
...
ansys::dpf::Operator op("mapdl::cms::SMISC"); // operator instantiation
