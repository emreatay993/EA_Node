...
Reads/computes Specific Heat from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| specific_heat |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | specific_heat |
...
ansys::dpf::Operator op("cff::flprj::CP"); // operator instantiation
...
ansys::dpf::FieldsContainer my_specific_heat = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_specific_heat = op.outputs.specific_heat()
```
</details>
...
my_specific_heat = op.outputs.specific_heat.GetData()
```
</details>
<br>
