...
# result:lsdyna::d3plot::TF

**Version: 0.0.0**

## Description

Read Heat Flux from result streams
...
|-------|------|------------------|-------------|
|  **Pin 0**| heat_flux |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | heat flux |
 ...
 **Scripting name**: heat flux

 **Full name**: result.heat flux

 **Internal name**: lsdyna::d3plot::TF
...
ansys::dpf::Operator op("lsdyna::d3plot::TF"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(1, my_mesh_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_heat_flux = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
op = dpf.operators.result.heat flux() # operator instantiation
op.inputs.time_scoping.connect(my_time_scoping)
op.inputs.mesh_scoping.connect(my_mesh_scoping)
op.inputs.streams_container.connect(my_streams_container)
op.inputs.data_sources.connect(my_data_sources)
op.inputs.unit_system.connect(my_unit_system)
my_heat_flux = op.outputs.heat_flux()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_heat_flux = op.outputs.heat_flux.GetData()
```
</details>
<br>
