...
# result:lsdyna::d3plot::node_residual_moment

**Version: 0.0.0**

## Description

Read Residual Moment from result streams
...
|-------|------|------------------|-------------|
|  **Pin 0**| node_residual_moment |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | node residual moment |
 ...
 **Scripting name**: node residual moment

 **Full name**: result.node residual moment

 **Internal name**: lsdyna::d3plot::node_residual_moment
...
ansys::dpf::Operator op("lsdyna::d3plot::node_residual_moment"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(1, my_mesh_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_node_residual_moment = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
op = dpf.operators.result.node residual moment() # operator instantiation
op.inputs.time_scoping.connect(my_time_scoping)
op.inputs.mesh_scoping.connect(my_mesh_scoping)
op.inputs.streams_container.connect(my_streams_container)
op.inputs.data_sources.connect(my_data_sources)
op.inputs.unit_system.connect(my_unit_system)
my_node_residual_moment = op.outputs.node_residual_moment()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_node_residual_moment = op.outputs.node_residual_moment.GetData()
```
</details>
<br>
