...
This operator is deprecated: use the operator nodal accelerations with the read_cyclic pin instead. Read nodal accelerations from a result file and expand it with cyclic symmetry.
...
ansys::dpf::Operator op("A_cyclic"); // operator instantiation
...
op = dpf.operators.result.cyclic_expanded_acceleration() # operator instantiation
