 ...
 **Full name**: result.nodal_averaged_equivalent_plastic_strain
...
ansys::dpf::Operator op("mapdl::rst::NPPL_EQV"); // operator instantiation
...
op = dpf.operators.result.nodal_averaged_equivalent_plastic_strain() # operator instantiation
