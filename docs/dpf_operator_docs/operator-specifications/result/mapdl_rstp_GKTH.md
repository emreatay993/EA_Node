...
# result:mapdl::rstp::GKTH

**Version: 0.0.0**

## Description

Read gasket thermal closure from rst file.
...
ansys::dpf::Operator op("mapdl::rstp::GKTH"); // operator instantiation
