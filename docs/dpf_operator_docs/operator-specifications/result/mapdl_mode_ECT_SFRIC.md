...
# result:mapdl::mode::ECT_SFRIC

**Version: 0.0.0**

## Description

Read/computeelement contact friction stress. If a downstream info (from a usepass) is provided, an expansion usepass*genpass is computed
 ...
 **Internal name**: mapdl::mode::ECT_SFRIC
...
ansys::dpf::Operator op("mapdl::mode::ECT_SFRIC"); // operator instantiation
