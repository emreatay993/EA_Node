...
# result:cff::flprj::YPLUS

**Version: 0.0.0**

## Description

Reads/computes Y Plus from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| y_plus |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | y_plus |
...
ansys::dpf::Operator op("cff::flprj::YPLUS"); // operator instantiation
