...
This operator is deprecated: use the operator element contact penetration with the read_cyclic pin instead. Read element contact penetration from a result file and expand it with cyclic symmetry.
 ...
 **Scripting name**: cyclic_expanded_contact_penetration

 **Full name**: result.cyclic_expanded_contact_penetration

 **Internal name**: ECT_PENE_cyclic
...
ansys::dpf::Operator op("ECT_PENE_cyclic"); // operator instantiation
...
op = dpf.operators.result.cyclic_expanded_contact_penetration() # operator instantiation
