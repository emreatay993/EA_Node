...
# result:lsdyna::d3plot::B_SN

**Version: 0.0.0**

## Description

Read Beam Axial Stress from result streams
...
|-------|------|------------------|-------------|
|  **Pin 0**| beam_axial_stress |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | beam axial stress |
 ...
 **Scripting name**: beam axial stress

 **Full name**: result.beam axial stress

 **Internal name**: lsdyna::d3plot::B_SN
...
ansys::dpf::Operator op("lsdyna::d3plot::B_SN"); // operator instantiation
...
ansys::dpf::FieldsContainer my_beam_axial_stress = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
op = dpf.operators.result.beam axial stress() # operator instantiation
...
my_beam_axial_stress = op.outputs.beam_axial_stress()
```
</details>
...
op.inputs.ipt_scoping.Connect(my_ipt_scoping)
op.inputs.unit_system.Connect(my_unit_system)
my_beam_axial_stress = op.outputs.beam_axial_stress.GetData()
```
</details>
<br>
