...
# result:cff::flprj::EPS

**Version: 0.0.0**

## Description

Reads/computes Turbulent Dissipation Rate from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| epsilon |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | epsilon |
...
ansys::dpf::Operator op("cff::flprj::EPS"); // operator instantiation
...
ansys::dpf::FieldsContainer my_epsilon = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_epsilon = op.outputs.epsilon.GetData()
```
</details>
<br>
