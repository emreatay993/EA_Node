...
# result:cff::flprj::TEMP_TOT

**Version: 0.0.0**

## Description

Reads/computes Total Temperature from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| total_temperature |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | total_temperature |
 ...
 **Internal name**: cff::flprj::TEMP_TOT
...
ansys::dpf::Operator op("cff::flprj::TEMP_TOT"); // operator instantiation
...
ansys::dpf::FieldsContainer my_total_temperature = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_total_temperature = op.outputs.total_temperature()
```
</details>
...
my_total_temperature = op.outputs.total_temperature.GetData()
```
</details>
<br>
