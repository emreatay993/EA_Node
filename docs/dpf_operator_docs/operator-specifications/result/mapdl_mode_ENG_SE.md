...
# result:mapdl::mode::ENG_SE

**Version: 0.0.0**

## Description

Read/computeelement energy associated with the stiffness matrix. If a downstream info (from a usepass) is provided, an expansion usepass*genpass is computed
 ...
 **Internal name**: mapdl::mode::ENG_SE
...
ansys::dpf::Operator op("mapdl::mode::ENG_SE"); // operator instantiation
