...
# result:cff::flprj::VOF

**Version: 0.0.0**

## Description

Reads/computes Volume Fraction from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| volume_fraction |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | volume_fraction |
...
ansys::dpf::Operator op("cff::flprj::VOF"); // operator instantiation
...
ansys::dpf::FieldsContainer my_volume_fraction = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_volume_fraction = op.outputs.volume_fraction()
```
</details>
...
my_volume_fraction = op.outputs.volume_fraction.GetData()
```
</details>
<br>
