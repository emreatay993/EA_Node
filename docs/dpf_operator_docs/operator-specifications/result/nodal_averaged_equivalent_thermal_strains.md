 ...
 **Full name**: result.nodal_averaged_equivalent_thermal_strains
...
ansys::dpf::Operator op("mapdl::rst::NTH_EQV"); // operator instantiation
...
op = dpf.operators.result.nodal_averaged_equivalent_thermal_strains() # operator instantiation
