 ...
 **Full name**: result.nodal_averaged_equivalent_elastic_strain
...
ansys::dpf::Operator op("mapdl::rst::NPEL_EQV"); // operator instantiation
...
op = dpf.operators.result.nodal_averaged_equivalent_elastic_strain() # operator instantiation
