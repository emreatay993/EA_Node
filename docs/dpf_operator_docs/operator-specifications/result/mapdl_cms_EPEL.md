...
# result:mapdl::cms::EPEL

**Version: 0.0.0**

## Description

Read/computeelement nodal component elastic strains. If a downstream info (from a usepass) is provided, an expansion usepass*genpass is computed
...
ansys::dpf::Operator op("mapdl::cms::EPEL"); // operator instantiation
