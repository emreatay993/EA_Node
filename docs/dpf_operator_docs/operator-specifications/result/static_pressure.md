...
Reads/computes Static Pressure from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| static_pressure |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | static_pressure |
...
ansys::dpf::Operator op("cff::cas::P_S"); // operator instantiation
...
ansys::dpf::FieldsContainer my_static_pressure = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_static_pressure = op.outputs.static_pressure()
```
</details>
...
my_static_pressure = op.outputs.static_pressure.GetData()
```
</details>
<br>
