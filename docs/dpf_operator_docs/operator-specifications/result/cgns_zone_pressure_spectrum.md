...
# result:cgns zone pressure spectrum
 ...
 **Scripting name**: cgns_zone_pressure_spectrum

 **Full name**: result.cgns_zone_pressure_spectrum

 **Internal name**: cgns::cgns::zone_pressure_spectrum
...
ansys::dpf::Operator op("cgns::cgns::zone_pressure_spectrum"); // operator instantiation
...
op = dpf.operators.result.cgns_zone_pressure_spectrum() # operator instantiation
