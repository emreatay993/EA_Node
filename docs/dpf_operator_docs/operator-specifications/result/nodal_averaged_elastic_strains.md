 ...
 **Full name**: result.nodal_averaged_elastic_strains
...
ansys::dpf::Operator op("mapdl::rst::NPEL"); // operator instantiation
...
op = dpf.operators.result.nodal_averaged_elastic_strains() # operator instantiation
