...
Reads/computes Thermal Conductivity from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| thermal_conductivity |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | thermal_conductivity |
...
ansys::dpf::Operator op("cff::flprj::KT"); // operator instantiation
...
ansys::dpf::FieldsContainer my_thermal_conductivity = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_thermal_conductivity = op.outputs.thermal_conductivity()
```
</details>
...
my_thermal_conductivity = op.outputs.thermal_conductivity.GetData()
```
</details>
<br>
