...
# result:lsdyna::d3plot::node_relative_penetration

**Version: 0.0.0**

## Description

Read Relative Contact Penetration from result streams
...
|-------|------|------------------|-------------|
|  **Pin 0**| relative_contact_penetration |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | relative contact penetration |
 ...
 **Scripting name**: relative contact penetration

 **Full name**: result.relative contact penetration

 **Internal name**: lsdyna::d3plot::node_relative_penetration
...
ansys::dpf::Operator op("lsdyna::d3plot::node_relative_penetration"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(1, my_mesh_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_relative_contact_penetration = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
op = dpf.operators.result.relative contact penetration() # operator instantiation
op.inputs.time_scoping.connect(my_time_scoping)
op.inputs.mesh_scoping.connect(my_mesh_scoping)
op.inputs.streams_container.connect(my_streams_container)
op.inputs.data_sources.connect(my_data_sources)
op.inputs.unit_system.connect(my_unit_system)
my_relative_contact_penetration = op.outputs.relative_contact_penetration()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_relative_contact_penetration = op.outputs.relative_contact_penetration.GetData()
```
</details>
<br>
