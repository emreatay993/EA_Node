...
# result:mapdl::mode::ECT_SLIDE

**Version: 0.0.0**

## Description

Read/computeelement contact sliding distance. If a downstream info (from a usepass) is provided, an expansion usepass*genpass is computed
 ...
 **Internal name**: mapdl::mode::ECT_SLIDE
...
ansys::dpf::Operator op("mapdl::mode::ECT_SLIDE"); // operator instantiation
