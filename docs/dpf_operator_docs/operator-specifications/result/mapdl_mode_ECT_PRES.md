...
# result:mapdl::mode::ECT_PRES

**Version: 0.0.0**

## Description

Read/computeelement contact pressure. If a downstream info (from a usepass) is provided, an expansion usepass*genpass is computed
 ...
 **Internal name**: mapdl::mode::ECT_PRES
...
ansys::dpf::Operator op("mapdl::mode::ECT_PRES"); // operator instantiation
