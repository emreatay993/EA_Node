...
# result:cff::flprj::SV_RTDFT

**Version: 0.0.0**

## Description

Reads/computes Divergence of the Lighthill Tensor from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| div_lighthill_tensor |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | div_lighthill_tensor |
 ...
 **Internal name**: cff::flprj::SV_RTDFT
...
ansys::dpf::Operator op("cff::flprj::SV_RTDFT"); // operator instantiation
...
ansys::dpf::FieldsContainer my_div_lighthill_tensor = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_div_lighthill_tensor = op.outputs.div_lighthill_tensor()
```
</details>
...
my_div_lighthill_tensor = op.outputs.div_lighthill_tensor.GetData()
```
</details>
<br>
