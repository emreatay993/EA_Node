...
This operator is deprecated: use the operator elemental summable miscellaneous data with the read_cyclic pin instead. Read elemental summable miscellaneous data from a result file and expand it with cyclic symmetry.
 ...
 **Scripting name**: cyclic_expanded_smisc

 **Full name**: result.cyclic_expanded_smisc

 **Internal name**: SMISC_cyclic
...
ansys::dpf::Operator op("SMISC_cyclic"); // operator instantiation
...
op = dpf.operators.result.cyclic_expanded_smisc() # operator instantiation
