...
# result:mapdl::cms::ENF

**Version: 0.0.0**

## Description

Read/computeelement nodal forces. If a downstream info (from a usepass) is provided, an expansion usepass*genpass is computed
...
ansys::dpf::Operator op("mapdl::cms::ENF"); // operator instantiation
