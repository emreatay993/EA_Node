...
# result:mapdl::mode::ECT_STAT

**Version: 0.0.0**

## Description

Load the appropriate operator based on the data sources and read/computeelement contact status
 ...
 **Internal name**: mapdl::mode::ECT_STAT
...
ansys::dpf::Operator op("mapdl::mode::ECT_STAT"); // operator instantiation
