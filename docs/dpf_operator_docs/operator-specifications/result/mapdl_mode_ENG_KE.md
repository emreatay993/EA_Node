...
# result:mapdl::mode::ENG_KE

**Version: 0.0.0**

## Description

Read/computekinetic energy. If a downstream info (from a usepass) is provided, an expansion usepass*genpass is computed
 ...
 **Internal name**: mapdl::mode::ENG_KE
...
ansys::dpf::Operator op("mapdl::mode::ENG_KE"); // operator instantiation
