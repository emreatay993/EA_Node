...
Read/computenodal accelerationsfor a datasource containing nested superelements is provider
...
ansys::dpf::Operator op("A_nested"); // operator instantiation
