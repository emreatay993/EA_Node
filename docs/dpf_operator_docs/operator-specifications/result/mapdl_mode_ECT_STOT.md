...
# result:mapdl::mode::ECT_STOT

**Version: 0.0.0**

## Description

Read/computeelement contact total stress (pressure plus friction). If a downstream info (from a usepass) is provided, an expansion usepass*genpass is computed
 ...
 **Internal name**: mapdl::mode::ECT_STOT
...
ansys::dpf::Operator op("mapdl::mode::ECT_STOT"); // operator instantiation
