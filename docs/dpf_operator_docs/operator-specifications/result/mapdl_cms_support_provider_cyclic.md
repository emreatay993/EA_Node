...
# result:mapdl::cms::support_provider_cyclic
 ...
 **Internal name**: mapdl::cms::support_provider_cyclic
...
ansys::dpf::Operator op("mapdl::cms::support_provider_cyclic"); // operator instantiation
