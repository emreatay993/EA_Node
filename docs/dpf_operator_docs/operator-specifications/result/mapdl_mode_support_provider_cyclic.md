...
# result:mapdl::mode::support_provider_cyclic

**Version: 0.0.0**

## Description

Read from the complementary result file in a recursive manner.
...
| <strong>Pin 200</strong>|  bool |[`bool`](../../core-concepts/dpf-types.md#standard-types) | use complementary (default = true) |
 ...
 **Internal name**: mapdl::mode::support_provider_cyclic
...
ansys::dpf::Operator op("mapdl::mode::support_provider_cyclic"); // operator instantiation
