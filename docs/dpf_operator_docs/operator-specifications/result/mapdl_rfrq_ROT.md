...
# result:mapdl::rfrq::ROT

**Version: 0.0.0**

## Description

Read/compute nodal rotationfrom a use pass file and expand the result if an upstream is available
...
ansys::dpf::Operator op("mapdl::rfrq::ROT"); // operator instantiation
