...
# result:cms expanded displacement

**Version: 0.0.0**

## Description

Read/compute nodal displacements expanded result.
 ...
 **Scripting name**: cms_expanded_displacement

 **Full name**: result.cms_expanded_displacement
...
ansys::dpf::Operator op("U_cms"); // operator instantiation
...
op = dpf.operators.result.cms_expanded_displacement() # operator instantiation
