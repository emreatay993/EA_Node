...
Reads/computes Surface Heat Rate from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| surface_heat_rate |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | surface_heat_rate |
...
ansys::dpf::Operator op("cff::flprj::Q"); // operator instantiation
...
ansys::dpf::FieldsContainer my_surface_heat_rate = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_surface_heat_rate = op.outputs.surface_heat_rate()
```
</details>
...
my_surface_heat_rate = op.outputs.surface_heat_rate.GetData()
```
</details>
<br>
