...
# result:mapdl::mode::mesh_property_provider
 ...
 **Internal name**: mapdl::mode::mesh_property_provider
...
ansys::dpf::Operator op("mapdl::mode::mesh_property_provider"); // operator instantiation
