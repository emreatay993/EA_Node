...
# result:mapdl::cms::ModalBasis

**Version: 0.0.0**

## Description

Read/computemodal basis. If a downstream info (from a usepass) is provided, an expansion usepass*genpass is computed
 ...
 **Internal name**: mapdl::cms::ModalBasis
...
ansys::dpf::Operator op("mapdl::cms::ModalBasis"); // operator instantiation
