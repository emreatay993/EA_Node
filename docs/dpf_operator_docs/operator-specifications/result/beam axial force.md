...
# result:lsdyna::d3plot::B_N

**Version: 0.0.0**

## Description

Read Beam Axial Force from result streams
...
|-------|------|------------------|-------------|
|  **Pin 0**| beam_axial_force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | beam axial force |
 ...
 **Scripting name**: beam axial force

 **Full name**: result.beam axial force

 **Internal name**: lsdyna::d3plot::B_N
...
ansys::dpf::Operator op("lsdyna::d3plot::B_N"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(1, my_mesh_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_beam_axial_force = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
op = dpf.operators.result.beam axial force() # operator instantiation
op.inputs.time_scoping.connect(my_time_scoping)
op.inputs.mesh_scoping.connect(my_mesh_scoping)
op.inputs.streams_container.connect(my_streams_container)
op.inputs.data_sources.connect(my_data_sources)
op.inputs.unit_system.connect(my_unit_system)
my_beam_axial_force = op.outputs.beam_axial_force()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_beam_axial_force = op.outputs.beam_axial_force.GetData()
```
</details>
<br>
