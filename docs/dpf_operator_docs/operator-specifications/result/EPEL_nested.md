...
Read/computeelement nodal component elastic strainsfor a datasource containing nested superelements is provider
...
ansys::dpf::Operator op("EPEL_nested"); // operator instantiation
