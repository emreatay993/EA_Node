...
# result:cff::flprj::V_SUP

**Version: 0.0.0**

## Description

Reads/computes Superficial Velocity from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| superficial_velocity |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | superficial_velocity |
...
ansys::dpf::Operator op("cff::flprj::V_SUP"); // operator instantiation
...
ansys::dpf::FieldsContainer my_superficial_velocity = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_superficial_velocity = op.outputs.superficial_velocity()
```
</details>
...
my_superficial_velocity = op.outputs.superficial_velocity.GetData()
```
</details>
<br>
