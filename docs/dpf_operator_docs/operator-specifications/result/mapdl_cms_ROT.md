...
# result:mapdl::cms::ROT

**Version: 0.0.0**

## Description

Read/computenodal rotation. If a downstream info (from a usepass) is provided, an expansion usepass*genpass is computed
...
ansys::dpf::Operator op("mapdl::cms::ROT"); // operator instantiation
