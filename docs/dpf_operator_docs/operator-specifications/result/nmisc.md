...
Read NMISC results from the rst file. On demand expansion and cyclic expansion procedures not supported since results cannot be summed.
...
| <strong>Pin 10</strong>|  item_index |[`int32`](../../core-concepts/dpf-types.md#standard-types), [`vector<int32>`](../../core-concepts/dpf-types.md#standard-types) | 1-Based Index of requested item. A List of 1-Based Indexes can be provided for items at several locations in the NMisc Table |
...
ansys::dpf::Operator op("mapdl::rth::NMISC"); // operator instantiation
