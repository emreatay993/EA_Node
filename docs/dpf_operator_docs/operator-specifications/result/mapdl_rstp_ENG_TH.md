...
# result:mapdl::rstp::ENG_TH

**Version: 0.0.0**

## Description

Read thermal dissipation energy from rst file.
 ...
 **Internal name**: mapdl::rstp::ENG_TH
...
ansys::dpf::Operator op("mapdl::rstp::ENG_TH"); // operator instantiation
