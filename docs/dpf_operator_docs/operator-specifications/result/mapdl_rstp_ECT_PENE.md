...
# result:mapdl::rstp::ECT_PENE

**Version: 0.0.0**

## Description

Read element contact penetration from rst file.
 ...
 **Internal name**: mapdl::rstp::ECT_PENE
...
ansys::dpf::Operator op("mapdl::rstp::ECT_PENE"); // operator instantiation
