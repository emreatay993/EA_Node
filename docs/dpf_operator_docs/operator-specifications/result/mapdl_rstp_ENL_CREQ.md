...
# result:mapdl::rstp::ENL_CREQ

**Version: 0.0.0**

## Description

Read element nodal accumulated equivalent creep strain from rst file.
 ...
 **Internal name**: mapdl::rstp::ENL_CREQ
...
ansys::dpf::Operator op("mapdl::rstp::ENL_CREQ"); // operator instantiation
