 ...
 **Full name**: result.nodal_averaged_thermal_strains
...
ansys::dpf::Operator op("mapdl::rst::NTH"); // operator instantiation
...
op = dpf.operators.result.nodal_averaged_thermal_strains() # operator instantiation
