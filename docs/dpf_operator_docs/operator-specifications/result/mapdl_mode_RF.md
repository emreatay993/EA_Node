...
# result:mapdl::mode::RF

**Version: 0.0.0**

## Description

Load the appropriate operator based on the data sources and read/computenodal reaction forces
...
|-------|------|------------------|-------------|
|  **Pin 0**| fields_containerA |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) |  |
|  **Pin 1**| fields_containerB |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) |  |
...
ansys::dpf::Operator op("mapdl::mode::RF"); // operator instantiation
