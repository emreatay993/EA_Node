...
# result:heat generation

**Version: 0.0.0**

## Description

Computes centroid of field1 and field2. fieldOut = fieldIn*(1.-fact)+Field2*(fact)
 ...
 **Scripting name**: heat_generation

 **Full name**: result.heat_generation

 **Internal name**: HeatSource
...
ansys::dpf::Operator op("HeatSource"); // operator instantiation
...
op = dpf.operators.result.heat_generation() # operator instantiation
