...
# result:mapdl::rstp::JC

**Version: 0.0.0**

## Description

Read conduction current density from rst file.
...
ansys::dpf::Operator op("mapdl::rstp::JC"); // operator instantiation
