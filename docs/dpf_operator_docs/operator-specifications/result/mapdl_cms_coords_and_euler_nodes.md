...
# result:mapdl::cms::coords_and_euler_nodes
 ...
 **Internal name**: mapdl::cms::coords_and_euler_nodes
...
ansys::dpf::Operator op("mapdl::cms::coords_and_euler_nodes"); // operator instantiation
