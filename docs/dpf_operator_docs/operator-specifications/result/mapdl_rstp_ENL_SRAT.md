...
# result:mapdl::rstp::ENL_SRAT

**Version: 0.0.0**

## Description

Read element nodal stress ratio from rst file.
 ...
 **Internal name**: mapdl::rstp::ENL_SRAT
...
ansys::dpf::Operator op("mapdl::rstp::ENL_SRAT"); // operator instantiation
