...
# result:lsdyna::d3plot::XI

**Version: 0.0.0**

## Description

Read Initial Coordinates from result streams
...
|-------|------|------------------|-------------|
|  **Pin 0**| initial_coordinates |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | initial coordinates |
 ...
 **Scripting name**: initial coordinates

 **Full name**: result.initial coordinates

 **Internal name**: lsdyna::d3plot::XI
...
ansys::dpf::Operator op("lsdyna::d3plot::XI"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(1, my_mesh_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_initial_coordinates = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
op = dpf.operators.result.initial coordinates() # operator instantiation
op.inputs.time_scoping.connect(my_time_scoping)
op.inputs.mesh_scoping.connect(my_mesh_scoping)
op.inputs.streams_container.connect(my_streams_container)
op.inputs.data_sources.connect(my_data_sources)
op.inputs.unit_system.connect(my_unit_system)
my_initial_coordinates = op.outputs.initial_coordinates()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_initial_coordinates = op.outputs.initial_coordinates.GetData()
```
</details>
<br>
