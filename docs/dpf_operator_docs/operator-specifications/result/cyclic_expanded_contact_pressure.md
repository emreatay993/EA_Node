...
This operator is deprecated: use the operator element contact pressure with the read_cyclic pin instead. Read element contact pressure from a result file and expand it with cyclic symmetry.
 ...
 **Scripting name**: cyclic_expanded_contact_pressure

 **Full name**: result.cyclic_expanded_contact_pressure

 **Internal name**: ECT_PRES_cyclic
...
ansys::dpf::Operator op("ECT_PRES_cyclic"); // operator instantiation
...
op = dpf.operators.result.cyclic_expanded_contact_pressure() # operator instantiation
