...
# result:mapdl::rstp::ECT_FRES

**Version: 0.0.0**

## Description

Read element actual applied fluid penetration pressure from rst file.
 ...
 **Internal name**: mapdl::rstp::ECT_FRES
...
ansys::dpf::Operator op("mapdl::rstp::ECT_FRES"); // operator instantiation
