...
# result:mapdl::rstp::ENG_KE

**Version: 0.0.0**

## Description

Read kinetic energy from rst file.
 ...
 **Internal name**: mapdl::rstp::ENG_KE
...
ansys::dpf::Operator op("mapdl::rstp::ENG_KE"); // operator instantiation
