...
# result:mapdl::rfrq::mesh_property_provider
 ...
 **Internal name**: mapdl::rfrq::mesh_property_provider
...
ansys::dpf::Operator op("mapdl::rfrq::mesh_property_provider"); // operator instantiation
