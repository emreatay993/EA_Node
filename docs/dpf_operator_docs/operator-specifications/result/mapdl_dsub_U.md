...
Read/compute nodal displacementsfrom a use pass file and expand the result if an upstream is available
...
ansys::dpf::Operator op("mapdl::dsub::U"); // operator instantiation
