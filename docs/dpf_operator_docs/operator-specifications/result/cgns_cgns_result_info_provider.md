...
# result:cgns result info provider provider
 ...
 **Internal name**: cgns::cgns::result_info_provider
...
ansys::dpf::Operator op("cgns::cgns::result_info_provider"); // operator instantiation
