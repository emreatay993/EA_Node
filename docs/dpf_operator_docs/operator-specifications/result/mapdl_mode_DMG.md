...
# result:mapdl::mode::DMG

**Version: 0.0.0**

## Description

Read/computenodal rotational acceleration. If a downstream info (from a usepass) is provided, an expansion usepass*genpass is computed
...
ansys::dpf::Operator op("mapdl::mode::DMG"); // operator instantiation
