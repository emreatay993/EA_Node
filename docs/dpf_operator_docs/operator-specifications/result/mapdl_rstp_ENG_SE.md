...
# result:mapdl::rstp::ENG_SE

**Version: 0.0.0**

## Description

Read element energy associated with the stiffness matrix from rst file.
 ...
 **Internal name**: mapdl::rstp::ENG_SE
...
ansys::dpf::Operator op("mapdl::rstp::ENG_SE"); // operator instantiation
