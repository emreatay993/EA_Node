...
# result:mapdl::mode::NMISC

**Version: 0.0.0**

## Description

Load the appropriate operator based on the data sources and read/computeelemental non summable miscellaneous data
 ...
 **Internal name**: mapdl::mode::NMISC
...
ansys::dpf::Operator op("mapdl::mode::NMISC"); // operator instantiation
