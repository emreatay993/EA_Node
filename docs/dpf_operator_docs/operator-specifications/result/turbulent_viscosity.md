...
# result:cff::flprj::MUT

**Version: 0.0.0**

## Description

Reads/computes Turbulent Viscosity from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| turbulent_viscosity |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | turbulent_viscosity |
...
ansys::dpf::Operator op("cff::flprj::MUT"); // operator instantiation
...
ansys::dpf::FieldsContainer my_turbulent_viscosity = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_turbulent_viscosity = op.outputs.turbulent_viscosity()
```
</details>
...
my_turbulent_viscosity = op.outputs.turbulent_viscosity.GetData()
```
</details>
<br>
