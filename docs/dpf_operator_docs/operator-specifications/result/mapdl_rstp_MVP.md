...
# result:mapdl::rstp::MVP

**Version: 0.0.0**

## Description

Read magnetic vector potential from rst file.
...
ansys::dpf::Operator op("mapdl::rstp::MVP"); // operator instantiation
