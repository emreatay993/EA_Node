...
This operator is deprecated: use the operator element contact status with the read_cyclic pin instead. Read element contact status from a result file and expand it with cyclic symmetry.
 ...
 **Scripting name**: cyclic_expanded_contact_status

 **Full name**: result.cyclic_expanded_contact_status

 **Internal name**: ECT_STAT_cyclic
...
ansys::dpf::Operator op("ECT_STAT_cyclic"); // operator instantiation
...
op = dpf.operators.result.cyclic_expanded_contact_status() # operator instantiation
