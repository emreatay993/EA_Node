...
This operator is deprecated: use the operator equivalent dof mass with the read_cyclic pin instead. Read equivalent dof mass from a result file and expand it with cyclic symmetry.
 ...
 **Internal name**: equivalent_mass_cyclic
...
ansys::dpf::Operator op("equivalent_mass_cyclic"); // operator instantiation
...
op = dpf.operators.result.cyclic_equivalent_mass() # operator instantiation
