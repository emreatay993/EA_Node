...
# result:cff::flprj::OME

**Version: 0.0.0**

## Description

Reads/computes Turbulent Specific Dissipation Rate from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| omega |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | omega |
...
ansys::dpf::Operator op("cff::flprj::OME"); // operator instantiation
...
ansys::dpf::FieldsContainer my_omega = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_omega = op.outputs.omega.GetData()
```
</details>
<br>
