...
# result:mapdl::rfrq::is_mesh_available
 ...
 **Internal name**: mapdl::rfrq::is_mesh_available
...
ansys::dpf::Operator op("mapdl::rfrq::is_mesh_available"); // operator instantiation
