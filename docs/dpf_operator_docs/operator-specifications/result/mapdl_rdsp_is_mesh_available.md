...
# result:mapdl::rdsp::is_mesh_available
 ...
 **Internal name**: mapdl::rdsp::is_mesh_available
...
ansys::dpf::Operator op("mapdl::rdsp::is_mesh_available"); // operator instantiation
