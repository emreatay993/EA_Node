...
# result:mapdl::rstp::ECT_SFRIC

**Version: 0.0.0**

## Description

Read element contact friction stress from rst file.
 ...
 **Internal name**: mapdl::rstp::ECT_SFRIC
...
ansys::dpf::Operator op("mapdl::rstp::ECT_SFRIC"); // operator instantiation
