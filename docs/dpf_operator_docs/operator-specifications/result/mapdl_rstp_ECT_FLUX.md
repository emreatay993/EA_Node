...
# result:mapdl::rstp::ECT_FLUX

**Version: 0.0.0**

## Description

Read element total heat flux at contact surface from rst file.
 ...
 **Internal name**: mapdl::rstp::ECT_FLUX
...
ansys::dpf::Operator op("mapdl::rstp::ECT_FLUX"); // operator instantiation
