...
Read/computeelemental summable miscellaneous datafor a datasource containing nested superelements is provider
...
ansys::dpf::Operator op("SMISC_nested"); // operator instantiation
