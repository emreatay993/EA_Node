...
This operator is deprecated: use the operator element total number of contact status changes during substep with the read_cyclic pin instead. Read element total number of contact status changes during substep from a result file and expand it with cyclic symmetry.
 ...
 **Scripting name**: cyclic_expanded_num_surface_status_changes

 **Full name**: result.cyclic_expanded_num_surface_status_changes

 **Internal name**: ECT_CNOS_cyclic
...
ansys::dpf::Operator op("ECT_CNOS_cyclic"); // operator instantiation
...
op = dpf.operators.result.cyclic_expanded_num_surface_status_changes() # operator instantiation
