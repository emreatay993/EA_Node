 ...
 **Full name**: result.nodal_averaged_plastic_strains
...
ansys::dpf::Operator op("mapdl::rst::NPPL"); // operator instantiation
...
op = dpf.operators.result.nodal_averaged_plastic_strains() # operator instantiation
