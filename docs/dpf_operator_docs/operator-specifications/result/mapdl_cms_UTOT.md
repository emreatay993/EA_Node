...
# result:mapdl::cms::UTOT

**Version: 0.0.0**

## Description

Read/computeU vector from the finite element problem KU=F. If a downstream info (from a usepass) is provided, an expansion usepass*genpass is computed
...
| <strong>Pin 17</strong>|  domain_pin_id |[`int32`](../../core-concepts/dpf-types.md#standard-types) | one modes fields container by domain id is kept in the cache |
| <strong>Pin 100</strong>|  down_stream_info |[`fields_container`](../../core-concepts/dpf-types.md#fields-container), [`down_stream_info`](../../core-concepts/dpf-types.md#down-stream-info) | modal response is expected to compute expansion, the user can also add rigid body transfomations. If no dowsn stream info is provided, the modes are provided in output |
...
ansys::dpf::Operator op("mapdl::cms::UTOT"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(1, my_mesh_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(17, my_domain_pin_id);
