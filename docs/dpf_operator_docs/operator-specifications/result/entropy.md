...
# result:cff::flprj::S_S

**Version: 0.0.0**

## Description

Reads/computes Entropy from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| entropy |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | entropy |
...
ansys::dpf::Operator op("cff::flprj::S_S"); // operator instantiation
...
ansys::dpf::FieldsContainer my_entropy = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_entropy = op.outputs.entropy.GetData()
```
</details>
<br>
