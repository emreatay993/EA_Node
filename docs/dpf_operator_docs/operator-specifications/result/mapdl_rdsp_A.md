...
Read/compute nodal accelerationsfrom a use pass file and expand the result if an upstream is available
...
ansys::dpf::Operator op("mapdl::rdsp::A"); // operator instantiation
