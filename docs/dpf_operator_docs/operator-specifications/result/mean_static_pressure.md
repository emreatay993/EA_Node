...
# result:cff::flprj::P_SA

**Version: 0.0.0**

## Description

Reads/computes Mean Static Pressure from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| mean_static_pressure |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | mean_static_pressure |
...
ansys::dpf::Operator op("cff::flprj::P_SA"); // operator instantiation
...
ansys::dpf::FieldsContainer my_mean_static_pressure = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_mean_static_pressure = op.outputs.mean_static_pressure()
```
</details>
...
my_mean_static_pressure = op.outputs.mean_static_pressure.GetData()
```
</details>
<br>
