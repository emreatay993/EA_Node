...
# result:mapdl::rstp::ENL_SEPL

**Version: 0.0.0**

## Description

Read element nodal equivalent stress parameter from rst file.
 ...
 **Internal name**: mapdl::rstp::ENL_SEPL
...
ansys::dpf::Operator op("mapdl::rstp::ENL_SEPL"); // operator instantiation
