...
# result:cff::flprj::V_A

**Version: 0.0.0**

## Description

Reads/computes Mean Velocity from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| mean_velocity |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | mean_velocity |
...
ansys::dpf::Operator op("cff::flprj::V_A"); // operator instantiation
...
ansys::dpf::FieldsContainer my_mean_velocity = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_mean_velocity = op.outputs.mean_velocity()
```
</details>
...
my_mean_velocity = op.outputs.mean_velocity.GetData()
```
</details>
<br>
