...
This operator is deprecated: use the operator element actual applied fluid penetration pressure with the read_cyclic pin instead. Read element actual applied fluid penetration pressure from a result file and expand it with cyclic symmetry.
 ...
 **Scripting name**: cyclic_expanded_contact_fluid_penetration_pressure

 **Full name**: result.cyclic_expanded_contact_fluid_penetration_pressure

 **Internal name**: ECT_FRES_cyclic
...
ansys::dpf::Operator op("ECT_FRES_cyclic"); // operator instantiation
...
op = dpf.operators.result.cyclic_expanded_contact_fluid_penetration_pressure() # operator instantiation
