...
# result:lsdyna::d3plot::X

**Version: 0.0.0**

## Description

Read Coordinates from result streams
...
|-------|------|------------------|-------------|
|  **Pin 0**| coordinates |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | coordinates |
...
ansys::dpf::Operator op("lsdyna::d3plot::X"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(1, my_mesh_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_coordinates = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
