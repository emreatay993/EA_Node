...
# result:mapdl::mode::is_mesh_available
 ...
 **Internal name**: mapdl::mode::is_mesh_available
...
ansys::dpf::Operator op("mapdl::mode::is_mesh_available"); // operator instantiation
