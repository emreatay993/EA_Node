...
# result:cms expanded elastic strain

**Version: 0.0.0**

## Description

Read/compute element nodal component elastic strains expanded result.
 ...
 **Scripting name**: cms_expanded_elastic_strain

 **Full name**: result.cms_expanded_elastic_strain

 **Internal name**: EPEL_cms
...
ansys::dpf::Operator op("EPEL_cms"); // operator instantiation
...
op = dpf.operators.result.cms_expanded_elastic_strain() # operator instantiation
