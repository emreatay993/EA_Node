...
Reads/computes Enthalpy from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| enthalpy |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | enthalpy |
...
ansys::dpf::Operator op("cff::cas::H_S"); // operator instantiation
...
ansys::dpf::FieldsContainer my_enthalpy = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_enthalpy = op.outputs.enthalpy()
```
</details>
...
my_enthalpy = op.outputs.enthalpy.GetData()
```
</details>
<br>
