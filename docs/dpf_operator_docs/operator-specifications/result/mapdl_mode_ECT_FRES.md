...
# result:mapdl::mode::ECT_FRES

**Version: 0.0.0**

## Description

Load the appropriate operator based on the data sources and read/computeelement actual applied fluid penetration pressure
 ...
 **Internal name**: mapdl::mode::ECT_FRES
...
ansys::dpf::Operator op("mapdl::mode::ECT_FRES"); // operator instantiation
