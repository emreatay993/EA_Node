...
# result:lsdyna::d3plot::qx

**Version: 0.0.0**

## Description

Read Shell X Shear Force from result streams
...
|-------|------|------------------|-------------|
|  **Pin 0**| shell_x_shear_force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | shell x shear force |
 ...
 **Scripting name**: shell x shear force

 **Full name**: result.shell x shear force

 **Internal name**: lsdyna::d3plot::qx
...
ansys::dpf::Operator op("lsdyna::d3plot::qx"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(25, my_part_id);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_shell_x_shear_force = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
op = dpf.operators.result.shell x shear force() # operator instantiation
op.inputs.time_scoping.connect(my_time_scoping)
op.inputs.streams_container.connect(my_streams_container)
op.inputs.data_sources.connect(my_data_sources)
op.inputs.part_id.connect(my_part_id)
op.inputs.unit_system.connect(my_unit_system)
my_shell_x_shear_force = op.outputs.shell_x_shear_force()
```
</details>
...
op.inputs.part_id.Connect(my_part_id)
op.inputs.unit_system.Connect(my_unit_system)
my_shell_x_shear_force = op.outputs.shell_x_shear_force.GetData()
```
</details>
<br>
