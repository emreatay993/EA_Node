...
# result:mapdl::rstp::ECT_CNOS

**Version: 0.0.0**

## Description

Read element total number of contact status changes during substep from rst file.
 ...
 **Internal name**: mapdl::rstp::ECT_CNOS
...
ansys::dpf::Operator op("mapdl::rstp::ECT_CNOS"); // operator instantiation
