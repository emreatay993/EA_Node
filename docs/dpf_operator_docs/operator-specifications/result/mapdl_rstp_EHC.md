...
# result:mapdl::rstp::EHC

**Version: 0.0.0**

## Description

Read element heat generation from rst file.
...
ansys::dpf::Operator op("mapdl::rstp::EHC"); // operator instantiation
