...
# result:cms expanded velocity

**Version: 0.0.0**

## Description

Read/compute nodal velocities expanded result.
 ...
 **Scripting name**: cms_expanded_velocity

 **Full name**: result.cms_expanded_velocity
...
ansys::dpf::Operator op("V_cms"); // operator instantiation
...
op = dpf.operators.result.cms_expanded_velocity() # operator instantiation
