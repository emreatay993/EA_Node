...
# result:cms expanded raw displacement

**Version: 0.0.0**

## Description

Read/compute U vector from the finite element problem KU=F expanded result.
...
| <strong>Pin 1</strong>|  mesh_scoping |[`scoping`](../../core-concepts/dpf-types.md#scoping) | mesh entities scoping, unordered_map<int, int> id to index (optional) (index is optional, to be set if a user wants the results at a given order) |
...
| <strong>Pin 100</strong>|  down_stream_info |[`fields_container`](../../core-concepts/dpf-types.md#fields-container), [`down_stream_info`](../../core-concepts/dpf-types.md#down-stream-info) | Solution in modal basis can be provided to compute expansion. If not provided, it will be recovered thanks to MCF operator |
 ...
 **Scripting name**: cms_expanded_raw_displacement

 **Full name**: result.cms_expanded_raw_displacement

 **Internal name**: UTOT_cms
...
ansys::dpf::Operator op("UTOT_cms"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(1, my_mesh_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(100, my_down_stream_info);
...
op = dpf.operators.result.cms_expanded_raw_displacement() # operator instantiation
op.inputs.time_scoping.connect(my_time_scoping)
op.inputs.mesh_scoping.connect(my_mesh_scoping)
op.inputs.streams_container.connect(my_streams_container)
op.inputs.data_sources.connect(my_data_sources)
op.inputs.down_stream_info.connect(my_down_stream_info)
