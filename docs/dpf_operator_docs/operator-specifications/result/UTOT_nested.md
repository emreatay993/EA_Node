...
Read/computeU vector from the finite element problem KU=Ffor a datasource containing nested superelements is provider
...
ansys::dpf::Operator op("UTOT_nested"); // operator instantiation
