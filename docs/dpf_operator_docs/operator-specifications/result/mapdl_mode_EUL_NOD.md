...
# result:mapdl::mode::EUL_NOD

**Version: 0.0.0**

## Description

Load the appropriate operator based on the data sources and read/computenode euler angles
 ...
 **Internal name**: mapdl::mode::EUL_NOD
...
ansys::dpf::Operator op("mapdl::mode::EUL_NOD"); // operator instantiation
