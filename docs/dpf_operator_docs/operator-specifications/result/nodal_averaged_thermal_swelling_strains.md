 ...
 **Full name**: result.nodal_averaged_thermal_swelling_strains
...
ansys::dpf::Operator op("mapdl::rst::NTH_SWL"); // operator instantiation
...
op = dpf.operators.result.nodal_averaged_thermal_swelling_strains() # operator instantiation
