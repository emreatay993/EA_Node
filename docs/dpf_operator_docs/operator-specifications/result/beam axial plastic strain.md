...
# result:lsdyna::d3plot::B_EPPL

**Version: 0.0.0**

## Description

Read Beam Axial Plastic strain from result streams
...
| <strong>Pin 6</strong>|  ipt_scoping |[`int32`](../../core-concepts/dpf-types.md#standard-types) | set integration point |
...
|-------|------|------------------|-------------|
|  **Pin 0**| beam_axial_plastic_strain |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | beam axial plastic strain |
 ...
 **Scripting name**: beam axial plastic strain

 **Full name**: result.beam axial plastic strain

 **Internal name**: lsdyna::d3plot::B_EPPL
...
ansys::dpf::Operator op("lsdyna::d3plot::B_EPPL"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(1, my_mesh_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(6, my_ipt_scoping);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_beam_axial_plastic_strain = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
op = dpf.operators.result.beam axial plastic strain() # operator instantiation
op.inputs.time_scoping.connect(my_time_scoping)
op.inputs.mesh_scoping.connect(my_mesh_scoping)
op.inputs.streams_container.connect(my_streams_container)
op.inputs.data_sources.connect(my_data_sources)
op.inputs.ipt_scoping.connect(my_ipt_scoping)
op.inputs.unit_system.connect(my_unit_system)
my_beam_axial_plastic_strain = op.outputs.beam_axial_plastic_strain()
```
</details>
...
op.inputs.ipt_scoping.Connect(my_ipt_scoping)
op.inputs.unit_system.Connect(my_unit_system)
my_beam_axial_plastic_strain = op.outputs.beam_axial_plastic_strain.GetData()
```
</details>
<br>
