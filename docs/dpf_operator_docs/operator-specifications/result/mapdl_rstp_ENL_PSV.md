...
# result:mapdl::rstp::ENL_PSV

**Version: 0.0.0**

## Description

Read element nodal plastic state variable from rst file.
 ...
 **Internal name**: mapdl::rstp::ENL_PSV
...
ansys::dpf::Operator op("mapdl::rstp::ENL_PSV"); // operator instantiation
