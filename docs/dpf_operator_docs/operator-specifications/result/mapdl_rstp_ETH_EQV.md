...
# result:mapdl::rstp::ETH_EQV

**Version: 0.0.0**

## Description

Read equivalent thermal strains from rst file.
 ...
 **Internal name**: mapdl::rstp::ETH_EQV
...
ansys::dpf::Operator op("mapdl::rstp::ETH_EQV"); // operator instantiation
