...
# result:mapdl::rstp::EPEL_EQV

**Version: 0.0.0**

## Description

Read equivalent elastic strain from rst file.
 ...
 **Internal name**: mapdl::rstp::EPEL_EQV
...
ansys::dpf::Operator op("mapdl::rstp::EPEL_EQV"); // operator instantiation
