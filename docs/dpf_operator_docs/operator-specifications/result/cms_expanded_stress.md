...
# result:cms expanded stress

**Version: 0.0.0**

## Description

Read/compute element nodal component stresses expanded result.
 ...
 **Scripting name**: cms_expanded_stress

 **Full name**: result.cms_expanded_stress
...
ansys::dpf::Operator op("S_cms"); // operator instantiation
...
op = dpf.operators.result.cms_expanded_stress() # operator instantiation
