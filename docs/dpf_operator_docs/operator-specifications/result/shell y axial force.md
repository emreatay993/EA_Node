...
# result:lsdyna::d3plot::ny

**Version: 0.0.0**

## Description

Read Shell Y Axial Force from result streams
...
|-------|------|------------------|-------------|
|  **Pin 0**| shell_y_axial_force |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | shell y axial force |
 ...
 **Scripting name**: shell y axial force

 **Full name**: result.shell y axial force

 **Internal name**: lsdyna::d3plot::ny
...
ansys::dpf::Operator op("lsdyna::d3plot::ny"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(25, my_part_id);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_shell_y_axial_force = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
op = dpf.operators.result.shell y axial force() # operator instantiation
op.inputs.time_scoping.connect(my_time_scoping)
op.inputs.streams_container.connect(my_streams_container)
op.inputs.data_sources.connect(my_data_sources)
op.inputs.part_id.connect(my_part_id)
op.inputs.unit_system.connect(my_unit_system)
my_shell_y_axial_force = op.outputs.shell_y_axial_force()
```
</details>
...
op.inputs.part_id.Connect(my_part_id)
op.inputs.unit_system.Connect(my_unit_system)
my_shell_y_axial_force = op.outputs.shell_y_axial_force.GetData()
```
</details>
<br>
