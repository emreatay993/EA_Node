...
# result:mapdl::rdsp::boundary_conditions
 ...
 **Internal name**: mapdl::rdsp::boundary_conditions
...
ansys::dpf::Operator op("mapdl::rdsp::boundary_conditions"); // operator instantiation
