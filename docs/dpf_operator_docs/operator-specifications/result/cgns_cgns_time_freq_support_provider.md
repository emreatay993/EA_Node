...
# result:cgns time freq support provider
 ...
 **Internal name**: cgns::cgns::time_freq_support_provider
...
ansys::dpf::Operator op("cgns::cgns::time_freq_support_provider"); // operator instantiation
