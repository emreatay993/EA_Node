...
# result:mapdl::cms::mesh_property_provider
 ...
 **Internal name**: mapdl::cms::mesh_property_provider
...
ansys::dpf::Operator op("mapdl::cms::mesh_property_provider"); // operator instantiation
