...
# result:lsdyna::d3plot::GLOB_V

**Version: 0.0.0**

## Description

Read Global Velocity from result streams
...
|-------|------|------------------|-------------|
|  **Pin 0**| global_velocity |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | global velocity |
 ...
 **Scripting name**: global velocity

 **Full name**: result.global velocity

 **Internal name**: lsdyna::d3plot::GLOB_V
...
ansys::dpf::Operator op("lsdyna::d3plot::GLOB_V"); // operator instantiation
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_global_velocity = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
op = dpf.operators.result.global velocity() # operator instantiation
op.inputs.streams_container.connect(my_streams_container)
op.inputs.data_sources.connect(my_data_sources)
op.inputs.unit_system.connect(my_unit_system)
my_global_velocity = op.outputs.global_velocity()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_global_velocity = op.outputs.global_velocity.GetData()
```
</details>
<br>
