...
# result:cff::flprj::P_TOT

**Version: 0.0.0**

## Description

Reads/computes Total Pressure from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| total_pressure |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | total_pressure |
...
ansys::dpf::Operator op("cff::flprj::P_TOT"); // operator instantiation
...
ansys::dpf::FieldsContainer my_total_pressure = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_total_pressure = op.outputs.total_pressure()
```
</details>
...
my_total_pressure = op.outputs.total_pressure.GetData()
```
</details>
<br>
