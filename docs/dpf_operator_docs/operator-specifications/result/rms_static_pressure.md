...
# result:cff::cas::P_SRMS

**Version: 0.0.0**

## Description

Reads/computes RMS Static Pressure from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| rms_static_pressure |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | rms_static_pressure |
...
ansys::dpf::Operator op("cff::cas::P_SRMS"); // operator instantiation
...
ansys::dpf::FieldsContainer my_rms_static_pressure = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_rms_static_pressure = op.outputs.rms_static_pressure()
```
</details>
...
my_rms_static_pressure = op.outputs.rms_static_pressure.GetData()
```
</details>
<br>
