...
# result:mapdl::rdsp::OMG

**Version: 0.0.0**

## Description

Read/compute nodal rotational velocityfrom a use pass file and expand the result if an upstream is available
...
ansys::dpf::Operator op("mapdl::rdsp::OMG"); // operator instantiation
