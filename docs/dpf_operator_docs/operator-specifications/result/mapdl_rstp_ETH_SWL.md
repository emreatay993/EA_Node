...
# result:mapdl::rstp::ETH_SWL

**Version: 0.0.0**

## Description

Read swelling strains from rst file.
 ...
 **Internal name**: mapdl::rstp::ETH_SWL
...
ansys::dpf::Operator op("mapdl::rstp::ETH_SWL"); // operator instantiation
