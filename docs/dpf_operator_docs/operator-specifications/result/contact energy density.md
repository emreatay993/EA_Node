...
# result:lsdyna::d3plot::node_contact_energy_density

**Version: 0.0.0**

## Description

Read Contact Energy Density from result streams
...
|-------|------|------------------|-------------|
|  **Pin 0**| contact_energy_density |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | contact energy density |
 ...
 **Scripting name**: contact energy density

 **Full name**: result.contact energy density

 **Internal name**: lsdyna::d3plot::node_contact_energy_density
...
ansys::dpf::Operator op("lsdyna::d3plot::node_contact_energy_density"); // operator instantiation
op.connect(0, my_time_scoping);
op.connect(1, my_mesh_scoping);
op.connect(3, my_streams_container);
op.connect(4, my_data_sources);
op.connect(50, my_unit_system);
ansys::dpf::FieldsContainer my_contact_energy_density = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
op = dpf.operators.result.contact energy density() # operator instantiation
op.inputs.time_scoping.connect(my_time_scoping)
op.inputs.mesh_scoping.connect(my_mesh_scoping)
op.inputs.streams_container.connect(my_streams_container)
op.inputs.data_sources.connect(my_data_sources)
op.inputs.unit_system.connect(my_unit_system)
my_contact_energy_density = op.outputs.contact_energy_density()
```
</details>
...
op.inputs.data_sources.Connect(my_data_sources)
op.inputs.unit_system.Connect(my_unit_system)
my_contact_energy_density = op.outputs.contact_energy_density.GetData()
```
</details>
<br>
