...
Read/computenodal velocities. If a downstream info (from a usepass) is provided, an expansion usepass*genpass is computed
...
ansys::dpf::Operator op("mapdl::cms::V"); // operator instantiation
