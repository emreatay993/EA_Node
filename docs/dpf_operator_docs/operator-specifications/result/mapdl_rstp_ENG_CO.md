...
# result:mapdl::rstp::ENG_CO

**Version: 0.0.0**

## Description

Read co-energy (magnetics) from rst file.
 ...
 **Internal name**: mapdl::rstp::ENG_CO
...
ansys::dpf::Operator op("mapdl::rstp::ENG_CO"); // operator instantiation
