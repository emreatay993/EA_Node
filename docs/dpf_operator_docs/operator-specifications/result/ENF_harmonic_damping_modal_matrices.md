...
# result:ENF_harmonic_damping_modal_matrices

**Version: 0.0.0**

## Description

Read damping modal matrices (with their coefficients for reaction forces msup expansion from a rst file.
...
| <strong>Pin 10</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  damping_coefs |[`generic_data_container`](../../core-concepts/dpf-types.md#generic-data-container) |  |
| <strong>Pin 12</strong> <br><span style="background-color:#d93025; color:white; padding:2px 6px; border-radius:3px; font-size:0.75em;">Required</span>|  freq |[`double`](../../core-concepts/dpf-types.md#standard-types) |  |
...
|  **Pin 2**| element_nodal_forces |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) |  |
 ...
 **Internal name**: ENF_harmonic_damping_modal_matrices
...
ansys::dpf::Operator op("ENF_harmonic_damping_modal_matrices"); // operator instantiation
...
op.connect(10, my_damping_coefs);
op.connect(12, my_freq);
op.connect(14, my_read_cyclic);
ansys::dpf::FieldsContainer my_fields_container = op.getOutput<ansys::dpf::FieldsContainer>(0);
ansys::dpf::FieldsContainer my_element_nodal_forces = op.getOutput<ansys::dpf::FieldsContainer>(2);
```
</details>
...
op.inputs.damping_coefs.connect(my_damping_coefs)
op.inputs.freq.connect(my_freq)
op.inputs.read_cyclic.connect(my_read_cyclic)
my_fields_container = op.outputs.fields_container()
my_element_nodal_forces = op.outputs.element_nodal_forces()
```
</details>
...
my_element_nodal_forces = op.outputs.element_nodal_forces.GetData()
```
</details>
<br>
