...
This operator is deprecated: use the operator element contact sliding distance with the read_cyclic pin instead. Read element contact sliding distance from a result file and expand it with cyclic symmetry.
 ...
 **Scripting name**: cyclic_expanded_contact_sliding_distance

 **Full name**: result.cyclic_expanded_contact_sliding_distance

 **Internal name**: ECT_SLIDE_cyclic
...
ansys::dpf::Operator op("ECT_SLIDE_cyclic"); // operator instantiation
...
op = dpf.operators.result.cyclic_expanded_contact_sliding_distance() # operator instantiation
