...
# result:cff::flprj::MDOT

**Version: 0.0.0**

## Description

Reads/computes Mass Flow Rate from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| mass_flow_rate |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | mass_flow_rate |
...
ansys::dpf::Operator op("cff::flprj::MDOT"); // operator instantiation
...
ansys::dpf::FieldsContainer my_mass_flow_rate = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_mass_flow_rate = op.outputs.mass_flow_rate()
```
</details>
...
my_mass_flow_rate = op.outputs.mass_flow_rate.GetData()
```
</details>
<br>
