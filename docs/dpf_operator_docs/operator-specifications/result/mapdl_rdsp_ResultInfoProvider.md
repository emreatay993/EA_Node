...
# result:mapdl::rdsp::ResultInfoProvider
 ...
 **Internal name**: mapdl::rdsp::ResultInfoProvider
...
ansys::dpf::Operator op("mapdl::rdsp::ResultInfoProvider"); // operator instantiation
