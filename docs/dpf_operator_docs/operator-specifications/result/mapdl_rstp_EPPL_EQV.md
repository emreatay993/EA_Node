...
# result:mapdl::rstp::EPPL_EQV

**Version: 0.0.0**

## Description

Read element nodal equivalent plastic strain from rst file.
 ...
 **Internal name**: mapdl::rstp::EPPL_EQV
...
ansys::dpf::Operator op("mapdl::rstp::EPPL_EQV"); // operator instantiation
