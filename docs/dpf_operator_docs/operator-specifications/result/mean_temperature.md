...
# result:cff::flprj::TEMP_A

**Version: 0.0.0**

## Description

Reads/computes Mean Temperature from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| mean_temperature |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | mean_temperature |
 ...
 **Internal name**: cff::flprj::TEMP_A
...
ansys::dpf::Operator op("cff::flprj::TEMP_A"); // operator instantiation
...
ansys::dpf::FieldsContainer my_mean_temperature = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_mean_temperature = op.outputs.mean_temperature()
```
</details>
...
my_mean_temperature = op.outputs.mean_temperature.GetData()
```
</details>
<br>
