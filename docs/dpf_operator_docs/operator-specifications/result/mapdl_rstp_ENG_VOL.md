...
# result:mapdl::rstp::ENG_VOL

**Version: 0.0.0**

## Description

Read element volume from rst file.
 ...
 **Internal name**: mapdl::rstp::ENG_VOL
...
ansys::dpf::Operator op("mapdl::rstp::ENG_VOL"); // operator instantiation
