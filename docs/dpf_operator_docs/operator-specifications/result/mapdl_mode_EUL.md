...
# result:mapdl::mode::EUL

**Version: 0.0.0**

## Description

Load the appropriate operator based on the data sources and read/computeelement euler angles
...
ansys::dpf::Operator op("mapdl::mode::EUL"); // operator instantiation
