...
# result:cms expanded acceleration

**Version: 0.0.0**

## Description

Read/compute nodal accelerations expanded result.
 ...
 **Scripting name**: cms_expanded_acceleration

 **Full name**: result.cms_expanded_acceleration
...
ansys::dpf::Operator op("A_cms"); // operator instantiation
...
op = dpf.operators.result.cms_expanded_acceleration() # operator instantiation
