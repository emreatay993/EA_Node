...
Read/compute nodal velocitiesfrom a use pass file and expand the result if an upstream is available
...
ansys::dpf::Operator op("mapdl::rdsp::V"); // operator instantiation
