...
# result:cff::flprj::TEMP

**Version: 0.0.0**

## Description

Reads/computes Temperature from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| temperature |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | temperature |
...
ansys::dpf::Operator op("cff::flprj::TEMP"); // operator instantiation
...
ansys::dpf::FieldsContainer my_temperature = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_temperature = op.outputs.temperature()
```
</details>
...
my_temperature = op.outputs.temperature.GetData()
```
</details>
<br>
