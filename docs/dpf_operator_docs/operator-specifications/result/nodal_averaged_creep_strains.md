 ...
 **Full name**: result.nodal_averaged_creep_strains
...
ansys::dpf::Operator op("mapdl::rst::NCR"); // operator instantiation
...
op = dpf.operators.result.nodal_averaged_creep_strains() # operator instantiation
