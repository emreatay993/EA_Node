...
# result:mapdl::mode::coords_and_euler_nodes
 ...
 **Internal name**: mapdl::mode::coords_and_euler_nodes
...
ansys::dpf::Operator op("mapdl::mode::coords_and_euler_nodes"); // operator instantiation
