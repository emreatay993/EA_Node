...
# result:mapdl::rth::ENG_EUL

**Version: 0.0.0**

## Description

Read element orientation from rst file.
 ...
 **Internal name**: mapdl::rth::ENG_EUL
...
ansys::dpf::Operator op("mapdl::rth::ENG_EUL"); // operator instantiation
