...
# result:mapdl::rstp::ENG_AHO

**Version: 0.0.0**

## Description

Read artificial hourglass energy from rst file.
 ...
 **Internal name**: mapdl::rstp::ENG_AHO
...
ansys::dpf::Operator op("mapdl::rstp::ENG_AHO"); // operator instantiation
