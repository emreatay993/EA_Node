...
# result:lsdyna::d3plot::B_EL

**Version: 0.0.0**

## Description

Read Beam Axial Total strain from result streams
...
|-------|------|------------------|-------------|
|  **Pin 0**| beam_axial_strain |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | beam axial strain |
 ...
 **Scripting name**: beam axial strain

 **Full name**: result.beam axial strain

 **Internal name**: lsdyna::d3plot::B_EL
...
ansys::dpf::Operator op("lsdyna::d3plot::B_EL"); // operator instantiation
...
ansys::dpf::FieldsContainer my_beam_axial_strain = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
op = dpf.operators.result.beam axial strain() # operator instantiation
...
my_beam_axial_strain = op.outputs.beam_axial_strain()
```
</details>
...
op.inputs.ipt_scoping.Connect(my_ipt_scoping)
op.inputs.unit_system.Connect(my_unit_system)
my_beam_axial_strain = op.outputs.beam_axial_strain.GetData()
```
</details>
<br>
