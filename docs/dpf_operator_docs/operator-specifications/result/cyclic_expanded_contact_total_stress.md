...
This operator is deprecated: use the operator element contact total stress (pressure plus friction) with the read_cyclic pin instead. Read element contact total stress (pressure plus friction) from a result file and expand it with cyclic symmetry.
 ...
 **Scripting name**: cyclic_expanded_contact_total_stress

 **Full name**: result.cyclic_expanded_contact_total_stress

 **Internal name**: ECT_STOT_cyclic
...
ansys::dpf::Operator op("ECT_STOT_cyclic"); // operator instantiation
...
op = dpf.operators.result.cyclic_expanded_contact_total_stress() # operator instantiation
