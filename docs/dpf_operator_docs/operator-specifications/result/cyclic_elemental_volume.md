...
# result:cyclic elemental volume

**Version: 0.0.0**

## Description

This operator is deprecated: use the operator element volume with the read_cyclic pin instead. Read element volume from a result file and expand it with cyclic symmetry.
 ...
 **Scripting name**: cyclic_elemental_volume

 **Full name**: result.cyclic_elemental_volume

 **Internal name**: ENG_VOL_cyclic
...
ansys::dpf::Operator op("ENG_VOL_cyclic"); // operator instantiation
...
op = dpf.operators.result.cyclic_elemental_volume() # operator instantiation
