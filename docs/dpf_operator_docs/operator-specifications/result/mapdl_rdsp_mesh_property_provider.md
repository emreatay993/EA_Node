...
# result:mapdl::rdsp::mesh_property_provider
 ...
 **Internal name**: mapdl::rdsp::mesh_property_provider
...
ansys::dpf::Operator op("mapdl::rdsp::mesh_property_provider"); // operator instantiation
