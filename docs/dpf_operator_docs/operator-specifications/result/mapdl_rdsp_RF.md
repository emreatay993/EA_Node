...
# result:mapdl::rdsp::RF

**Version: 0.0.0**

## Description

 Load the appropriate operator based on the data sources and read/compute nodal reaction forces
...
ansys::dpf::Operator op("mapdl::rdsp::RF"); // operator instantiation
