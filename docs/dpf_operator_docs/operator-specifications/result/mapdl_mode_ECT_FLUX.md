...
# result:mapdl::mode::ECT_FLUX

**Version: 0.0.0**

## Description

Read/computeelement total heat flux at contact surface. If a downstream info (from a usepass) is provided, an expansion usepass*genpass is computed
 ...
 **Internal name**: mapdl::mode::ECT_FLUX
...
ansys::dpf::Operator op("mapdl::mode::ECT_FLUX"); // operator instantiation
