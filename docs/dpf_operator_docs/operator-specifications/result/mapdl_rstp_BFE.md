...
# result:mapdl::rstp::BFE

**Version: 0.0.0**

## Description

Read element structural nodal temperatures from rst file.
...
ansys::dpf::Operator op("mapdl::rstp::BFE"); // operator instantiation
