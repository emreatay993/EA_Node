...
# result:mapdl::rstp::ENL_PLWK

**Version: 0.0.0**

## Description

Read element nodal plastic strain energy density from rst file.
 ...
 **Internal name**: mapdl::rstp::ENL_PLWK
...
ansys::dpf::Operator op("mapdl::rstp::ENL_PLWK"); // operator instantiation
