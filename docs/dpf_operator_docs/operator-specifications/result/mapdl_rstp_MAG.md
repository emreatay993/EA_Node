...
# result:mapdl::rstp::MAG

**Version: 0.0.0**

## Description

Read magnetic scalar potential from rst file.
...
ansys::dpf::Operator op("mapdl::rstp::MAG"); // operator instantiation
