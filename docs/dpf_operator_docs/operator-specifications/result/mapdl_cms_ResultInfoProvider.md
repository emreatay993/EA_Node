...
# result:mapdl::cms::ResultInfoProvider
 ...
 **Internal name**: mapdl::cms::ResultInfoProvider
...
ansys::dpf::Operator op("mapdl::cms::ResultInfoProvider"); // operator instantiation
