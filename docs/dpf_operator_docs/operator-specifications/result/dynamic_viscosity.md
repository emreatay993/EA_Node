...
Reads/computes Dynamic Viscosity from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| dynamic_viscosity |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | dynamic_viscosity |
...
ansys::dpf::Operator op("cff::flprj::MU"); // operator instantiation
...
ansys::dpf::FieldsContainer my_dynamic_viscosity = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_dynamic_viscosity = op.outputs.dynamic_viscosity()
```
</details>
...
my_dynamic_viscosity = op.outputs.dynamic_viscosity.GetData()
```
</details>
<br>
