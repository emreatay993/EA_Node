...
# result:mapdl::rstp::ECD

**Version: 0.0.0**

## Description

Read element current density from rst file.
...
ansys::dpf::Operator op("mapdl::rstp::ECD"); // operator instantiation
