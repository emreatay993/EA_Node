...
# result:mapdl::rstp::S_eqv

**Version: 0.0.0**

## Description

Read equivalent stresses from rst file.
 ...
 **Internal name**: mapdl::rstp::S_eqv
...
ansys::dpf::Operator op("mapdl::rstp::S_eqv"); // operator instantiation
