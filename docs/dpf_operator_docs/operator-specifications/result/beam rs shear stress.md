...
# result:lsdyna::d3plot::B_ST1

**Version: 0.0.0**

## Description

Read Beam RS Shear Stress from result streams
...
|-------|------|------------------|-------------|
|  **Pin 0**| beam_rs_shear_stress |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | beam rs shear stress |
 ...
 **Scripting name**: beam rs shear stress

 **Full name**: result.beam rs shear stress

 **Internal name**: lsdyna::d3plot::B_ST1
...
ansys::dpf::Operator op("lsdyna::d3plot::B_ST1"); // operator instantiation
...
ansys::dpf::FieldsContainer my_beam_rs_shear_stress = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
op = dpf.operators.result.beam rs shear stress() # operator instantiation
...
my_beam_rs_shear_stress = op.outputs.beam_rs_shear_stress()
```
</details>
...
op.inputs.ipt_scoping.Connect(my_ipt_scoping)
op.inputs.unit_system.Connect(my_unit_system)
my_beam_rs_shear_stress = op.outputs.beam_rs_shear_stress.GetData()
```
</details>
<br>
