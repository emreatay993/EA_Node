...
# result:cff::flprj::V_RMS

**Version: 0.0.0**

## Description

Reads/computes RMS Velocity from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| rms_velocity |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | rms_velocity |
...
ansys::dpf::Operator op("cff::flprj::V_RMS"); // operator instantiation
...
ansys::dpf::FieldsContainer my_rms_velocity = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_rms_velocity = op.outputs.rms_velocity()
```
</details>
...
my_rms_velocity = op.outputs.rms_velocity.GetData()
```
</details>
<br>
