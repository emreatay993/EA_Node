...
# result:mapdl::rstp::ECT_STOT

**Version: 0.0.0**

## Description

Read element contact total stress (pressure plus friction) from rst file.
 ...
 **Internal name**: mapdl::rstp::ECT_STOT
...
ansys::dpf::Operator op("mapdl::rstp::ECT_STOT"); // operator instantiation
