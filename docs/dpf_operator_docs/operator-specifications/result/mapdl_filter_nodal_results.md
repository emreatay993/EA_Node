...
# result:mapdl::filter_nodal_results

**Version: 0.0.0**

## Description

Filter MAPDL nodal results.
 ...
 **Internal name**: mapdl::filter_nodal_results
...
ansys::dpf::Operator op("mapdl::filter_nodal_results"); // operator instantiation
