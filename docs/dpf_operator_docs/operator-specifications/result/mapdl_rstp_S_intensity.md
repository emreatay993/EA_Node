...
# result:mapdl::rstp::S_intensity

**Version: 0.0.0**

## Description

Read stress intensity from rst file.
 ...
 **Internal name**: mapdl::rstp::S_intensity
...
ansys::dpf::Operator op("mapdl::rstp::S_intensity"); // operator instantiation
