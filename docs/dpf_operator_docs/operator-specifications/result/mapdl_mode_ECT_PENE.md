...
# result:mapdl::mode::ECT_PENE

**Version: 0.0.0**

## Description

Load the appropriate operator based on the data sources and read/computeelement contact penetration
 ...
 **Internal name**: mapdl::mode::ECT_PENE
...
ansys::dpf::Operator op("mapdl::mode::ECT_PENE"); // operator instantiation
