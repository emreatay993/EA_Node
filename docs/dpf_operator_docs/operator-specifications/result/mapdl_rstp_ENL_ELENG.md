...
# result:mapdl::rstp::ENL_ELENG

**Version: 0.0.0**

## Description

Read element nodal elestic strain energy density from rst file.
 ...
 **Internal name**: mapdl::rstp::ENL_ELENG
...
ansys::dpf::Operator op("mapdl::rstp::ENL_ELENG"); // operator instantiation
