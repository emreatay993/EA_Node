...
# result:cff::flprj::RHO

**Version: 0.0.0**

## Description

Reads/computes Density from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| density |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | density |
...
ansys::dpf::Operator op("cff::flprj::RHO"); // operator instantiation
...
ansys::dpf::FieldsContainer my_density = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_density = op.outputs.density.GetData()
```
</details>
<br>
