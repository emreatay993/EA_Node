...
# result:mapdl::rstp::EPCR_EQV

**Version: 0.0.0**

## Description

Read equivalent creep strains from rst file.
 ...
 **Internal name**: mapdl::rstp::EPCR_EQV
...
ansys::dpf::Operator op("mapdl::rstp::EPCR_EQV"); // operator instantiation
