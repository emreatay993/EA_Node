...
# result:cyclic elemental non summable miscellaneous data

**Version: 0.0.0**

## Description

This operator is deprecated: use the operator elemental non summable miscellaneous data with the read_cyclic pin instead. Read elemental non summable miscellaneous data from a result file and expand it with cyclic symmetry.
...
ansys::dpf::Operator op("NMISC_cyclic"); // operator instantiation
...
op = dpf.operators.result.cyclic_nmisc() # operator instantiation
