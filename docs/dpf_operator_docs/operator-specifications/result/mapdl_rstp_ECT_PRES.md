...
# result:mapdl::rstp::ECT_PRES

**Version: 0.0.0**

## Description

Read element contact pressure from rst file.
 ...
 **Internal name**: mapdl::rstp::ECT_PRES
...
ansys::dpf::Operator op("mapdl::rstp::ECT_PRES"); // operator instantiation
