...
# result:mapdl::mode::ECT_CNOS

**Version: 0.0.0**

## Description

Load the appropriate operator based on the data sources and read/computeelement total number of contact status changes during substep
 ...
 **Internal name**: mapdl::mode::ECT_CNOS
...
ansys::dpf::Operator op("mapdl::mode::ECT_CNOS"); // operator instantiation
