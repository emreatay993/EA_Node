...
# result:cms expanded elemental summable miscellaneous data

**Version: 0.0.0**

## Description

Read/compute elemental summable miscellaneous data expanded result.
 ...
 **Scripting name**: cms_expanded_smisc

 **Full name**: result.cms_expanded_smisc

 **Internal name**: SMISC_cms
...
ansys::dpf::Operator op("SMISC_cms"); // operator instantiation
...
op = dpf.operators.result.cms_expanded_smisc() # operator instantiation
