...
# result:mapdl::unfilter_elemental_nodal_results

**Version: 0.0.0**

## Description

Recreate Missing Elemental Nodal data for degenerate elements.
 ...
 **Internal name**: mapdl::unfilter_elemental_nodal_results
...
ansys::dpf::Operator op("mapdl::unfilter_elemental_nodal_results"); // operator instantiation
