...
# result:mapdl::rstp::GKDI

**Version: 0.0.0**

## Description

Read gasket inelastic closure from rst file.
...
ansys::dpf::Operator op("mapdl::rstp::GKDI"); // operator instantiation
