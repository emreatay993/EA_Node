...
Reads/computes Mach Number from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| mach_number |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | mach_number |
...
ansys::dpf::Operator op("cff::cas::MACH"); // operator instantiation
...
ansys::dpf::FieldsContainer my_mach_number = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_mach_number = op.outputs.mach_number()
```
</details>
...
my_mach_number = op.outputs.mach_number.GetData()
```
</details>
<br>
