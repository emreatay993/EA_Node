...
# result:mapdl::rstp::ENL_EPEQ

**Version: 0.0.0**

## Description

Read element nodal accumulated equivalent plastic strain from rst file.
 ...
 **Internal name**: mapdl::rstp::ENL_EPEQ
...
ansys::dpf::Operator op("mapdl::rstp::ENL_EPEQ"); // operator instantiation
