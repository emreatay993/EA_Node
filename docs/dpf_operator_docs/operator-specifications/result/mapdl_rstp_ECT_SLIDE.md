...
# result:mapdl::rstp::ECT_SLIDE

**Version: 0.0.0**

## Description

Read element contact sliding distance from rst file.
 ...
 **Internal name**: mapdl::rstp::ECT_SLIDE
...
ansys::dpf::Operator op("mapdl::rstp::ECT_SLIDE"); // operator instantiation
