...
Reads/computes Turbulent Kinetic Energy from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| turbulent_kinetic_energy |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | turbulent_kinetic_energy |
...
ansys::dpf::Operator op("cff::flprj::K"); // operator instantiation
...
ansys::dpf::FieldsContainer my_turbulent_kinetic_energy = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_turbulent_kinetic_energy = op.outputs.turbulent_kinetic_energy()
```
</details>
...
my_turbulent_kinetic_energy = op.outputs.turbulent_kinetic_energy.GetData()
```
</details>
<br>
