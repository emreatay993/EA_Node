...
# result:ENF_modal_matrices

**Version: 0.0.0**

## Description

Read static, damping and inertia modal matrices (with their coefficients for reaction forces msup expansion from a rst file.
 ...
 **Internal name**: ENF_modal_matrices
...
ansys::dpf::Operator op("ENF_modal_matrices"); // operator instantiation
