...
Read/computenodal rotationfor a datasource containing nested superelements is provider
...
ansys::dpf::Operator op("ROT_nested"); // operator instantiation
