...
This operator is deprecated: use the operator element nodal component stresses with the read_cyclic pin instead. Read element nodal component stresses from a result file and expand it with cyclic symmetry.
...
ansys::dpf::Operator op("S_cyclic"); // operator instantiation
...
op = dpf.operators.result.cyclic_expanded_stress() # operator instantiation
