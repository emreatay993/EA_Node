...
# result:mapdl::rstp::ENL_CRWK

**Version: 0.0.0**

## Description

Read element nodal creep strain energy density from rst file.
 ...
 **Internal name**: mapdl::rstp::ENL_CRWK
...
ansys::dpf::Operator op("mapdl::rstp::ENL_CRWK"); // operator instantiation
