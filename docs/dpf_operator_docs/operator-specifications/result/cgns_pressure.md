 ...
 **Scripting name**: cgns_pressure

 **Full name**: result.cgns_pressure

 **Internal name**: cgns::cgns::Pressure
...
ansys::dpf::Operator op("cgns::cgns::Pressure"); // operator instantiation
...
op = dpf.operators.result.cgns_pressure() # operator instantiation
