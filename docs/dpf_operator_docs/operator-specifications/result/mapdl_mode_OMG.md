...
# result:mapdl::mode::OMG

**Version: 0.0.0**

## Description

Read/computenodal rotational velocity. If a downstream info (from a usepass) is provided, an expansion usepass*genpass is computed
...
ansys::dpf::Operator op("mapdl::mode::OMG"); // operator instantiation
