...
# result:cff::flprj::TEMP_RMS

**Version: 0.0.0**

## Description

Reads/computes RMS Temperature from result streams.
...
|-------|------|------------------|-------------|
|  **Pin 0**| rms_temperature |[`fields_container`](../../core-concepts/dpf-types.md#fields-container) | rms_temperature |
 ...
 **Internal name**: cff::flprj::TEMP_RMS
...
ansys::dpf::Operator op("cff::flprj::TEMP_RMS"); // operator instantiation
...
ansys::dpf::FieldsContainer my_rms_temperature = op.getOutput<ansys::dpf::FieldsContainer>(0);
```
</details>
...
my_rms_temperature = op.outputs.rms_temperature()
```
</details>
...
my_rms_temperature = op.outputs.rms_temperature.GetData()
```
</details>
<br>
