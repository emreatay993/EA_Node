...
# result:mapdl::rstp::ECT_GAP

**Version: 0.0.0**

## Description

Read element contact gap distance from rst file.
 ...
 **Internal name**: mapdl::rstp::ECT_GAP
...
ansys::dpf::Operator op("mapdl::rstp::ECT_GAP"); // operator instantiation
