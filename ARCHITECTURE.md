...
- `ea_node_editor/ui` + `ea_node_editor/ui_qml`: shell window, QML scene, bridges, and UI models.
...
5. Session restore + optional autosave recovery runs, then active workspace/view/scope are bound.
