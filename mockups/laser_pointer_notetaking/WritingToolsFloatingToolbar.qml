    ...
    component WritingToolGlyph: Canvas {
        ...
        onPaint: {
            ...
            if (glyph.iconName === "pen") {
                // Pen-tool nib, reverse-engineered from icons/benchmark/pen.png
                // (pixel analysis, normalised to the icon bbox). Screen-space:
                ...
                // Sharpened hex pencil, tip at lower-left — reverse-engineered
                // from the reference button: a grey barrel carrying two facet
                ...
                // Illustrated chisel highlighter, reverse-engineered from the
                // benchmark reference: a green ink barrel (back of the pen), a
